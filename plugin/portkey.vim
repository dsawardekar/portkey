...
function! s:PluginConstructor()
  let pluginObj = {}
  let pluginObj.get_app = function('<SNR>' . s:SID() . '_Plugin_get_app')
  let pluginObj.loaded = function('<SNR>' . s:SID() . '_Plugin_loaded')
  let pluginObj.start = function('<SNR>' . s:SID() . '_Plugin_start')
  let pluginObj.on_buffer_open = function('<SNR>' . s:SID() . '_Plugin_on_buffer_open')
  let pluginObj.on_buffer_enter = function('<SNR>' . s:SID() . '_Plugin_on_buffer_enter')
  let pluginObj.on_buffer_leave = function('<SNR>' . s:SID() . '_Plugin_on_buffer_leave')
  let pluginObj.on_vim_enter = function('<SNR>' . s:SID() . '_Plugin_on_vim_enter')
  let pluginObj.can_autostart = function('<SNR>' . s:SID() . '_Plugin_can_autostart')
  let pluginObj.has_autostart = function('<SNR>' . s:SID() . '_Plugin_has_autostart')
  let pluginObj.has_portkey_json = function('<SNR>' . s:SID() . '_Plugin_has_portkey_json')
  return pluginObj
endfunction
