...
function! s:DelegateConstructor(scope, method)
  ...
  let delegateObj.invoke = function('s:Delegate_invoke')
  let delegateObj.unlink = function('s:Delegate_unlink')
  return delegateObj
endfunction
...
function! s:FileOpenerConstructor()
  ...
  let fileOpenerObj.set_mkdir_mode = function('s:FileOpener_set_mkdir_mode')
  let fileOpenerObj.get_mkdir_mode = function('s:FileOpener_get_mkdir_mode')
  let fileOpenerObj.set_exec_mode = function('s:FileOpener_set_exec_mode')
  let fileOpenerObj.get_exec_mode = function('s:FileOpener_get_exec_mode')
  let fileOpenerObj.open = function('s:FileOpener_open')
  let fileOpenerObj.open_with = function('s:FileOpener_open_with')
  let fileOpenerObj.mkdir = function('s:FileOpener_mkdir')
  let fileOpenerObj.build_cmd = function('s:FileOpener_build_cmd')
...
function! s:BufferOpenerConstructor()
  ...
  let bufferOpenerObj.needs = function('s:BufferOpener_needs')
  let bufferOpenerObj.open = function('s:BufferOpener_open')
  let bufferOpenerObj.get_abs_root = function('s:BufferOpener_get_abs_root')
  let bufferOpenerObj.get_rel_path = function('s:BufferOpener_get_rel_path')
  let bufferOpenerObj.get_abs_path = function('s:BufferOpener_get_abs_path')
  return bufferOpenerObj
endfunction

function! s:BufferOpener_needs() dict
  return ['context', 'file_opener']
endfunction

function! s:BufferOpener_open(filepath, create_if_not_found, window_mode) dict
...
function! s:BufferOpener_get_abs_root() dict
  return self.context.get_root()
endfunction

function! s:BufferOpener_get_rel_path(filepath) dict
  return fnamemodify(self.get_abs_path(a:filepath), ':.')
endfunction

function! s:BufferOpener_get_abs_path(filepath) dict
...
function! s:LexNullConstructor()
  ...
  let lexNullObj.scan = function('s:LexNull_scan')
  return lexNullObj
endfunction

function! s:LexNull_scan(lexer) dict
endfunction

function! s:LexTextConstructor()
  let lexTextObj = {}
  let lexTextObj.scan = function('s:LexText_scan')
  return lexTextObj
endfunction

function! s:LexText_scan(lexer) dict
  while 1
...
function! s:LexInsideModifierConstructor()
  ...
  let lexInsideModifierObj.scan = function('s:LexInsideModifier_scan')
  return lexInsideModifierObj
endfunction

function! s:LexInsideModifier_scan(lexer) dict
  let rune = a:lexer.peek()
  if rune ==# '%'
    call a:lexer.emit_text()
...
function! s:LexLeftDelimConstructor()
  let lexLeftDelimObj = {}
  let lexLeftDelimObj.scan = function('s:LexLeftDelim_scan')
  return lexLeftDelimObj
endfunction

function! s:LexLeftDelim_scan(lexer) dict
  call a:lexer.ignore()
...
function! s:LexRightDelimConstructor()
  ...
  let lexRightDelimObj.scan = function('s:LexRightDelim_scan')
  return lexRightDelimObj
endfunction

function! s:LexRightDelim_scan(lexer) dict
  call a:lexer.ignore()
  return 'LexText'
endfunction
...
function! s:LexInsidePlaceholderConstructor()
  ...
  let lexInsidePlaceholderObj.scan = function('s:LexInsidePlaceholder_scan')
  return lexInsidePlaceholderObj
endfunction

function! s:LexInsidePlaceholder_scan(lexer) dict
  let rune = a:lexer.peek()
  if rune ==# '}'
    call a:lexer.backup()
    if a:lexer.peek() ==# '{'
...
function! s:LexInsidePlaceholderNameConstructor()
  ...
  let lexInsidePlaceholderNameObj.scan = function('s:LexInsidePlaceholderName_scan')
  return lexInsidePlaceholderNameObj
endfunction

function! s:LexInsidePlaceholderName_scan(lexer) dict
  call a:lexer.ignore_whitespace()
...
function! s:LexInsideFilterConstructor()
  ...
  let lexInsideFilterObj.scan = function('s:LexInsideFilter_scan')
  return lexInsideFilterObj
endfunction

function! s:LexInsideFilter_scan(lexer) dict
  let rune = a:lexer.peek()
  call a:lexer.ignore_whitespace()
  if rune ==# '}'
    call a:lexer.next()
...
function! s:LexInsideFilterChainConstructor()
  ...
  let lexInsideFilterChainObj.scan = function('s:LexInsideFilterChain_scan')
  return lexInsideFilterChainObj
endfunction

function! s:LexInsideFilterChain_scan(lexer) dict
  call a:lexer.ignore_whitespace()
  call a:lexer.accept_keyword()
  if !(a:lexer.is_ahead())
...
function! s:LexInsideEscapeConstructor()
  ...
  let lexInsideEscapeObj.scan = function('s:LexInsideEscape_scan')
  return lexInsideEscapeObj
endfunction

function! s:LexInsideEscape_scan(lexer) dict
  let rune = a:lexer.peek()
  if rune ==# 'n' || rune ==# 'r'
    call a:lexer.advance()
...
function! s:LexStateFactoryConstructor()
  ...
  let lexStateFactoryObj.get_state = function('s:LexStateFactory_get_state')
  return lexStateFactoryObj
endfunction

function! s:LexStateFactory_get_state(name) dict
...
function! s:AutocmdLoaderConstructor()
  ...
  let autocmdLoaderObj.set_group_name = function('s:AutocmdLoader_set_group_name')
  let autocmdLoaderObj.get_group_name = function('s:AutocmdLoader_get_group_name')
  let autocmdLoaderObj.load = function('s:AutocmdLoader_load')
  let autocmdLoaderObj.unload = function('s:AutocmdLoader_unload')
  let autocmdLoaderObj.cmd = function('s:AutocmdLoader_cmd')
  let autocmdLoaderObj.size = function('s:AutocmdLoader_size')
...
function! s:EnvironmentConstructor()
  ...
  let environmentObj.on_inject = function('s:Environment_on_inject')
  let environmentObj.load_defaults = function('s:Environment_load_defaults')
  let environmentObj.set_option = function('s:Environment_set_option')
  let environmentObj.get_option = function('s:Environment_get_option')
  let environmentObj.load_option = function('s:Environment_load_option')
  let environmentObj.load_options = function('s:Environment_load_options')
  return environmentObj
endfunction

function! s:Environment_on_inject() dict
  call self.load_options()
endfunction

function! s:Environment_load_defaults(opts) dict
  let self.options = a:opts
endfunction

function! s:Environment_set_option(name, value) dict
  let self.options[a:name] = a:value
endfunction

function! s:Environment_get_option(name) dict
  return self.options[a:name]
endfunction

function! s:Environment_load_option(name) dict
...
function! s:Environment_load_options() dict
...
function! s:ProjectorConstructor()
  ...
  let projectorObj.needs = function('s:Projector_needs')
  let projectorObj.get_projection_templates = function('s:Projector_get_projection_templates')
  let projectorObj.get_file_template = function('s:Projector_get_file_template')
  let projectorObj.render_template = function('s:Projector_render_template')
  let projectorObj.append_template = function('s:Projector_append_template')
  return projectorObj
endfunction

function! s:Projector_needs() dict
  return ['lexer', 'compiler', 'projections']
endfunction

function! s:Projector_get_projection_templates(projection, projection_type, context) dict
...
function! s:Projector_get_file_template(filepath, context) dict
...
function! s:Projector_render_template(template, context) dict
...
function! s:Projector_append_template(list, template, context) dict
...
function! s:BufferConstructor(path)
  ...
  let bufferObj.has_root = function('s:Buffer_has_root')
  let bufferObj.find_root = function('s:Buffer_find_root')
  let bufferObj.get_path = function('s:Buffer_get_path')
  let bufferObj.get_portkey_path = function('s:Buffer_get_portkey_path')
  let bufferObj.get_portkey_display_path = function('s:Buffer_get_portkey_display_path')
  let bufferObj.get_abs_portkey_path = function('s:Buffer_get_abs_portkey_path')
  let bufferObj.get_root = function('s:Buffer_get_root')
  let bufferObj.get_abs_root = function('s:Buffer_get_abs_root')
  let bufferObj.get_abs_path = function('s:Buffer_get_abs_path')
  let bufferObj.get_rel_path = function('s:Buffer_get_rel_path')
  let bufferObj.get_rootname = function('s:Buffer_get_rootname')
  let bufferObj.get_filename = function('s:Buffer_get_filename')
  let bufferObj.reset = function('s:Buffer_reset')
  let bufferObj.set_match = function('s:Buffer_set_match')
  let bufferObj.get_match = function('s:Buffer_get_match')
  let bufferObj.has_projection = function('s:Buffer_has_projection')
  let bufferObj.get_projection = function('s:Buffer_get_projection')
  let bufferObj.get_source = function('s:Buffer_get_source')
  let bufferObj.get_pattern = function('s:Buffer_get_pattern')
  let bufferObj.set_enrolled = function('s:Buffer_set_enrolled')
  let bufferObj.get_enrolled = function('s:Buffer_get_enrolled')
  let bufferObj.set_configured = function('s:Buffer_set_configured')
  let bufferObj.get_configured = function('s:Buffer_get_configured')
  return bufferObj
endfunction

function! s:Buffer_has_root() dict
  if self.did_search
    return self.root !=# ''
  else
...
function! s:Buffer_find_root() dict
...
function! s:Buffer_get_portkey_path() dict
  let path = self.get_abs_root() . "portkey.json"
  return fnamemodify(path, ':.')
endfunction

function! s:Buffer_get_portkey_display_path(...) dict
  if len(a:000) ==# 0
...
function! s:Buffer_get_abs_portkey_path() dict
  return fnamemodify(self.get_portkey_path(), ':p')
endfunction

function! s:Buffer_get_root() dict
  if !(self.did_search)
...
function! s:Buffer_get_abs_root() dict
...
function! s:Buffer_get_abs_path() dict
...
function! s:Buffer_get_rel_path() dict
...
function! s:Buffer_get_rootname() dict
  return fnamemodify(self.get_path(), ':t:r')
endfunction

function! s:Buffer_get_filename() dict
  return fnamemodify(self.get_path(), ':t')
endfunction

function! s:Buffer_reset() dict
...
function! s:Buffer_set_match(match) dict
  let self.match = a:match
  let self.configured = 1
endfunction

function! s:Buffer_get_match() dict
  return self.match
endfunction

function! s:Buffer_has_projection() dict
  return has_key(self, 'match')
endfunction

function! s:Buffer_get_projection() dict
  return self.get_match().get_pattern().get_projection()
endfunction

function! s:Buffer_get_source() dict
  return self.get_match().source
endfunction

function! s:Buffer_get_pattern() dict
  return self.get_match().pattern
endfunction

function! s:Buffer_set_enrolled(enrolled) dict
  let self.enrolled = a:enrolled
endfunction

function! s:Buffer_get_enrolled() dict
  return self.enrolled
endfunction

function! s:Buffer_set_configured(configured) dict
  let self.configured = a:configured
endfunction

function! s:Buffer_get_configured() dict
...
function! s:BufferCollectionConstructor()
  ...
  let bufferCollectionObj.has_current = function('s:BufferCollection_has_current')
  let bufferCollectionObj.get_current = function('s:BufferCollection_get_current')
  let bufferCollectionObj.set_current = function('s:BufferCollection_set_current')
  let bufferCollectionObj.clear = function('s:BufferCollection_clear')
  return bufferCollectionObj
endfunction

function! s:BufferCollection_has_current() dict
...
function! s:BufferCollection_set_current(current) dict
...
function! s:ContextCollectionConstructor()
  ...
  let contextCollectionObj.contains = function('s:ContextCollection_contains')
  let contextCollectionObj.add = function('s:ContextCollection_add')
  let contextCollectionObj.remove = function('s:ContextCollection_remove')
  let contextCollectionObj.remove_all = function('s:ContextCollection_remove_all')
  let contextCollectionObj.get = function('s:ContextCollection_get')
  return contextCollectionObj
endfunction

function! s:ContextCollection_contains(root) dict
  return has_key(self.contexts, a:root)
endfunction

function! s:ContextCollection_add(root) dict
...
function! s:ContextCollection_remove(root) dict
  if self.contains(a:root)
    unlet self.contexts[a:root]
  endif
endfunction

function! s:ContextCollection_remove_all() dict
  for root in keys(self.contexts)
    call self.remove(root)
  endfor
endfunction

function! s:ContextCollection_get(root) dict
...
function! s:GlobberConstructor()
  let globberObj = {}
  let globberObj.glob = function('s:Globber_glob')
  let globberObj.get_glob_pattern = function('s:Globber_get_glob_pattern')
  let globberObj.get_recursive_pattern = function('s:Globber_get_recursive_pattern')
  return globberObj
endfunction

function! s:Globber_glob(path, pattern) dict
...
function! s:Globber_get_glob_pattern(pattern) dict
...
function! s:Globber_get_recursive_pattern(pattern) dict
...
function! s:FinderMatcherConstructor()
  ...
  let finderMatcherObj.shorten = function('s:FinderMatcher_shorten')
  let finderMatcherObj.match = function('s:FinderMatcher_match')
  let finderMatcherObj.sort = function('s:FinderMatcher_sort')
  let finderMatcherObj.compare_filenames = function('s:FinderMatcher_compare_filenames')
  let finderMatcherObj.match_filename = function('s:FinderMatcher_match_filename')
  let finderMatcherObj.subst_filename = function('s:FinderMatcher_subst_filename')
  let finderMatcherObj.find_common_parent = function('s:FinderMatcher_find_common_parent')
  let finderMatcherObj.find_common_extension = function('s:FinderMatcher_find_common_extension')
  return finderMatcherObj
endfunction

function! s:FinderMatcher_shorten(results) dict
  let names = []
...
function! s:FinderMatcher_match(filename, results) dict
  let common_parent = self.find_common_parent(a:results)
  let common_ext = self.find_common_extension(a:results)
  if common_ext !=# ''
...
function! s:FinderMatcher_sort(results) dict
  let sort_function = s:new_delegate(self, 'compare_filenames')
  call sort(a:results, sort_function)
endfunction

function! s:FinderMatcher_compare_filenames(a, b) dict
  let len_a = len(a:a)
  let len_b = len(a:b)
  return len_a - len_b
endfunction

function! s:FinderMatcher_match_filename(filename, result) dict
  let sub_filename = self.subst_filename(a:filename, a:result)
  return sub_filename ==# a:result
endfunction

function! s:FinderMatcher_subst_filename(filename, result) dict
...
function! s:FinderMatcher_find_common_parent(list) dict
  let n = len(a:list)
  if n ==# 0
    return ''
  elseif n ==# 1
...
function! s:FinderMatcher_find_common_extension(results) dict
  let n = len(a:results)
  if n ># 1
...
function! s:FinderFacadeConstructor()
  let finderFacadeObj = {}
  let finderFacadeObj.needs = function('s:FinderFacade_needs')
  let finderFacadeObj.find = function('s:FinderFacade_find')
  let finderFacadeObj.pick = function('s:FinderFacade_pick')
  let finderFacadeObj.first = function('s:FinderFacade_first')
  let finderFacadeObj.nth = function('s:FinderFacade_nth')
  let finderFacadeObj.find_and_rank = function('s:FinderFacade_find_and_rank')
  return finderFacadeObj
endfunction

function! s:FinderFacade_needs() dict
  return ['finder', 'ranker', 'matcher']
endfunction

function! s:FinderFacade_find(type, context) dict
  let results = self.find_and_rank(a:type, a:context)
  return self.matcher.shorten(results)
endfunction

function! s:FinderFacade_pick(type, context, filename) dict
  let results = self.find_and_rank(a:type, a:context)
  return self.matcher.match(a:filename, results)
endfunction

function! s:FinderFacade_first(type, context) dict
  return self.nth(a:type, a:context, 1)
endfunction

function! s:FinderFacade_nth(type, context, index) dict
...
function! s:FinderFacade_find_and_rank(type, context) dict
...
function! s:SyntaxLoaderConstructor()
  ...
  let syntaxLoaderObj.register = function('s:SyntaxLoader_register')
  let syntaxLoaderObj.get_syntax = function('s:SyntaxLoader_get_syntax')
  let syntaxLoaderObj.has_syntax = function('s:SyntaxLoader_has_syntax')
  let syntaxLoaderObj.load = function('s:SyntaxLoader_load')
  let syntaxLoaderObj.load_by_pattern = function('s:SyntaxLoader_load_by_pattern')
  return syntaxLoaderObj
endfunction

function! s:SyntaxLoader_register(resource_type, file) dict
  let self.syntaxes[a:resource_type] = a:file
endfunction

function! s:SyntaxLoader_get_syntax(resource_type) dict
  return self.syntaxes[a:resource_type]
endfunction

function! s:SyntaxLoader_has_syntax(resource_type) dict
  return has_key(self.syntaxes, a:resource_type)
endfunction

function! s:SyntaxLoader_load(resource_type) dict
...
function! s:SyntaxLoader_load_by_pattern(filepath) dict
...
function! s:CommandOptionsConstructor()
  ...
  let commandOptionsObj.set_args = function('s:CommandOptions_set_args')
  let commandOptionsObj.get_args = function('s:CommandOptions_get_args')
  let commandOptionsObj.get_nargs = function('s:CommandOptions_get_nargs')
  let commandOptionsObj.get_opts = function('s:CommandOptions_get_opts')
  let commandOptionsObj.set_filename = function('s:CommandOptions_set_filename')
  let commandOptionsObj.get_filename = function('s:CommandOptions_get_filename')
  let commandOptionsObj.set_launchables = function('s:CommandOptions_set_launchables')
  let commandOptionsObj.get_launchables = function('s:CommandOptions_get_launchables')
  let commandOptionsObj.set_append_mode = function('s:CommandOptions_set_append_mode')
  let commandOptionsObj.get_append_mode = function('s:CommandOptions_get_append_mode')
  let commandOptionsObj.get_option = function('s:CommandOptions_get_option')
  let commandOptionsObj.get_word = function('s:CommandOptions_get_word')
  let commandOptionsObj.get_bang = function('s:CommandOptions_get_bang')
  let commandOptionsObj.has_range = function('s:CommandOptions_has_range')
  let commandOptionsObj.get_range = function('s:CommandOptions_get_range')
  let commandOptionsObj.has_count = function('s:CommandOptions_has_count')
  let commandOptionsObj.get_count = function('s:CommandOptions_get_count')
  let commandOptionsObj.set_window_mode = function('s:CommandOptions_set_window_mode')
  let commandOptionsObj.get_window_mode = function('s:CommandOptions_get_window_mode')
  let commandOptionsObj.calc_window_mode = function('s:CommandOptions_calc_window_mode')
  let commandOptionsObj.has_resource_type = function('s:CommandOptions_has_resource_type')
  let commandOptionsObj.get_resource_type = function('s:CommandOptions_get_resource_type')
  let commandOptionsObj.set_resource_type = function('s:CommandOptions_set_resource_type')
  let commandOptionsObj.build_resource_type = function('s:CommandOptions_build_resource_type')
  return commandOptionsObj
endfunction

function! s:CommandOptions_set_args(args) dict
...
function! s:CommandOptions_get_args() dict
  return self.args
endfunction

function! s:CommandOptions_get_nargs() dict
  return self.nargs
endfunction

function! s:CommandOptions_get_opts() dict
  return self.opts
endfunction

function! s:CommandOptions_set_filename(filename) dict
  let self.filename = a:filename
endfunction

function! s:CommandOptions_get_filename() dict
  return self.filename
endfunction

function! s:CommandOptions_set_launchables(launchables) dict
  let self.launchables = a:launchables
endfunction

function! s:CommandOptions_get_launchables() dict
  return self.launchables
endfunction

function! s:CommandOptions_set_append_mode(append_mode) dict
  let self.append_mode = a:append_mode
endfunction

function! s:CommandOptions_get_append_mode() dict
  return self.append_mode
endfunction

function! s:CommandOptions_get_option(name, default) dict
...
function! s:CommandOptions_get_word() dict
  return self.get_option('word', '')
endfunction

function! s:CommandOptions_get_bang() dict
  return self.get_option('bang', 0)
endfunction

function! s:CommandOptions_has_range() dict
  return has_key(self.opts, 'range')
endfunction

function! s:CommandOptions_get_range() dict
  return self.get_option('range', [1, 1])
endfunction

function! s:CommandOptions_has_count() dict
  return has_key(self.opts, 'count') && self.opts.count ># 0
endfunction

function! s:CommandOptions_get_count() dict
...
function! s:CommandOptions_set_window_mode(window_mode) dict
  let self.window_mode = a:window_mode
endfunction

function! s:CommandOptions_get_window_mode() dict
...
function! s:CommandOptions_calc_window_mode() dict
...
function! s:CommandOptions_has_resource_type() dict
  return has_key(self, 'resource_type')
endfunction

function! s:CommandOptions_get_resource_type() dict
...
function! s:CommandOptions_set_resource_type(resource_type) dict
  let self.resource_type = a:resource_type
endfunction

function! s:CommandOptions_build_resource_type() dict
...
function! s:CompleterConstructor()
  let completerObj = {}
  let completerObj.needs = function('s:Completer_needs')
  let completerObj.complete = function('s:Completer_complete')
  let completerObj.filter = function('s:Completer_filter')
  return completerObj
endfunction

function! s:Completer_needs() dict
  return ['finder_facade']
endfunction

function! s:Completer_complete(finder_context, options) dict
...
function! s:Completer_filter(results, options) dict
...
function! s:ExtractorConstructor()
  let extractorObj = {}
  let extractorObj.match = function('s:Extractor_match')
  let extractorObj.change_source = function('s:Extractor_change_source')
  let extractorObj.change_destination = function('s:Extractor_change_destination')
  return extractorObj
endfunction

function! s:Extractor_match(context) dict
  return 0
endfunction

function! s:Extractor_change_source(lines, mode, range) dict
endfunction

function! s:Extractor_change_destination(lines, mode, range) dict
endfunction
...
function! s:ExtractorCollectionConstructor()
  ...
  let extractorCollectionObj.add_extractor = function('s:ExtractorCollection_add_extractor')
  let extractorCollectionObj.remove_extractor = function('s:ExtractorCollection_remove_extractor')
  let extractorCollectionObj.get_all_extractors = function('s:ExtractorCollection_get_all_extractors')
  let extractorCollectionObj.has_extractor = function('s:ExtractorCollection_has_extractor')
  let extractorCollectionObj.find_extractor = function('s:ExtractorCollection_find_extractor')
  let extractorCollectionObj.size = function('s:ExtractorCollection_size')
  return extractorCollectionObj
endfunction

function! s:ExtractorCollection_add_extractor(extractor) dict
  call insert(self.extractors, a:extractor)
endfunction

function! s:ExtractorCollection_remove_extractor(name) dict
  let i = 0
...
function! s:ExtractorCollection_get_all_extractors() dict
  return self.extractors
endfunction

function! s:ExtractorCollection_has_extractor(name) dict
  let i = 0
  for extractor in self.extractors
    if extractor.get_name() ==# a:name
      return 1
...
function! s:ExtractorCollection_find_extractor(context) dict
  for extractor in self.extractors
...
function! s:ExtractorCollection_size() dict
...
function! s:ExtensionConstructor()
  let extensionObj = {}
  let extensionObj.get_name = function('s:Extension_get_name')
  let extensionObj.get_portkey_path = function('s:Extension_get_portkey_path')
  let extensionObj.get_scope = function('s:Extension_get_scope')
  let extensionObj.get_finder = function('s:Extension_get_finder')
  let extensionObj.get_ranker = function('s:Extension_get_ranker')
  let extensionObj.get_syntax_files = function('s:Extension_get_syntax_files')
  let extensionObj.configure_inflector = function('s:Extension_configure_inflector')
  let extensionObj.configure_projection = function('s:Extension_configure_projection')
  let extensionObj.get_filters = function('s:Extension_get_filters')
  let extensionObj.get_extractors = function('s:Extension_get_extractors')
  return extensionObj
endfunction

function! s:Extension_get_name() dict
endfunction

function! s:Extension_get_portkey_path(type, variant) dict
endfunction

function! s:Extension_get_scope() dict
endfunction

function! s:Extension_get_finder(type) dict
endfunction

function! s:Extension_get_ranker(type) dict
endfunction

function! s:Extension_get_syntax_files() dict
endfunction

function! s:Extension_configure_inflector(inflector) dict
endfunction

function! s:Extension_configure_projection(projection) dict
endfunction

function! s:Extension_get_filters() dict
endfunction

function! s:Extension_get_extractors() dict
endfunction
...
function! s:ExtensionCollectionConstructor()
  ...
  let extensionCollectionObj.add_extension = function('s:ExtensionCollection_add_extension')
  let extensionCollectionObj.remove_extension = function('s:ExtensionCollection_remove_extension')
  let extensionCollectionObj.has_extension = function('s:ExtensionCollection_has_extension')
  let extensionCollectionObj.get_extension = function('s:ExtensionCollection_get_extension')
  let extensionCollectionObj.get_all_extensions = function('s:ExtensionCollection_get_all_extensions')
  let extensionCollectionObj.find_extension_portkey = function('s:ExtensionCollection_find_extension_portkey')
  return extensionCollectionObj
endfunction

function! s:ExtensionCollection_add_extension(extension) dict
  let self.extensions[a:extension.get_name()] = a:extension
endfunction

function! s:ExtensionCollection_remove_extension(name) dict
  if self.has_extension(a:name)
    unlet self.extensions[a:name]
  endif
endfunction

function! s:ExtensionCollection_has_extension(name) dict
  return has_key(self.extensions, a:name)
endfunction

function! s:ExtensionCollection_get_extension(name) dict
  return self.extensions[a:name]
endfunction

function! s:ExtensionCollection_get_all_extensions() dict
  return values(self.extensions)
endfunction

function! s:ExtensionCollection_find_extension_portkey(name) dict
  if self.has_extension(a:name)
...
function! s:LaunchableCollectionConstructor()
  ...
  let launchableCollectionObj.add = function('s:LaunchableCollection_add')
  let launchableCollectionObj.get_all = function('s:LaunchableCollection_get_all')
  let launchableCollectionObj.find = function('s:LaunchableCollection_find')
  let launchableCollectionObj.size = function('s:LaunchableCollection_size')
  return launchableCollectionObj
endfunction

function! s:LaunchableCollection_add(launchable) dict
  call add(self.launchables, a:launchable)
endfunction

function! s:LaunchableCollection_get_all() dict
  return self.launchables
endfunction

function! s:LaunchableCollection_find(strategy) dict
...
function! s:LaunchableCollection_size() dict
...
function! s:PickFileStrategyConstructor()
  ...
  let pickFileStrategyObj.needs = function('s:PickFileStrategy_needs')
  let pickFileStrategyObj.get_launchable = function('s:PickFileStrategy_get_launchable')
  return pickFileStrategyObj
endfunction

function! s:PickFileStrategy_needs() dict
  return ['finder_facade']
endfunction

function! s:PickFileStrategy_get_launchable(finder_context, options) dict
  let query_type = a:finder_context.get_query_type(a:options)
...
function! s:FirstFileStrategyConstructor()
  ...
  let firstFileStrategyObj.needs = function('s:FirstFileStrategy_needs')
  let firstFileStrategyObj.get_launchable = function('s:FirstFileStrategy_get_launchable')
  return firstFileStrategyObj
endfunction

function! s:FirstFileStrategy_needs() dict
  return ['finder_facade']
endfunction

function! s:FirstFileStrategy_get_launchable(finder_context, options) dict
  let query_type = a:finder_context.get_query_type(a:options)
  let template_context = a:finder_context.get_template_context(a:options)
...
function! s:NthFileStrategyConstructor()
  ...
  let nthFileStrategyObj.needs = function('s:NthFileStrategy_needs')
  let nthFileStrategyObj.get_launchable = function('s:NthFileStrategy_get_launchable')
  return nthFileStrategyObj
endfunction

function! s:NthFileStrategy_needs() dict
  return ['finder_facade']
endfunction

function! s:NthFileStrategy_get_launchable(finder_context, options) dict
  let query_type = a:finder_context.get_query_type(a:options)
  let filename = a:options.get_filename()
  let template_context = a:finder_context.get_template_context(a:options)
...
function! s:NewResourceStrategyConstructor()
  ...
  let newResourceStrategyObj.needs = function('s:NewResourceStrategy_needs')
  let newResourceStrategyObj.get_launchable = function('s:NewResourceStrategy_get_launchable')
  let newResourceStrategyObj.lookup = function('s:NewResourceStrategy_lookup')
  let newResourceStrategyObj.affinize = function('s:NewResourceStrategy_affinize')
  return newResourceStrategyObj
endfunction

function! s:NewResourceStrategy_needs() dict
  return ['finder_facade']
endfunction

function! s:NewResourceStrategy_get_launchable(finder_context, options) dict
  let filename = a:options.get_filename()
...
function! s:NewResourceStrategy_lookup(name) dict
  return self.container.lookup(a:name)
endfunction

function! s:NewResourceStrategy_affinize(name, affinity) dict
...
function! s:TestFileStrategyConstructor()
  ...
  let testFileStrategyObj.needs = function('s:TestFileStrategy_needs')
  let testFileStrategyObj.lookup = function('s:TestFileStrategy_lookup')
  let testFileStrategyObj.get_launchable = function('s:TestFileStrategy_get_launchable')
  let testFileStrategyObj.is_test = function('s:TestFileStrategy_is_test')
  return testFileStrategyObj
endfunction

function! s:TestFileStrategy_needs() dict
  return ['finder_facade']
endfunction

function! s:TestFileStrategy_lookup(name) dict
  return self.container.lookup(a:name)
endfunction

function! s:TestFileStrategy_get_launchable(finder_context, options) dict
  let buffers = self.lookup('buffers')
...
function! s:TestFileStrategy_is_test(resource_type) dict
...
function! s:GetFileStrategyConstructor()
  ...
  let getFileStrategyObj.needs = function('s:GetFileStrategy_needs')
  let getFileStrategyObj.first = function('s:GetFileStrategy_first')
  let getFileStrategyObj.get_launchable = function('s:GetFileStrategy_get_launchable')
  let getFileStrategyObj.get_variant = function('s:GetFileStrategy_get_variant')
  return getFileStrategyObj
endfunction

function! s:GetFileStrategy_needs() dict
  return ['finder_facade', 'inflector', 'buffers']
endfunction

function! s:GetFileStrategy_first(filename, finder_context, options) dict
  let query_type = a:finder_context.get_query_type(a:options)
  let template_context = a:finder_context.get_template_context(a:options)
  return self.finder_facade.first(query_type, template_context)
endfunction

function! s:GetFileStrategy_get_launchable(finder_context, options) dict
  let filename = a:options.get_filename()
...
function! s:GetFileStrategy_get_variant(current) dict
  return a:current
endfunction
...
function! s:StripExtStrategyConstructor()
  ...
  let stripExtStrategyObj.get_variant = function('s:StripExtStrategy_get_variant')
  return stripExtStrategyObj
endfunction

function! s:StripExtStrategy_get_variant(current) dict
...
function! s:AffinizeStrategyConstructor()
  ...
  let affinizeStrategyObj.get_variant = function('s:AffinizeStrategy_get_variant')
  return affinizeStrategyObj
endfunction

function! s:AffinizeStrategy_get_variant(current) dict
...
function! s:UnderscorizeStrategyConstructor()
  ...
  let underscorizeStrategyObj.get_variant = function('s:UnderscorizeStrategy_get_variant')
  return underscorizeStrategyObj
endfunction

function! s:UnderscorizeStrategy_get_variant(current) dict
...
function! s:CamelizeStrategyConstructor()
  ...
  let camelizeStrategyObj.get_variant = function('s:CamelizeStrategy_get_variant')
  return camelizeStrategyObj
endfunction

function! s:CamelizeStrategy_get_variant(current) dict
  return self.inflector.camelize(a:current)
endfunction

" included: 'version.riml'
let g:portkey_version = '0.1.14'
" included: 'base_command.riml'
function! s:BaseCommandConstructor()
  let baseCommandObj = {}
  let baseCommandObj.get_command_id = function('s:BaseCommand_get_command_id')
  let baseCommandObj.get_auto_register = function('s:BaseCommand_get_auto_register')
  let baseCommandObj.get_auto_unregister = function('s:BaseCommand_get_auto_unregister')
  let baseCommandObj.has_ex_mode = function('s:BaseCommand_has_ex_mode')
  let baseCommandObj.has_ctrlp_mode = function('s:BaseCommand_has_ctrlp_mode')
  let baseCommandObj.set_registered = function('s:BaseCommand_set_registered')
  let baseCommandObj.has_registered = function('s:BaseCommand_has_registered')
  let baseCommandObj.get_name = function('s:BaseCommand_get_name')
  let baseCommandObj.get_aliases = function('s:BaseCommand_get_aliases')
  let baseCommandObj.get_names = function('s:BaseCommand_get_names')
  let baseCommandObj.get_ctrlp_aliases = function('s:BaseCommand_get_ctrlp_aliases')
  let baseCommandObj.get_ctrlp_names = function('s:BaseCommand_get_ctrlp_names')
  let baseCommandObj.get_display_name = function('s:BaseCommand_get_display_name')
  let baseCommandObj.get_bang = function('s:BaseCommand_get_bang')
  let baseCommandObj.get_bar = function('s:BaseCommand_get_bar')
  let baseCommandObj.get_nargs = function('s:BaseCommand_get_nargs')
  let baseCommandObj.get_buffer = function('s:BaseCommand_get_buffer')
  let baseCommandObj.get_register = function('s:BaseCommand_get_register')
  let baseCommandObj.get_completer = function('s:BaseCommand_get_completer')
  let baseCommandObj.get_range = function('s:BaseCommand_get_range')
  let baseCommandObj.get_count = function('s:BaseCommand_get_count')
  let baseCommandObj.get_options = function('s:BaseCommand_get_options')
  let baseCommandObj.complete = function('s:BaseCommand_complete')
  let baseCommandObj.run = function('s:BaseCommand_run')
...
function! s:PortkeyCommandConstructor(container)
  ...
  let portkeyCommandObj.lookup = function('s:PortkeyCommand_lookup')
  let portkeyCommandObj.process = function('s:PortkeyCommand_process')
  let portkeyCommandObj.get_env_var = function('s:PortkeyCommand_get_env_var')
  let portkeyCommandObj.buffer_has_projection = function('s:PortkeyCommand_buffer_has_projection')
  let portkeyCommandObj.buffer_has_context = function('s:PortkeyCommand_buffer_has_context')
  let portkeyCommandObj.buffer_has_enrolled = function('s:PortkeyCommand_buffer_has_enrolled')
  let portkeyCommandObj.get_current_buffer = function('s:PortkeyCommand_get_current_buffer')
  let portkeyCommandObj.get_current_buffer_path = function('s:PortkeyCommand_get_current_buffer_path')
  let portkeyCommandObj.get_current_buffer_filename = function('s:PortkeyCommand_get_current_buffer_filename')
  let portkeyCommandObj.get_current_buffer_rootname = function('s:PortkeyCommand_get_current_buffer_rootname')
  let portkeyCommandObj.get_current_contexts = function('s:PortkeyCommand_get_current_contexts')
  let portkeyCommandObj.get_current_context = function('s:PortkeyCommand_get_current_context')
  let portkeyCommandObj.get_current_root = function('s:PortkeyCommand_get_current_root')
  let portkeyCommandObj.get_current_projection = function('s:PortkeyCommand_get_current_projection')
  let portkeyCommandObj.get_current_projections = function('s:PortkeyCommand_get_current_projections')
  let portkeyCommandObj.get_current_pattern = function('s:PortkeyCommand_get_current_pattern')
  let portkeyCommandObj.get_current_resource_type = function('s:PortkeyCommand_get_current_resource_type')
  return portkeyCommandObj
endfunction

function! s:PortkeyCommand_lookup(object) dict
...
function! s:PortkeyCommand_process(...) dict
  let registry = self.lookup('registry')
  return call(registry['run_action'], a:000, registry)
endfunction

function! s:PortkeyCommand_get_env_var(name) dict
  return self.lookup('env').get_option(a:name)
endfunction

function! s:PortkeyCommand_buffer_has_projection() dict
  return self.get_current_buffer().has_projection()
endfunction

function! s:PortkeyCommand_buffer_has_context() dict
  return self.get_current_contexts().contains(self.get_current_root())
endfunction

function! s:PortkeyCommand_buffer_has_enrolled() dict
  return self.get_current_buffer().get_enrolled()
endfunction

function! s:PortkeyCommand_get_current_buffer() dict
  return self.lookup('buffers').get_current()
endfunction

function! s:PortkeyCommand_get_current_buffer_path() dict
  return self.get_current_buffer().get_rel_path()
endfunction

function! s:PortkeyCommand_get_current_buffer_filename() dict
  return self.get_current_buffer().get_filename()
endfunction

function! s:PortkeyCommand_get_current_buffer_rootname() dict
  return self.get_current_buffer().get_rootname()
endfunction

function! s:PortkeyCommand_get_current_contexts() dict
  return self.lookup('contexts')
endfunction

function! s:PortkeyCommand_get_current_context() dict
  return self.get_current_contexts().get(self.get_current_root())
endfunction

function! s:PortkeyCommand_get_current_root() dict
  return self.get_current_buffer().get_abs_root()
endfunction

function! s:PortkeyCommand_get_current_projection() dict
  return self.get_current_buffer().get_projection()
endfunction

function! s:PortkeyCommand_get_current_projections() dict
  return self.get_current_context().get_projections()
endfunction

function! s:PortkeyCommand_get_current_pattern() dict
  return self.get_current_buffer().get_pattern()
endfunction

function! s:PortkeyCommand_get_current_resource_type() dict
...
function! s:ConfigureBufferCommandConstructor(container)
  ...
  let configureBufferCommandObj.get_name = function('s:ConfigureBufferCommand_get_name')
  let configureBufferCommandObj.run = function('s:ConfigureBufferCommand_run')
...
function! s:ChangeCurrentBufferCommandConstructor(container)
  ...
  let changeCurrentBufferCommandObj.get_name = function('s:ChangeCurrentBufferCommand_get_name')
  let changeCurrentBufferCommandObj.run = function('s:ChangeCurrentBufferCommand_run')
...
function! s:LoadBufferExCmdsCommandConstructor(container)
  ...
  let loadBufferExCmdsCommandObj.get_name = function('s:LoadBufferExCmdsCommand_get_name')
  let loadBufferExCmdsCommandObj.run = function('s:LoadBufferExCmdsCommand_run')
  return loadBufferExCmdsCommandObj
endfunction

function! s:LoadBufferExCmdsCommand_get_name() dict
  return 'LoadBufferExCmds'
endfunction

function! s:LoadBufferExCmdsCommand_run(opts) dict
...
function! s:MapBuilderConstructor()
  ...
  let mapBuilderObj.append_to = function('s:MapBuilder_append_to')
  let mapBuilderObj.options = function('s:MapBuilder_options')
  let mapBuilderObj.option = function('s:MapBuilder_option')
  let mapBuilderObj.lhs = function('s:MapBuilder_lhs')
  let mapBuilderObj.rhs = function('s:MapBuilder_rhs')
  let mapBuilderObj.mode = function('s:MapBuilder_mode')
  let mapBuilderObj.build = function('s:MapBuilder_build')
  return mapBuilderObj
endfunction

function! s:MapBuilder_append_to(key, str) dict
  let key = "cmd_" . a:key
  let self[key] = self[key] . " " . a:str
endfunction

function! s:MapBuilder_options(opts) dict
  for [name, value] in items(a:opts)
    call self.option(name, value)
  endfor
endfunction

function! s:MapBuilder_option(name, value) dict
...
function! s:MapBuilder_lhs(str) dict
  let self.cmd_lhs = a:str
endfunction

function! s:MapBuilder_rhs(str) dict
  let self.cmd_rhs = a:str
endfunction

function! s:MapBuilder_mode(str) dict
  let self.cmd_mode = a:str
endfunction

function! s:MapBuilder_build() dict
...
function! s:MapLoaderConstructor(Callback)
  ...
  let mapLoaderObj.set_check_conflicts = function('s:MapLoader_set_check_conflicts')
  let mapLoaderObj.get_check_conflicts = function('s:MapLoader_get_check_conflicts')
  let mapLoaderObj.load = function('s:MapLoader_load')
  let mapLoaderObj.unload = function('s:MapLoader_unload')
  let mapLoaderObj.do_mapping = function('s:MapLoader_do_mapping')
  let mapLoaderObj.print = function('s:MapLoader_print')
  let mapLoaderObj.get_callback_expr = function('s:MapLoader_get_callback_expr')
  let mapLoaderObj.has_conflict = function('s:MapLoader_has_conflict')
  return mapLoaderObj
endfunction

function! s:MapLoader_set_check_conflicts(check_conflicts) dict
  let self.check_conflicts = a:check_conflicts
endfunction

function! s:MapLoader_get_check_conflicts() dict
  return self.check_conflicts
endfunction

function! s:MapLoader_load(mappings) dict
  call self.do_mapping(a:mappings, 1)
endfunction

function! s:MapLoader_unload(mappings) dict
  call self.do_mapping(a:mappings, 0)
endfunction

function! s:MapLoader_do_mapping(mappings, do_load) dict
...
function! s:MapLoader_print(mappings) dict
  let i = 0
  for mapping in a:mappings
    let map_keys = mapping.value
    let projection = mapping.source
...
function! s:MapLoader_get_callback_expr(arg) dict
  let callback_name = s:get_delegate_name(self.Callback)
  return ":call " . callback_name . "('" . a:arg . "')<CR>"
endfunction

function! s:MapLoader_has_conflict(keys, force) dict
...
function! s:LoadBufferMappingsCommandConstructor(container)
  ...
  let loadBufferMappingsCommandObj.get_name = function('s:LoadBufferMappingsCommand_get_name')
  let loadBufferMappingsCommandObj.run = function('s:LoadBufferMappingsCommand_run')
  return loadBufferMappingsCommandObj
endfunction

function! s:LoadBufferMappingsCommand_get_name() dict
  return 'LoadBufferMappings'
endfunction

function! s:LoadBufferMappingsCommand_run(opts) dict
...
function! s:MapDelegateConstructor()
  let mapDelegateObj = {}
  let mapDelegateObj.invoke = function('s:MapDelegate_invoke')
  return mapDelegateObj
endfunction

function! s:MapDelegate_invoke(resource_type) dict
...
function! s:LoadGetFileCommandConstructor(container)
  ...
  let loadGetFileCommandObj.get_name = function('s:LoadGetFileCommand_get_name')
  let loadGetFileCommandObj.has_ex_mode = function('s:LoadGetFileCommand_has_ex_mode')
  let loadGetFileCommandObj.has_ctrlp_mode = function('s:LoadGetFileCommand_has_ctrlp_mode')
  let loadGetFileCommandObj.run = function('s:LoadGetFileCommand_run')
  return loadGetFileCommandObj
endfunction

function! s:LoadGetFileCommand_get_name() dict
  return 'LoadGetFile'
endfunction

function! s:LoadGetFileCommand_has_ex_mode() dict
  return self.buffer_has_projection()
endfunction

function! s:LoadGetFileCommand_has_ctrlp_mode() dict
  return self.buffer_has_projection()
endfunction

function! s:LoadGetFileCommand_run(opts) dict
...
function! s:IncludeExprDelegateConstructor(cmd)
  ...
  let includeExprDelegateObj.invoke = function('s:IncludeExprDelegate_invoke')
  return includeExprDelegateObj
endfunction

function! s:IncludeExprDelegate_invoke(filename) dict
...
function! s:LoadSyntaxCommandConstructor(container)
  ...
  let loadSyntaxCommandObj.get_name = function('s:LoadSyntaxCommand_get_name')
  let loadSyntaxCommandObj.run = function('s:LoadSyntaxCommand_run')
...
function! s:ShowVersionCommandConstructor(container)
  ...
  let showVersionCommandObj.get_name = function('s:ShowVersionCommand_get_name')
  let showVersionCommandObj.has_ex_mode = function('s:ShowVersionCommand_has_ex_mode')
  let showVersionCommandObj.run = function('s:ShowVersionCommand_run')
  return showVersionCommandObj
endfunction

function! s:ShowVersionCommand_get_name() dict
  return 'PortkeyVersion'
endfunction

function! s:ShowVersionCommand_has_ex_mode() dict
  return 1
endfunction

function! s:ShowVersionCommand_run(opts) dict
  if self.buffer_has_projection()
    let resource_type = self.get_current_resource_type()
  else
...
function! s:RefreshCommandConstructor(container)
  ...
  let refreshCommandObj.get_name = function('s:RefreshCommand_get_name')
  let refreshCommandObj.has_ex_mode = function('s:RefreshCommand_has_ex_mode')
  let refreshCommandObj.get_auto_unregister = function('s:RefreshCommand_get_auto_unregister')
  let refreshCommandObj.get_bang = function('s:RefreshCommand_get_bang')
  let refreshCommandObj.run = function('s:RefreshCommand_run')
  return refreshCommandObj
endfunction

function! s:RefreshCommand_get_name() dict
  return 'PortkeyRefresh'
endfunction

function! s:RefreshCommand_has_ex_mode() dict
  return 1
endfunction

function! s:RefreshCommand_get_auto_unregister() dict
  return 0
endfunction

function! s:RefreshCommand_get_bang() dict
  return 1
endfunction

function! s:RefreshCommand_run(opts) dict
  if a:opts.bang
    let opts = {}
...
function! s:SwitchFileCommandConstructor(container)
  ...
  let switchFileCommandObj.has_ex_mode = function('s:SwitchFileCommand_has_ex_mode')
  let switchFileCommandObj.has_ctrlp_mode = function('s:SwitchFileCommand_has_ctrlp_mode')
  let switchFileCommandObj.get_ctrlp_aliases = function('s:SwitchFileCommand_get_ctrlp_aliases')
  let switchFileCommandObj.get_nargs = function('s:SwitchFileCommand_get_nargs')
  let switchFileCommandObj.get_bang = function('s:SwitchFileCommand_get_bang')
  let switchFileCommandObj.get_completer = function('s:SwitchFileCommand_get_completer')
  let switchFileCommandObj.complete = function('s:SwitchFileCommand_complete')
  let switchFileCommandObj.run = function('s:SwitchFileCommand_run')
  let switchFileCommandObj.launch = function('s:SwitchFileCommand_launch')
  let switchFileCommandObj.get_finder_context = function('s:SwitchFileCommand_get_finder_context')
  let switchFileCommandObj.get_launcher_strategies = function('s:SwitchFileCommand_get_launcher_strategies')
  let switchFileCommandObj.get_error_label = function('s:SwitchFileCommand_get_error_label')
  let switchFileCommandObj.get_error_msg = function('s:SwitchFileCommand_get_error_msg')
  let switchFileCommandObj.can_complete = function('s:SwitchFileCommand_can_complete')
  let switchFileCommandObj.can_run = function('s:SwitchFileCommand_can_run')
  return switchFileCommandObj
endfunction

function! s:SwitchFileCommand_has_ex_mode() dict
  return self.buffer_has_context() && self.buffer_has_projection()
endfunction

function! s:SwitchFileCommand_has_ctrlp_mode() dict
  return self.buffer_has_context() && self.buffer_has_projection()
endfunction

function! s:SwitchFileCommand_get_ctrlp_aliases() dict
  return [self.get_name()]
endfunction

function! s:SwitchFileCommand_get_nargs() dict
  return '?'
endfunction

function! s:SwitchFileCommand_get_bang() dict
  return 1
endfunction

function! s:SwitchFileCommand_get_completer() dict
  return 'customlist'
endfunction

function! s:SwitchFileCommand_complete(word, cmd_line, cursor) dict
  let opts = {}
...
function! s:SwitchFileCommand_run(...) dict
  let options = self.lookup('command_options')
...
function! s:SwitchFileCommand_launch(strategies, finder_context, options) dict
...
function! s:SwitchFileCommand_get_finder_context() dict
  return ''
endfunction

function! s:SwitchFileCommand_get_launcher_strategies() dict
  return []
endfunction

function! s:SwitchFileCommand_get_error_label(options) dict
  return self.get_name()
endfunction

function! s:SwitchFileCommand_get_error_msg(launchable, options) dict
...
function! s:SwitchFileCommand_can_complete(options) dict
  return self.buffer_has_projection()
endfunction

function! s:SwitchFileCommand_can_run(options) dict
  return self.buffer_has_projection()
endfunction
...
function! s:PortkeyRunnerCommandConstructor(container)
  ...
  let portkeyRunnerCommandObj.get_name = function('s:PortkeyRunnerCommand_get_name')
  let portkeyRunnerCommandObj.get_aliases = function('s:PortkeyRunnerCommand_get_aliases')
  let portkeyRunnerCommandObj.get_nargs = function('s:PortkeyRunnerCommand_get_nargs')
  let portkeyRunnerCommandObj.get_bang = function('s:PortkeyRunnerCommand_get_bang')
  let portkeyRunnerCommandObj.has_ctrlp_mode = function('s:PortkeyRunnerCommand_has_ctrlp_mode')
  let portkeyRunnerCommandObj.get_completer = function('s:PortkeyRunnerCommand_get_completer')
  let portkeyRunnerCommandObj.get_finder_context = function('s:PortkeyRunnerCommand_get_finder_context')
  let portkeyRunnerCommandObj.get_launcher_strategies = function('s:PortkeyRunnerCommand_get_launcher_strategies')
  let portkeyRunnerCommandObj.launch = function('s:PortkeyRunnerCommand_launch')
  let portkeyRunnerCommandObj.make = function('s:PortkeyRunnerCommand_make')
  return portkeyRunnerCommandObj
endfunction

function! s:PortkeyRunnerCommand_get_name() dict
  return 'PortkeyRunner'
endfunction

function! s:PortkeyRunnerCommand_get_aliases() dict
  return ['Run']
endfunction

function! s:PortkeyRunnerCommand_get_nargs() dict
  return '0'
endfunction

function! s:PortkeyRunnerCommand_get_bang() dict
  return 1
endfunction

function! s:PortkeyRunnerCommand_has_ctrlp_mode() dict
  return 0
endfunction

function! s:PortkeyRunnerCommand_get_completer() dict
  return 0
endfunction

function! s:PortkeyRunnerCommand_get_finder_context() dict
  return 'test_finder_context'
endfunction

function! s:PortkeyRunnerCommand_get_launcher_strategies() dict
  return ['test_file_strategy']
endfunction

function! s:PortkeyRunnerCommand_launch(strategies, finder_context, options) dict
  let launcher = self.lookup('launcher')
...
function! s:PortkeyRunnerCommand_make(file, compiler, options) dict
...
function! s:LoadExtensionCommandConstructor(container)
  ...
  let loadExtensionCommandObj.get_name = function('s:LoadExtensionCommand_get_name')
  let loadExtensionCommandObj.run = function('s:LoadExtensionCommand_run')
  return loadExtensionCommandObj
endfunction

function! s:LoadExtensionCommand_get_name() dict
  return 'LoadExtension'
endfunction

function! s:LoadExtensionCommand_run(extension, opts) dict
...
function! s:PortkeyMappingsCommandConstructor(container)
  ...
  let portkeyMappingsCommandObj.get_name = function('s:PortkeyMappingsCommand_get_name')
  let portkeyMappingsCommandObj.has_ex_mode = function('s:PortkeyMappingsCommand_has_ex_mode')
  let portkeyMappingsCommandObj.get_bang = function('s:PortkeyMappingsCommand_get_bang')
  let portkeyMappingsCommandObj.run = function('s:PortkeyMappingsCommand_run')
  return portkeyMappingsCommandObj
endfunction

function! s:PortkeyMappingsCommand_get_name() dict
  return 'PortkeyMappings'
endfunction

function! s:PortkeyMappingsCommand_has_ex_mode() dict
  return 1
endfunction

function! s:PortkeyMappingsCommand_get_bang() dict
  return 1
endfunction

function! s:PortkeyMappingsCommand_run(opts) dict
...
function! s:OpenPortkeyCommandConstructor(controller)
  ...
  let openPortkeyCommandObj.get_name = function('s:OpenPortkeyCommand_get_name')
  let openPortkeyCommandObj.get_aliases = function('s:OpenPortkeyCommand_get_aliases')
  let openPortkeyCommandObj.has_ex_mode = function('s:OpenPortkeyCommand_has_ex_mode')
  let openPortkeyCommandObj.run = function('s:OpenPortkeyCommand_run')
  return openPortkeyCommandObj
endfunction

function! s:OpenPortkeyCommand_get_name() dict
  return 'OpenPortkey'
endfunction

function! s:OpenPortkeyCommand_get_aliases() dict
  return ['PK']
endfunction

function! s:OpenPortkeyCommand_has_ex_mode() dict
  return 1
endfunction

function! s:OpenPortkeyCommand_run(opts) dict
...
function! s:AlternateFileCommandConstructor(container)
  ...
  let alternateFileCommandObj.get_name = function('s:AlternateFileCommand_get_name')
  let alternateFileCommandObj.get_count = function('s:AlternateFileCommand_get_count')
  let alternateFileCommandObj.get_aliases = function('s:AlternateFileCommand_get_aliases')
  let alternateFileCommandObj.get_launcher_strategies = function('s:AlternateFileCommand_get_launcher_strategies')
  let alternateFileCommandObj.get_finder_context = function('s:AlternateFileCommand_get_finder_context')
  return alternateFileCommandObj
endfunction

function! s:AlternateFileCommand_get_name() dict
  return 'Alternate'
endfunction

function! s:AlternateFileCommand_get_count() dict
  return 1
endfunction

function! s:AlternateFileCommand_get_aliases() dict
  return ['AE', 'AS', 'AV', 'AT', 'AD', 'A']
endfunction

function! s:AlternateFileCommand_get_launcher_strategies() dict
  return ['pick_file_strategy', 'nth_file_strategy']
endfunction

function! s:AlternateFileCommand_get_finder_context() dict
...
function! s:RelatedFileCommandConstructor(container)
  ...
  let relatedFileCommandObj.get_name = function('s:RelatedFileCommand_get_name')
  let relatedFileCommandObj.get_count = function('s:RelatedFileCommand_get_count')
  let relatedFileCommandObj.get_aliases = function('s:RelatedFileCommand_get_aliases')
  let relatedFileCommandObj.get_finder_context = function('s:RelatedFileCommand_get_finder_context')
  let relatedFileCommandObj.get_launcher_strategies = function('s:RelatedFileCommand_get_launcher_strategies')
  return relatedFileCommandObj
endfunction

function! s:RelatedFileCommand_get_name() dict
  return 'Related'
endfunction

function! s:RelatedFileCommand_get_count() dict
  return 1
endfunction

function! s:RelatedFileCommand_get_aliases() dict
  return ['RE', 'RS', 'RV', 'RT', 'RD', 'R']
endfunction

function! s:RelatedFileCommand_get_finder_context() dict
  return 'related_finder_context'
endfunction

function! s:RelatedFileCommand_get_launcher_strategies() dict
  return ['pick_file_strategy', 'nth_file_strategy']
endfunction
...
function! s:ResourceFileCommandConstructor(container)
  ...
  let resourceFileCommandObj.get_name = function('s:ResourceFileCommand_get_name')
  let resourceFileCommandObj.has_ex_mode = function('s:ResourceFileCommand_has_ex_mode')
  let resourceFileCommandObj.has_ctrlp_mode = function('s:ResourceFileCommand_has_ctrlp_mode')
  let resourceFileCommandObj.get_range = function('s:ResourceFileCommand_get_range')
  let resourceFileCommandObj.get_aliases = function('s:ResourceFileCommand_get_aliases')
  let resourceFileCommandObj.get_ctrlp_aliases = function('s:ResourceFileCommand_get_ctrlp_aliases')
  let resourceFileCommandObj.get_finder_context = function('s:ResourceFileCommand_get_finder_context')
  let resourceFileCommandObj.get_launcher_strategies = function('s:ResourceFileCommand_get_launcher_strategies')
  let resourceFileCommandObj.get_resource_type_names = function('s:ResourceFileCommand_get_resource_type_names')
  let resourceFileCommandObj.get_error_label = function('s:ResourceFileCommand_get_error_label')
  let resourceFileCommandObj.can_complete = function('s:ResourceFileCommand_can_complete')
  let resourceFileCommandObj.can_run = function('s:ResourceFileCommand_can_run')
  return resourceFileCommandObj
endfunction

function! s:ResourceFileCommand_get_name() dict
  return 'ResourceFile'
endfunction

function! s:ResourceFileCommand_has_ex_mode() dict
  return self.buffer_has_context()
endfunction

function! s:ResourceFileCommand_has_ctrlp_mode() dict
  return self.buffer_has_context()
endfunction

function! s:ResourceFileCommand_get_range() dict
  return 1
endfunction

function! s:ResourceFileCommand_get_aliases() dict
...
function! s:ResourceFileCommand_get_ctrlp_aliases() dict
  return self.get_resource_type_names()
endfunction

function! s:ResourceFileCommand_get_finder_context() dict
  return 'resource_finder_context'
endfunction

function! s:ResourceFileCommand_get_launcher_strategies() dict
  return ['pick_file_strategy', 'new_resource_strategy']
endfunction

function! s:ResourceFileCommand_get_resource_type_names() dict
  let contexts = self.get_current_contexts()
  let root = self.get_current_root()
  if !(contexts.contains(root))
    return []
...
function! s:ResourceFileCommand_get_error_label(options) dict
  let resource_type = a:options.get_resource_type()
...
function! s:ResourceFileCommand_can_complete(options) dict
  if !(self.buffer_has_context())
    return 0
  endif
...
function! s:ResourceFileCommand_can_run(options) dict
  return self.buffer_has_context()
endfunction
...
function! s:GetFileCommandConstructor(container)
  ...
  let getFileCommandObj.get_name = function('s:GetFileCommand_get_name')
  let getFileCommandObj.has_ex_mode = function('s:GetFileCommand_has_ex_mode')
  let getFileCommandObj.has_ctrlp_mode = function('s:GetFileCommand_has_ctrlp_mode')
  let getFileCommandObj.get_finder_context = function('s:GetFileCommand_get_finder_context')
  let getFileCommandObj.get_launcher_strategies = function('s:GetFileCommand_get_launcher_strategies')
  let getFileCommandObj.launch = function('s:GetFileCommand_launch')
  let getFileCommandObj.to_rel_path = function('s:GetFileCommand_to_rel_path')
  return getFileCommandObj
endfunction

function! s:GetFileCommand_get_name() dict
  return 'GetFile'
endfunction

function! s:GetFileCommand_has_ex_mode() dict
  return 0
endfunction

function! s:GetFileCommand_has_ctrlp_mode() dict
  return 0
endfunction

function! s:GetFileCommand_get_finder_context() dict
  return 'get_file_finder_context'
endfunction

function! s:GetFileCommand_get_launcher_strategies() dict
  let s = []
...
function! s:GetFileCommand_launch(strategies, finder_context, options) dict
  let launcher = self.lookup('launcher')
  let launchable = launcher.run(a:strategies, a:finder_context, a:options)
...
function! s:GetFileCommand_to_rel_path(filepath) dict
  let root = self.get_current_root()
...
function! s:LinesExtractorConstructor()
  ...
  let linesExtractorObj.match = function('s:LinesExtractor_match')
  let linesExtractorObj.change_source = function('s:LinesExtractor_change_source')
  let linesExtractorObj.change_destination = function('s:LinesExtractor_change_destination')
  return linesExtractorObj
endfunction

function! s:LinesExtractor_match(context) dict
  return 1
endfunction

function! s:LinesExtractor_change_source(start_line, end_line, opts) dict
  let cmd = ":" . a:start_line . "," . a:end_line . "d"
  execute cmd
endfunction

function! s:LinesExtractor_change_destination(lines, opts) dict
...
function! s:ProjectionFinderConstructor(projector)
  ...
  let projectionFinderObj.find = function('s:ProjectionFinder_find')
  let projectionFinderObj.is_readable = function('s:ProjectionFinder_is_readable')
  return projectionFinderObj
endfunction

function! s:ProjectionFinder_find(context, collector) dict
...
function! s:ProjectionFinder_is_readable(file) dict
...
function! s:ProjectionRankerConstructor()
  ...
  let projectionRankerObj.rank = function('s:ProjectionRanker_rank')
  let projectionRankerObj.get_rootname = function('s:ProjectionRanker_get_rootname')
  return projectionRankerObj
endfunction

function! s:ProjectionRanker_rank(context, rank_items) dict
  let buffer = a:context.lookup('buffer')
...
function! s:ProjectionRanker_get_rootname(path) dict
...
function! s:ResourceFinderConstructor()
  ...
  let resourceFinderObj.needs = function('s:ResourceFinder_needs')
  let resourceFinderObj.find = function('s:ResourceFinder_find')
  return resourceFinderObj
endfunction

function! s:ResourceFinder_needs() dict
  return ['globber']
endfunction

function! s:ResourceFinder_find(context, collector) dict
...
function! s:FileFinderConstructor()
  let fileFinderObj = {}
  let fileFinderObj.find = function('s:FileFinder_find')
  let fileFinderObj.add_candidate = function('s:FileFinder_add_candidate')
  let fileFinderObj.into_pattern = function('s:FileFinder_into_pattern')
  let fileFinderObj.into_rootname = function('s:FileFinder_into_rootname')
  return fileFinderObj
endfunction

function! s:FileFinder_find(context, collector) dict
  let pattern_list = a:context.lookup('pattern_list')
  let buffer = a:context.lookup('buffer')
  let root = buffer.get_abs_root()
...
function! s:FileFinder_add_candidate(collector, root, path) dict
  if filereadable(a:root . a:path)
    call a:collector.add(a:path)
  endif
endfunction

function! s:FileFinder_into_pattern(source, pattern) dict
  return a:pattern.swap(a:source)
endfunction

function! s:FileFinder_into_rootname(source, pattern) dict
...
function! s:CoreExtensionConstructor()
  ...
  let coreExtensionObj.needs = function('s:CoreExtension_needs')
  let coreExtensionObj.get_name = function('s:CoreExtension_get_name')
  let coreExtensionObj.get_scope = function('s:CoreExtension_get_scope')
  let coreExtensionObj.get_portkey_path = function('s:CoreExtension_get_portkey_path')
  let coreExtensionObj.load = function('s:CoreExtension_load')
  let coreExtensionObj.get_finder = function('s:CoreExtension_get_finder')
  let coreExtensionObj.get_ranker = function('s:CoreExtension_get_ranker')
  let coreExtensionObj.get_syntax_files = function('s:CoreExtension_get_syntax_files')
  let coreExtensionObj.get_extractors = function('s:CoreExtension_get_extractors')
  let coreExtensionObj.configure_inflector = function('s:CoreExtension_configure_inflector')
  let coreExtensionObj.configure_projection = function('s:CoreExtension_configure_projection')
  let coreExtensionObj.get_filters = function('s:CoreExtension_get_filters')
  let coreExtensionObj.lookup = function('s:CoreExtension_lookup')
  return coreExtensionObj
endfunction

function! s:CoreExtension_needs() dict
  return ['projector']
endfunction

function! s:CoreExtension_get_name() dict
  return 'core'
endfunction

function! s:CoreExtension_get_scope() dict
  return 'global'
endfunction

function! s:CoreExtension_get_portkey_path(type, variant) dict
  return 'portkey.json'
endfunction

function! s:CoreExtension_load() dict
  return 1
endfunction

function! s:CoreExtension_get_finder(type) dict
...
function! s:CoreExtension_get_ranker(type) dict
  if a:type ==# 'projection'
...
function! s:CoreExtension_get_syntax_files() dict
  return {}
endfunction

function! s:CoreExtension_get_extractors() dict
  return [s:LinesExtractorConstructor()]
endfunction

function! s:CoreExtension_configure_inflector(inflector) dict
endfunction

function! s:CoreExtension_configure_projection(projection) dict
endfunction

function! s:CoreExtension_get_filters() dict
  return {}
endfunction

function! s:CoreExtension_lookup(name) dict
  return self.container.lookup(a:name)
endfunction
...
function! s:ContainerConstructor(parent)
  ...
  let containerObj.register = function('s:Container_register')
  let containerObj.unregister = function('s:Container_unregister')
  let containerObj.lookup = function('s:Container_lookup')
  let containerObj.has = function('s:Container_has')
  let containerObj.has_parent = function('s:Container_has_parent')
  let containerObj.inject = function('s:Container_inject')
  let containerObj.child = function('s:Container_child')
  let containerObj.get_parent = function('s:Container_get_parent')
  return containerObj
endfunction
...
function! s:ContainerObjectConstructor(classname, singleton)
  ...
  let containerObjectObj.get_instance = function('s:ContainerObject_get_instance')
  let containerObjectObj.set_instance = function('s:ContainerObject_set_instance')
  let containerObjectObj.instantiated = function('s:ContainerObject_instantiated')
  let containerObjectObj.needs_new_instance = function('s:ContainerObject_needs_new_instance')
  let containerObjectObj.create = function('s:ContainerObject_create')
...
function! s:ControllerConstructor()
  let controllerObj = {}
  let controllerObj.process = function('s:Controller_process')
  let controllerObj.load = function('s:Controller_load')
  let controllerObj.configure_container = function('s:Controller_configure_container')
  let controllerObj.load_commands = function('s:Controller_load_commands')
  let controllerObj.load_core_extension = function('s:Controller_load_core_extension')
...
function! s:Controller_load_core_extension() dict
...
function! s:AppConstructor()
  ...
  let appObj.start = function('s:App_start')
  let appObj.on_buffer_open = function('s:App_on_buffer_open')
  let appObj.on_buffer_enter = function('s:App_on_buffer_enter')
  let appObj.on_buffer_leave = function('s:App_on_buffer_leave')
  let appObj.add_extension = function('s:App_add_extension')
  return appObj
endfunction
...
function! s:App_add_extension(extension) dict
...
function! s:ObjectCacheConstructor()
  ...
  let objectCacheObj.has = function('s:ObjectCache_has')
  let objectCacheObj.add = function('s:ObjectCache_add')
  let objectCacheObj.insert = function('s:ObjectCache_insert')
  let objectCacheObj.put = function('s:ObjectCache_put')
  let objectCacheObj.get = function('s:ObjectCache_get')
  let objectCacheObj.remove = function('s:ObjectCache_remove')
  let objectCacheObj.clear = function('s:ObjectCache_clear')
  let objectCacheObj.clear_all = function('s:ObjectCache_clear_all')
  let objectCacheObj.get_hits = function('s:ObjectCache_get_hits')
  let objectCacheObj.get_misses = function('s:ObjectCache_get_misses')
  return objectCacheObj
endfunction

function! s:ObjectCache_has(key) dict
  return has_key(self.cache, a:key)
endfunction

function! s:ObjectCache_add(key, value) dict
  if !(self.has(a:key))
...
function! s:ObjectCache_insert(key, value) dict
  if !(self.has(a:key))
    let self.cache[a:key] = []
  endif
  let list = self.cache[a:key]
...
function! s:ObjectCache_put(key, value) dict
  let self.cache[a:key] = a:value
  let self.misses += 1
endfunction

function! s:ObjectCache_get(key) dict
  let self.hits += 1
  return self.cache[a:key]
endfunction

function! s:ObjectCache_remove(key) dict
  if self.has(a:key)
    unlet self.cache[a:key]
  endif
endfunction

function! s:ObjectCache_clear(...) dict
  if len(a:000) ==# 1
    let pattern = a:000[0]
  else
...
function! s:ObjectCache_clear_all() dict
  unlet self.cache
  let self.cache = {}
  let self.hits = 0
  let self.misses = 0
...
function! s:ObjectCache_get_hits() dict
  return self.hits
endfunction

function! s:ObjectCache_get_misses() dict
  return self.misses
endfunction
...
function! s:MemoizerDelegateConstructor(target, method, cache_store, memoizer)
  ...
  let memoizerDelegateObj.get_key = function('s:MemoizerDelegate_get_key')
  let memoizerDelegateObj.invoke = function('s:MemoizerDelegate_invoke')
  return memoizerDelegateObj
endfunction

function! s:MemoizerDelegate_get_key(args) dict
  if len(a:args) ==# 0
...
function! s:MemoizerDelegate_invoke(...) dict
...
function! s:MemoizerConstructor(target)
  ...
  let memoizerObj.memoizer_get_target = function('s:Memoizer_memoizer_get_target')
  let memoizerObj.memoizer_load_method = function('s:Memoizer_memoizer_load_method')
  let memoizerObj.memoizer_load = function('s:Memoizer_memoizer_load')
  let memoizerObj.memoizer_load_all = function('s:Memoizer_memoizer_load_all')
  let memoizerObj.memoizer_start = function('s:Memoizer_memoizer_start')
  let memoizerObj.memoizer_stop = function('s:Memoizer_memoizer_stop')
  let memoizerObj.memoizer_is_active = function('s:Memoizer_memoizer_is_active')
  let memoizerObj.memoizer_clear_cache = function('s:Memoizer_memoizer_clear_cache')
  let memoizerObj.memoizer_clear_all = function('s:Memoizer_memoizer_clear_all')
  let memoizerObj.memoizer_get_hits = function('s:Memoizer_memoizer_get_hits')
  let memoizerObj.memoizer_get_misses = function('s:Memoizer_memoizer_get_misses')
  return memoizerObj
endfunction

function! s:Memoizer_memoizer_get_target() dict
  return self.memoizer_target
endfunction

function! s:Memoizer_memoizer_load_method(Method) dict
...
function! s:Memoizer_memoizer_load(...) dict
...
function! s:Memoizer_memoizer_load_all() dict
...
function! s:Memoizer_memoizer_start() dict
  call self.memoizer_clear_all()
  let self.memoizer_active = 1
endfunction

function! s:Memoizer_memoizer_stop() dict
  let self.memoizer_active = 0
endfunction

function! s:Memoizer_memoizer_is_active() dict
  return self.memoizer_active
endfunction

function! s:Memoizer_memoizer_clear_cache(method) dict
  let cache_store = self.memoizer_cache[a:method]
  call cache_store.clear()
endfunction

function! s:Memoizer_memoizer_clear_all() dict
  for method in keys(self.memoizer_cache)
    call self.memoizer_clear_cache(method)
  endfor
endfunction

function! s:Memoizer_memoizer_get_hits() dict
  let hits = 0
...
function! s:Memoizer_memoizer_get_misses() dict
  let misses = 0
  for cache_store in values(self.memoizer_cache)
...
function! s:LexerConstructor()
  let lexerObj = {}
  let lexerObj.next = function('s:Lexer_next')
  let lexerObj.backup = function('s:Lexer_backup')
  let lexerObj.peek = function('s:Lexer_peek')
  let lexerObj.ignore = function('s:Lexer_ignore')
  let lexerObj.ignore_whitespace = function('s:Lexer_ignore_whitespace')
  let lexerObj.advance = function('s:Lexer_advance')
  let lexerObj.accept = function('s:Lexer_accept')
  let lexerObj.accept_run = function('s:Lexer_accept_run')
  let lexerObj.accept_keyword = function('s:Lexer_accept_keyword')
  let lexerObj.emit = function('s:Lexer_emit')
  let lexerObj.emit_text = function('s:Lexer_emit_text')
  let lexerObj.was_text_last_emitted = function('s:Lexer_was_text_last_emitted')
  let lexerObj.scan = function('s:Lexer_scan')
  let lexerObj.run = function('s:Lexer_run')
  let lexerObj.is_state = function('s:Lexer_is_state')
  let lexerObj.is_ahead = function('s:Lexer_is_ahead')
  let lexerObj.is_whitespace = function('s:Lexer_is_whitespace')
  let lexerObj.error = function('s:Lexer_error')
  let lexerObj.print_cursor = function('s:Lexer_print_cursor')
  let lexerObj.print_stream = function('s:Lexer_print_stream')
  return lexerObj
endfunction

function! s:Lexer_next() dict
...
function! s:Lexer_backup() dict
  let self.pos -= self.width
endfunction

function! s:Lexer_peek() dict
  let rune = self.next()
  call self.backup()
  return rune
endfunction

function! s:Lexer_ignore() dict
  let self.start = self.pos
endfunction

function! s:Lexer_ignore_whitespace() dict
...
function! s:Lexer_advance() dict
  call self.next()
  call self.ignore()
endfunction

function! s:Lexer_accept(valid) dict
  let rune = self.next()
...
function! s:Lexer_accept_run(valid) dict
  while self.accept(a:valid)
  endwhile
endfunction

function! s:Lexer_accept_keyword() dict
  call self.accept_run(s:charsKeyword)
endfunction

function! s:Lexer_emit(token_type) dict
...
function! s:Lexer_emit_text() dict
  if self.is_ahead()
...
function! s:Lexer_was_text_last_emitted() dict
...
function! s:Lexer_scan(input) dict
...
function! s:Lexer_is_state(state) dict
  return !has_key(a:state, 'is_null')
endfunction

function! s:Lexer_is_ahead() dict
  return self.pos ># self.start
endfunction

function! s:Lexer_is_whitespace(char) dict
  return a:char ==# ' ' || a:char ==# "\t"
endfunction

function! s:Lexer_error(msg) dict
  let str = strpart(self.input, 0, self.pos + 5)
  let msg = "LexicalError: " . a:msg . " for input: '" . str . "'"
  throw msg
endfunction

function! s:Lexer_print_cursor() dict
  let cursors = ''
  let index = 0
...
function! s:Lexer_print_stream() dict
  let i = 0
...
function! s:UppercaseFilterConstructor()
  ...
  let uppercaseFilterObj.filter = function('s:UppercaseFilter_filter')
  return uppercaseFilterObj
endfunction

function! s:UppercaseFilter_filter(str) dict
  return toupper(a:str)
endfunction

function! s:LowercaseFilterConstructor()
  let lowercaseFilterObj = {}
  let lowercaseFilterObj.filter = function('s:LowercaseFilter_filter')
  return lowercaseFilterObj
endfunction

function! s:LowercaseFilter_filter(str) dict
  return tolower(a:str)
endfunction

function! s:InflectorFilterConstructor()
  let inflectorFilterObj = {}
  let inflectorFilterObj.set_inflector = function('s:InflectorFilter_set_inflector')
  return inflectorFilterObj
endfunction

function! s:InflectorFilter_set_inflector(inflector) dict
...
function! s:PluralFilterConstructor()
  ...
  let pluralFilterObj.filter = function('s:PluralFilter_filter')
  return pluralFilterObj
endfunction

function! s:PluralFilter_filter(str) dict
...
function! s:SingularFilterConstructor()
  ...
  let singularFilterObj.filter = function('s:SingularFilter_filter')
  return singularFilterObj
endfunction

function! s:SingularFilter_filter(str) dict
...
function! s:CamelcaseFilterConstructor()
  ...
  let camelcaseFilterObj.filter = function('s:CamelcaseFilter_filter')
  return camelcaseFilterObj
endfunction

function! s:CamelcaseFilter_filter(str) dict
...
function! s:LowerCamelcaseFilterConstructor()
  ...
  let lowerCamelcaseFilterObj.filter = function('s:LowerCamelcaseFilter_filter')
  return lowerCamelcaseFilterObj
endfunction

function! s:LowerCamelcaseFilter_filter(str) dict
...
function! s:UnderscoreFilterConstructor()
  ...
  let underscoreFilterObj.filter = function('s:UnderscoreFilter_filter')
  return underscoreFilterObj
endfunction

function! s:UnderscoreFilter_filter(str) dict
...
function! s:HumanFilterConstructor()
  ...
  let humanFilterObj.filter = function('s:HumanFilter_filter')
  return humanFilterObj
endfunction

function! s:HumanFilter_filter(str) dict
...
function! s:DashFilterConstructor()
  ...
  let dashFilterObj.filter = function('s:DashFilter_filter')
  return dashFilterObj
endfunction

function! s:DashFilter_filter(str) dict
...
function! s:TitleFilterConstructor()
  ...
  let titleFilterObj.filter = function('s:TitleFilter_filter')
  return titleFilterObj
endfunction

function! s:TitleFilter_filter(str) dict
...
function! s:TableFilterConstructor()
  ...
  let tableFilterObj.filter = function('s:TableFilter_filter')
  return tableFilterObj
endfunction

function! s:TableFilter_filter(str) dict
...
function! s:ClassFilterConstructor()
  ...
  let classFilterObj.filter = function('s:ClassFilter_filter')
  return classFilterObj
endfunction

function! s:ClassFilter_filter(str) dict
...
function! s:BaseFilterFactoryConstructor()
  ...
  let baseFilterFactoryObj.needs = function('s:BaseFilterFactory_needs')
  let baseFilterFactoryObj.has_filter = function('s:BaseFilterFactory_has_filter')
  let baseFilterFactoryObj.add_filter = function('s:BaseFilterFactory_add_filter')
  let baseFilterFactoryObj.get_filter = function('s:BaseFilterFactory_get_filter')
  let baseFilterFactoryObj.configure_filter = function('s:BaseFilterFactory_configure_filter')
  return baseFilterFactoryObj
endfunction

function! s:BaseFilterFactory_needs() dict
  return ['inflector']
endfunction

function! s:BaseFilterFactory_has_filter(name) dict
  return has_key(self.filters, a:name)
endfunction

function! s:BaseFilterFactory_add_filter(name, filter) dict
  let self.filters[a:name] = a:filter
  call self.configure_filter(a:filter)
endfunction

function! s:BaseFilterFactory_get_filter(name) dict
  return self.filters[a:name]
endfunction

function! s:BaseFilterFactory_configure_filter(filter) dict
...
function! s:FilterFactoryConstructor()
  ...
  let filterFactoryObj.on_inject = function('s:FilterFactory_on_inject')
  let filterFactoryObj.load_defaults = function('s:FilterFactory_load_defaults')
  return filterFactoryObj
endfunction

function! s:FilterFactory_on_inject() dict
  call self.load_defaults()
endfunction

function! s:FilterFactory_load_defaults() dict
...
function! s:TemplateObjectConstructor()
  ...
  let templateObjectObj.append = function('s:TemplateObject_append')
  let templateObjectObj.render = function('s:TemplateObject_render')
  return templateObjectObj
endfunction

function! s:TemplateObject_append(object) dict
  call add(self.objects, a:object)
endfunction

function! s:TemplateObject_render(context) dict
  let str = ''
...
function! s:TextObjectConstructor(text)
  ...
  let textObjectObj.render = function('s:TextObject_render')
  return textObjectObj
endfunction

function! s:TextObject_render(context) dict
  return self.text
endfunction
...
function! s:PlaceholderObjectConstructor(name)
  ...
  let placeholderObjectObj.set_filter_factory = function('s:PlaceholderObject_set_filter_factory')
  let placeholderObjectObj.add_filter = function('s:PlaceholderObject_add_filter')
  let placeholderObjectObj.filter = function('s:PlaceholderObject_filter')
  let placeholderObjectObj.render = function('s:PlaceholderObject_render')
  return placeholderObjectObj
endfunction

function! s:PlaceholderObject_set_filter_factory(factory) dict
  let self.filter_factory = a:factory
endfunction

function! s:PlaceholderObject_add_filter(filter_name) dict
  call add(self.filters, a:filter_name)
endfunction

function! s:PlaceholderObject_filter(filter_name, str) dict
...
function! s:PlaceholderObject_render(context) dict
...
function! s:NewlineObjectConstructor()
  ...
  let newlineObjectObj.render = function('s:NewlineObject_render')
  return newlineObjectObj
endfunction

function! s:NewlineObject_render(context) dict
  return "\n"
endfunction
...
function! s:TabObjectConstructor()
  ...
  let tabObjectObj.render = function('s:TabObject_render')
  return tabObjectObj
endfunction

function! s:TabObject_render(context) dict
  if &expandtab
...
function! s:CompilerConstructor()
  ...
  let compilerObj.needs = function('s:Compiler_needs')
  let compilerObj.get_object = function('s:Compiler_get_object')
  let compilerObj.get_key_name_for_modifier = function('s:Compiler_get_key_name_for_modifier')
  let compilerObj.get_filter_for_modifier = function('s:Compiler_get_filter_for_modifier')
  let compilerObj.is_placeholder = function('s:Compiler_is_placeholder')
  let compilerObj.is_filter = function('s:Compiler_is_filter')
  let compilerObj.is_eof = function('s:Compiler_is_eof')
  let compilerObj.is_visible = function('s:Compiler_is_visible')
  let compilerObj.compile = function('s:Compiler_compile')
  return compilerObj
endfunction

function! s:Compiler_needs() dict
  return ['filter_factory']
endfunction

function! s:Compiler_get_object(token) dict
...
function! s:Compiler_get_key_name_for_modifier(modifier) dict
  if a:modifier ==# 's'
    return 'source'
  elseif a:modifier ==# '%'
    return 'source_path'
...
function! s:Compiler_get_filter_for_modifier(modifier) dict
...
function! s:Compiler_is_placeholder(object) dict
  return has_key(a:object, 'is_placeholder')
endfunction

function! s:Compiler_is_filter(object) dict
  return has_key(a:object, 'is_filter')
endfunction

function! s:Compiler_is_eof(object) dict
  return has_key(a:object, 'is_eof')
endfunction

function! s:Compiler_is_visible(object) dict
  return !(self.is_filter(a:object) || self.is_eof(a:object))
endfunction

function! s:Compiler_compile(tokens) dict
...
function! s:CommandBuilderConstructor()
  ...
  let commandBuilderObj.ex_cmd = function('s:CommandBuilder_ex_cmd')
  let commandBuilderObj.append_to = function('s:CommandBuilder_append_to')
  let commandBuilderObj.option = function('s:CommandBuilder_option')
  let commandBuilderObj.options = function('s:CommandBuilder_options')
  let commandBuilderObj.param = function('s:CommandBuilder_param')
  let commandBuilderObj.name = function('s:CommandBuilder_name')
  let commandBuilderObj.repr = function('s:CommandBuilder_repr')
  let commandBuilderObj.build = function('s:CommandBuilder_build')
...
function! s:CtrlPExtensionConstructor()
  ...
  let ctrlPExtensionObj.next_id = function('s:CtrlPExtension_next_id')
  let ctrlPExtensionObj.set_options = function('s:CtrlPExtension_set_options')
  let ctrlPExtensionObj.get_options = function('s:CtrlPExtension_get_options')
  let ctrlPExtensionObj.set_name = function('s:CtrlPExtension_set_name')
  let ctrlPExtensionObj.get_name = function('s:CtrlPExtension_get_name')
  let ctrlPExtensionObj.set_agent = function('s:CtrlPExtension_set_agent')
  let ctrlPExtensionObj.get_agent = function('s:CtrlPExtension_get_agent')
  let ctrlPExtensionObj.get_ext_vars = function('s:CtrlPExtension_get_ext_vars')
  let ctrlPExtensionObj.get_id = function('s:CtrlPExtension_get_id')
  let ctrlPExtensionObj.get_ex_cmd_name = function('s:CtrlPExtension_get_ex_cmd_name')
  let ctrlPExtensionObj.enable = function('s:CtrlPExtension_enable')
  let ctrlPExtensionObj.disable = function('s:CtrlPExtension_disable')
  let ctrlPExtensionObj.show = function('s:CtrlPExtension_show')
  let ctrlPExtensionObj.do_init = function('s:CtrlPExtension_do_init')
  let ctrlPExtensionObj.do_accept = function('s:CtrlPExtension_do_accept')
  let ctrlPExtensionObj.do_enter = function('s:CtrlPExtension_do_enter')
  let ctrlPExtensionObj.do_exit = function('s:CtrlPExtension_do_exit')
  let ctrlPExtensionObj.do_opts = function('s:CtrlPExtension_do_opts')
  let ctrlPExtensionObj.get_callback = function('s:CtrlPExtension_get_callback')
  let ctrlPExtensionObj.new_callback = function('s:CtrlPExtension_new_callback')
...
function! s:CommandRegistryConstructor()
  ...
  let commandRegistryObj.next_command_id = function('s:CommandRegistry_next_command_id')
  let commandRegistryObj.add = function('s:CommandRegistry_add')
  let commandRegistryObj.remove = function('s:CommandRegistry_remove')
  let commandRegistryObj.unregister = function('s:CommandRegistry_unregister')
  let commandRegistryObj.remove_all = function('s:CommandRegistry_remove_all')
  let commandRegistryObj.count = function('s:CommandRegistry_count')
  let commandRegistryObj.auto_register = function('s:CommandRegistry_auto_register')
  let commandRegistryObj.register = function('s:CommandRegistry_register')
  let commandRegistryObj.register_ex_commands = function('s:CommandRegistry_register_ex_commands')
  let commandRegistryObj.register_ctrlp_commands = function('s:CommandRegistry_register_ctrlp_commands')
  let commandRegistryObj.remove_command = function('s:CommandRegistry_remove_command')
  let commandRegistryObj.remove_action = function('s:CommandRegistry_remove_action')
  let commandRegistryObj.unregister_command = function('s:CommandRegistry_unregister_command')
  let commandRegistryObj.unregister_ctrlp_command = function('s:CommandRegistry_unregister_ctrlp_command')
  let commandRegistryObj.find = function('s:CommandRegistry_find')
  let commandRegistryObj.register_ex_command = function('s:CommandRegistry_register_ex_command')
  let commandRegistryObj.command_has_name = function('s:CommandRegistry_command_has_name')
  let commandRegistryObj.new_callback = function('s:CommandRegistry_new_callback')
  let commandRegistryObj.get_callback = function('s:CommandRegistry_get_callback')
  let commandRegistryObj.get_completer = function('s:CommandRegistry_get_completer')
  let commandRegistryObj.register_command = function('s:CommandRegistry_register_command')
  let commandRegistryObj.register_commands = function('s:CommandRegistry_register_commands')
  let commandRegistryObj.run_command = function('s:CommandRegistry_run_command')
  let commandRegistryObj.run_action = function('s:CommandRegistry_run_action')
  let commandRegistryObj.complete_command = function('s:CommandRegistry_complete_command')
  let commandRegistryObj.is_cmd = function('s:CommandRegistry_is_cmd')
  let commandRegistryObj.has_bang = function('s:CommandRegistry_has_bang')
  let commandRegistryObj.has_range = function('s:CommandRegistry_has_range')
  let commandRegistryObj.has_count = function('s:CommandRegistry_has_count')
  let commandRegistryObj.get_display_name = function('s:CommandRegistry_get_display_name')
  let commandRegistryObj.find_by_id = function('s:CommandRegistry_find_by_id')
  let commandRegistryObj.has_action = function('s:CommandRegistry_has_action')
  let commandRegistryObj.register_ctrlp_command = function('s:CommandRegistry_register_ctrlp_command')
  let commandRegistryObj.has_ctrlp = function('s:CommandRegistry_has_ctrlp')
  let commandRegistryObj.get_ctrlp_extension = function('s:CommandRegistry_get_ctrlp_extension')
  let commandRegistryObj.get_ctrlp_agent = function('s:CommandRegistry_get_ctrlp_agent')
  let commandRegistryObj.get_self_callback = function('s:CommandRegistry_get_self_callback')
  let commandRegistryObj.get_ctrlp_callback = function('s:CommandRegistry_get_ctrlp_callback')
  let commandRegistryObj.get_ctrlp_repr = function('s:CommandRegistry_get_ctrlp_repr')
  let commandRegistryObj.unlink = function('s:CommandRegistry_unlink')
...
function! s:CompleteDelegateConstructor(registry, id, name)
  ...
  let completeDelegateObj.invoke = function('s:CompleteDelegate_invoke')
...
function! s:CtrlPDelegateConstructor(extension, registry)
  ...
  let ctrlPDelegateObj.invoke = function('s:CtrlPDelegate_invoke')
  return ctrlPDelegateObj
endfunction

function! s:CtrlPDelegate_invoke(id, name) dict
...
function! s:CtrlPAgentConstructor(registry)
  ...
  let ctrlPAgentObj.init = function('s:CtrlPAgent_init')
  let ctrlPAgentObj.accept = function('s:CtrlPAgent_accept')
  let ctrlPAgentObj.enter = function('s:CtrlPAgent_enter')
  let ctrlPAgentObj.exit = function('s:CtrlPAgent_exit')
  let ctrlPAgentObj.opts = function('s:CtrlPAgent_opts')
  let ctrlPAgentObj.set_command = function('s:CtrlPAgent_set_command')
  let ctrlPAgentObj.has_command = function('s:CtrlPAgent_has_command')
...
function! s:ProjectionTemplateConstructor(original)
  ...
  let projectionTemplateObj.get_original = function('s:ProjectionTemplate_get_original')
  let projectionTemplateObj.get_compiled = function('s:ProjectionTemplate_get_compiled')
  let projectionTemplateObj.has_error = function('s:ProjectionTemplate_has_error')
  let projectionTemplateObj.get_error = function('s:ProjectionTemplate_get_error')
  let projectionTemplateObj.compile = function('s:ProjectionTemplate_compile')
  let projectionTemplateObj.render = function('s:ProjectionTemplate_render')
  let projectionTemplateObj.is_compiled = function('s:ProjectionTemplate_is_compiled')
  return projectionTemplateObj
endfunction

function! s:ProjectionTemplate_get_original() dict
  return self.original
endfunction

function! s:ProjectionTemplate_get_compiled() dict
  return self.compiled
endfunction

function! s:ProjectionTemplate_has_error() dict
  return self.error !=# ''
endfunction

function! s:ProjectionTemplate_get_error() dict
  return self.error
endfunction

function! s:ProjectionTemplate_compile(lexer, compiler) dict
  try
    let self.error = ''
...
function! s:ProjectionTemplate_render(context) dict
  if self.is_compiled()
...
function! s:ProjectionTemplate_is_compiled() dict
...
function! s:ProjectionPatternConstructor(original, projection)
  ...
  let projectionPatternObj.get_original = function('s:ProjectionPattern_get_original')
  let projectionPatternObj.get_projection = function('s:ProjectionPattern_get_projection')
  let projectionPatternObj.swap = function('s:ProjectionPattern_swap')
  let projectionPatternObj.get_regex = function('s:ProjectionPattern_get_regex')
  let projectionPatternObj.has_template = function('s:ProjectionPattern_has_template')
  let projectionPatternObj.set_template = function('s:ProjectionPattern_set_template')
  let projectionPatternObj.get_template = function('s:ProjectionPattern_get_template')
  let projectionPatternObj.is_recursive = function('s:ProjectionPattern_is_recursive')
  return projectionPatternObj
endfunction

function! s:ProjectionPattern_get_original() dict
  return self.original
endfunction

function! s:ProjectionPattern_get_projection() dict
  return self.projection
endfunction

function! s:ProjectionPattern_swap(filename) dict
...
function! s:ProjectionPattern_get_regex() dict
...
function! s:ProjectionPattern_has_template() dict
  return has_key(self, 'template')
endfunction

function! s:ProjectionPattern_set_template(template) dict
  let self.template = s:ProjectionTemplateConstructor(a:template)
endfunction

function! s:ProjectionPattern_get_template() dict
  return self.template
endfunction

function! s:ProjectionPattern_is_recursive() dict
...
function! s:ProjectionMatcherConstructor(map)
  ...
  let projectionMatcherObj.match = function('s:ProjectionMatcher_match')
  let projectionMatcherObj.get_pattern_store = function('s:ProjectionMatcher_get_pattern_store')
  let projectionMatcherObj.set_updated = function('s:ProjectionMatcher_set_updated')
  let projectionMatcherObj.get_updated = function('s:ProjectionMatcher_get_updated')
  let projectionMatcherObj.get_patterns = function('s:ProjectionMatcher_get_patterns')
  let projectionMatcherObj.sort_projections = function('s:ProjectionMatcher_sort_projections')
  let projectionMatcherObj.update = function('s:ProjectionMatcher_update')
  let projectionMatcherObj.get_callback = function('s:ProjectionMatcher_get_callback')
  let projectionMatcherObj.compare_patterns = function('s:ProjectionMatcher_compare_patterns')
  let projectionMatcherObj.compare_alphabetical = function('s:ProjectionMatcher_compare_alphabetical')
  return projectionMatcherObj
endfunction

function! s:ProjectionMatcher_match(path, order) dict
...
function! s:ProjectionMatcher_get_pattern_store(order) dict
  return a:order . "_patterns"
endfunction

function! s:ProjectionMatcher_set_updated(order) dict
  let key = a:order . "_updated"
  let self[key] = 1
endfunction

function! s:ProjectionMatcher_get_updated(order) dict
  let key = a:order . "_updated"
  return has_key(self, key) && self[key]
endfunction

function! s:ProjectionMatcher_get_patterns(order) dict
...
function! s:ProjectionMatcher_sort_projections(projections, order) dict
...
function! s:ProjectionMatcher_update() dict
  let self.asc_updated = 0
  let self.desc_updated = 0
endfunction

function! s:ProjectionMatcher_get_callback() dict
...
function! s:ProjectionMatcher_compare_patterns(a, b) dict
...
function! s:ProjectionMatcher_compare_alphabetical(a, b) dict
  if a:a <# a:b
    let result = -1
  elseif a:a ># a:b
    let result = 1
...
function! s:ProjectionMatchConstructor(ok)
  ...
  let projectionMatchObj.set_input = function('s:ProjectionMatch_set_input')
  let projectionMatchObj.get_input = function('s:ProjectionMatch_get_input')
  let projectionMatchObj.set_source = function('s:ProjectionMatch_set_source')
  let projectionMatchObj.get_source = function('s:ProjectionMatch_get_source')
  let projectionMatchObj.set_pattern = function('s:ProjectionMatch_set_pattern')
  let projectionMatchObj.get_pattern = function('s:ProjectionMatch_get_pattern')
  return projectionMatchObj
endfunction

function! s:ProjectionMatch_set_input(input) dict
  let self.input = a:input
endfunction

function! s:ProjectionMatch_get_input() dict
  return self.input
endfunction

function! s:ProjectionMatch_set_source(source) dict
  let self.source = a:source
endfunction

function! s:ProjectionMatch_get_source() dict
  return self.source
endfunction

function! s:ProjectionMatch_set_pattern(pattern) dict
  let self.pattern = a:pattern
endfunction

function! s:ProjectionMatch_get_pattern() dict
  return self.pattern
endfunction
...
function! s:ProjectionConstructor(resource_type)
  ...
  let projectionObj.get_revision = function('s:Projection_get_revision')
  let projectionObj.bump_revision = function('s:Projection_bump_revision')
  let projectionObj.get_id = function('s:Projection_get_id')
  let projectionObj.get_hash = function('s:Projection_get_hash')
  let projectionObj.has_pattern = function('s:Projection_has_pattern')
  let projectionObj.add_pattern = function('s:Projection_add_pattern')
  let projectionObj.get_patterns = function('s:Projection_get_patterns')
  let projectionObj.match = function('s:Projection_match')
  let projectionObj.get_compare_func = function('s:Projection_get_compare_func')
  let projectionObj.has_projection_template = function('s:Projection_has_projection_template')
  let projectionObj.get_projection_templates = function('s:Projection_get_projection_templates')
  let projectionObj.add_projection_template = function('s:Projection_add_projection_template')
  let projectionObj.get_resource_type = function('s:Projection_get_resource_type')
  let projectionObj.has_keyword = function('s:Projection_has_keyword')
  let projectionObj.add_keyword = function('s:Projection_add_keyword')
  let projectionObj.get_keyword_list = function('s:Projection_get_keyword_list')
  let projectionObj.set_affinity = function('s:Projection_set_affinity')
  let projectionObj.get_affinity = function('s:Projection_get_affinity')
  let projectionObj.get_mapping = function('s:Projection_get_mapping')
  let projectionObj.set_mapping = function('s:Projection_set_mapping')
  let projectionObj.has_mapping = function('s:Projection_has_mapping')
  let projectionObj.get_compiler = function('s:Projection_get_compiler')
  let projectionObj.set_compiler = function('s:Projection_set_compiler')
  let projectionObj.has_compiler = function('s:Projection_has_compiler')
  let projectionObj.get_scope = function('s:Projection_get_scope')
  let projectionObj.set_scope = function('s:Projection_set_scope')
  let projectionObj.has_scope = function('s:Projection_has_scope')
  return projectionObj
endfunction

function! s:Projection_get_revision() dict
  return self.revision
endfunction

function! s:Projection_bump_revision() dict
  let self.revision += 1
endfunction

function! s:Projection_get_id() dict
  return self.id
endfunction

function! s:Projection_get_hash() dict
  return self.id . "-" . self.revision
endfunction

function! s:Projection_has_pattern(pattern) dict
...
function! s:Projection_add_pattern(pattern) dict
  let pattern_obj = s:ProjectionPatternConstructor(a:pattern, self)
  call add(self.patterns, pattern_obj)
  return pattern_obj
endfunction

function! s:Projection_get_patterns() dict
  return self.patterns
endfunction

function! s:Projection_match(filename) dict
...
function! s:Projection_get_compare_func() dict
  let matcher = s:ProjectionMatcherConstructor({})
  let CompareFunc = s:create_delegate(matcher, 'compare_patterns')
  return CompareFunc
endfunction

function! s:Projection_has_projection_template(projection_type, template_str) dict
...
function! s:Projection_get_projection_templates(projection_type) dict
  return self.projection_templates[a:projection_type]
endfunction

function! s:Projection_add_projection_template(projection_type, ...) dict
  let templates = self.get_projection_templates(a:projection_type)
  let changed = 0
...
function! s:Projection_get_resource_type() dict
  return self.resource_type
endfunction

function! s:Projection_has_keyword(keyword) dict
  return index(self.keywords, a:keyword) >=# 0
endfunction

function! s:Projection_add_keyword(keyword) dict
  call add(self.keywords, a:keyword)
endfunction

function! s:Projection_get_keyword_list() dict
  return self.keywords
endfunction

function! s:Projection_set_affinity(affinity) dict
  let self.affinity = a:affinity
endfunction

function! s:Projection_get_affinity() dict
  return self.affinity
endfunction

function! s:Projection_get_mapping() dict
  return self.mapping
endfunction

function! s:Projection_set_mapping(mapping) dict
  let self.mapping = a:mapping
endfunction

function! s:Projection_has_mapping() dict
  return has_key(self, 'mapping') && self.mapping !=# 'null'
endfunction

function! s:Projection_get_compiler() dict
  return self.compiler
endfunction

function! s:Projection_set_compiler(compiler) dict
  let self.compiler = a:compiler
endfunction

function! s:Projection_has_compiler() dict
  return has_key(self, 'compiler') && self.compiler !=# 'null'
endfunction

function! s:Projection_get_scope() dict
  return self.scope
endfunction

function! s:Projection_set_scope(scope) dict
  let self.scope = a:scope
endfunction

function! s:Projection_has_scope() dict
...
function! s:TrieConstructor()
  ...
  let trieObj.add_word = function('s:Trie_add_word')
  let trieObj.size = function('s:Trie_size')
  let trieObj.sizeof = function('s:Trie_sizeof')
  let trieObj.keys = function('s:Trie_keys')
  let trieObj.keys_with_prefix = function('s:Trie_keys_with_prefix')
  let trieObj.collect = function('s:Trie_collect')
  let trieObj.get = function('s:Trie_get')
  let trieObj.find = function('s:Trie_find')
  let trieObj.find_distinct_prefixes = function('s:Trie_find_distinct_prefixes')
  let trieObj.collect_prefix = function('s:Trie_collect_prefix')
  let trieObj.print = function('s:Trie_print')
  return trieObj
endfunction

function! s:Trie_add_word(str, ...) dict
  if len(a:000) ==# 1
    let src = a:000[0]
  else
    let src = 0
...
function! s:Trie_size() dict
  return self.sizeof(self.root)
endfunction

function! s:Trie_sizeof(node) dict
...
function! s:Trie_keys() dict
  return self.keys_with_prefix('')
endfunction

function! s:Trie_keys_with_prefix(prefix) dict
  let queue = []
  call self.collect(self.get(a:prefix), a:prefix, queue)
  return queue
endfunction

function! s:Trie_collect(node, prefix, queue) dict
...
function! s:Trie_get(prefix) dict
  let node = self.root
...
function! s:Trie_find(prefix) dict
  let node = self.get(a:prefix)
  return node.is_node
endfunction

function! s:Trie_find_distinct_prefixes() dict
...
function! s:Trie_collect_prefix(collector) dict
...
function! s:TrieNodeConstructor(char, source)
  ...
  let trieNodeObj.add_child = function('s:TrieNode_add_child')
  let trieNodeObj.remove_child = function('s:TrieNode_remove_child')
  let trieNodeObj.collect_prefix = function('s:TrieNode_collect_prefix')
  let trieNodeObj.get_children = function('s:TrieNode_get_children')
  let trieNodeObj.contains = function('s:TrieNode_contains')
  let trieNodeObj.get_char = function('s:TrieNode_get_char')
  let trieNodeObj.set_char = function('s:TrieNode_set_char')
  let trieNodeObj.get_child = function('s:TrieNode_get_child')
  let trieNodeObj.get_source = function('s:TrieNode_get_source')
  let trieNodeObj.get_total_children = function('s:TrieNode_get_total_children')
  let trieNodeObj.has_child = function('s:TrieNode_has_child')
  let trieNodeObj.has_fork = function('s:TrieNode_has_fork')
  let trieNodeObj.print = function('s:TrieNode_print')
  let trieNodeObj.print_str = function('s:TrieNode_print_str')
  return trieNodeObj
endfunction

function! s:TrieNode_add_child(node) dict
...
function! s:TrieNode_remove_child(char) dict
...
function! s:TrieNode_collect_prefix(collector) dict
...
function! s:TrieNode_get_children() dict
  return values(self.children)
endfunction

function! s:TrieNode_contains(char) dict
  return has_key(self.children, a:char)
endfunction

function! s:TrieNode_get_char() dict
  return self.char
endfunction

function! s:TrieNode_set_char(char) dict
  let self.char = a:char
endfunction

function! s:TrieNode_get_child(char) dict
  return self.children[a:char]
endfunction

function! s:TrieNode_get_source() dict
  return self.source
endfunction

function! s:TrieNode_get_total_children() dict
  return len(self.children)
endfunction

function! s:TrieNode_has_child() dict
  return self.terminal
endfunction

function! s:TrieNode_has_fork() dict
  return len(self.children) >=# 2
endfunction

function! s:TrieNode_print(indent, last) dict
...
function! s:TrieNode_print_str(str, indent) dict
...
function! s:PrefixCollectorConstructor()
  ...
  let prefixCollectorObj.accept_start = function('s:PrefixCollector_accept_start')
  let prefixCollectorObj.accept_end = function('s:PrefixCollector_accept_end')
  let prefixCollectorObj.accept_start_frame = function('s:PrefixCollector_accept_start_frame')
  let prefixCollectorObj.accept_push = function('s:PrefixCollector_accept_push')
  let prefixCollectorObj.accept_end_frame = function('s:PrefixCollector_accept_end_frame')
  let prefixCollectorObj.improve_collection = function('s:PrefixCollector_improve_collection')
  let prefixCollectorObj.get_prefixes = function('s:PrefixCollector_get_prefixes')
  let prefixCollectorObj.add_prefix = function('s:PrefixCollector_add_prefix')
  let prefixCollectorObj.print_prefixes = function('s:PrefixCollector_print_prefixes')
  return prefixCollectorObj
endfunction

function! s:PrefixCollector_accept_start() dict
endfunction

function! s:PrefixCollector_accept_end() dict
  call self.improve_collection()
endfunction

function! s:PrefixCollector_accept_start_frame() dict
...
function! s:PrefixCollector_accept_push(char, source) dict
  call self.current_frame.append(a:char)
  call self.current_frame.set_source(a:source)
endfunction

function! s:PrefixCollector_accept_end_frame() dict
...
function! s:PrefixCollector_improve_collection() dict
  let prefix_values = {}
...
function! s:PrefixCollector_get_prefixes() dict
  return self.prefixes
endfunction

function! s:PrefixCollector_add_prefix(value, source) dict
  let prefix = s:PrefixConstructor(a:value, a:source)
  call add(self.prefixes, prefix)
endfunction

function! s:PrefixCollector_print_prefixes() dict
  for prefix in self.prefixes
...
function! s:StackConstructor()
  let stackObj = {}
  let stackObj.frames = []
  let stackObj.push = function('s:Stack_push')
  let stackObj.pop = function('s:Stack_pop')
  let stackObj.is_empty = function('s:Stack_is_empty')
  return stackObj
endfunction

function! s:Stack_push(frame) dict
...
function! s:Stack_is_empty() dict
...
function! s:StackFrameConstructor(start)
  ...
  let stackFrameObj.set_source = function('s:StackFrame_set_source')
  let stackFrameObj.get_source = function('s:StackFrame_get_source')
  let stackFrameObj.append = function('s:StackFrame_append')
  let stackFrameObj.set_nesting = function('s:StackFrame_set_nesting')
  let stackFrameObj.get_nesting = function('s:StackFrame_get_nesting')
  let stackFrameObj.get_prefix = function('s:StackFrame_get_prefix')
  let stackFrameObj.get_chars = function('s:StackFrame_get_chars')
  return stackFrameObj
endfunction

function! s:StackFrame_set_source(source) dict
  let self.source = a:source
endfunction

function! s:StackFrame_get_source() dict
  return self.source
endfunction

function! s:StackFrame_append(chars) dict
  if self.prefix ==# ''
...
function! s:StackFrame_set_nesting(nesting) dict
  let self.nesting = a:nesting
endfunction

function! s:StackFrame_get_nesting() dict
  return self.nesting
endfunction

function! s:StackFrame_get_prefix() dict
  return self.start . self.prefix
endfunction

function! s:StackFrame_get_chars() dict
  return self.chars
endfunction
...
function! s:ProjectionCollectionConstructor()
  ...
  let projectionCollectionObj.needs = function('s:ProjectionCollection_needs')
  let projectionCollectionObj.get_matcher = function('s:ProjectionCollection_get_matcher')
  let projectionCollectionObj.add = function('s:ProjectionCollection_add')
  let projectionCollectionObj.change_projection = function('s:ProjectionCollection_change_projection')
  let projectionCollectionObj.has = function('s:ProjectionCollection_has')
  let projectionCollectionObj.find_by_resource_type = function('s:ProjectionCollection_find_by_resource_type')
  let projectionCollectionObj.get_projections = function('s:ProjectionCollection_get_projections')
  let projectionCollectionObj.get_resource_types = function('s:ProjectionCollection_get_resource_types')
  let projectionCollectionObj.get_mappings = function('s:ProjectionCollection_get_mappings')
  let projectionCollectionObj.get_patterns = function('s:ProjectionCollection_get_patterns')
  let projectionCollectionObj.match = function('s:ProjectionCollection_match')
  return projectionCollectionObj
endfunction

function! s:ProjectionCollection_needs() dict
  return ['extensions']
endfunction

function! s:ProjectionCollection_get_matcher() dict
...
function! s:ProjectionCollection_add(resource_type, json) dict
...
function! s:ProjectionCollection_change_projection(projection) dict
...
function! s:ProjectionCollection_has(resource_type) dict
  return has_key(self.projections, a:resource_type)
endfunction

function! s:ProjectionCollection_find_by_resource_type(resource_type) dict
...
function! s:ProjectionCollection_get_projections() dict
  return values(self.projections)
endfunction

function! s:ProjectionCollection_get_resource_types() dict
  return keys(self.projections)
endfunction

function! s:ProjectionCollection_get_mappings() dict
  return self.trie.find_distinct_prefixes()
endfunction

function! s:ProjectionCollection_get_patterns(order) dict
  return self.get_matcher().get_patterns(a:order)
endfunction

function! s:ProjectionCollection_match(path, ...) dict
  if len(a:000) ==# 1
    let order = a:000[0]
  else
    let order = 'desc'
...
function! s:ProjectionLoaderConstructor(projection)
  ...
  let projectionLoaderObj.load = function('s:ProjectionLoader_load')
  let projectionLoaderObj.get_changed = function('s:ProjectionLoader_get_changed')
  let projectionLoaderObj.load_property = function('s:ProjectionLoader_load_property')
  let projectionLoaderObj.load_projection_template = function('s:ProjectionLoader_load_projection_template')
  let projectionLoaderObj.load_list = function('s:ProjectionLoader_load_list')
  let projectionLoaderObj.load_pattern = function('s:ProjectionLoader_load_pattern')
  let projectionLoaderObj.has_property = function('s:ProjectionLoader_has_property')
  let projectionLoaderObj.change_property = function('s:ProjectionLoader_change_property')
  let projectionLoaderObj.change_list = function('s:ProjectionLoader_change_list')
  let projectionLoaderObj.change_list_item = function('s:ProjectionLoader_change_list_item')
  return projectionLoaderObj
endfunction

function! s:ProjectionLoader_load(json) dict
  let self.changed = 0
...
function! s:ProjectionLoader_get_changed() dict
  return self.changed
endfunction

function! s:ProjectionLoader_load_property(property, key, json) dict
...
function! s:ProjectionLoader_load_projection_template(projection_type, json) dict
...
function! s:ProjectionLoader_load_list(property, key, json) dict
  if has_key(a:json, a:key)
...
function! s:ProjectionLoader_load_pattern(json) dict
...
function! s:ProjectionLoader_has_property(property) dict
...
function! s:ProjectionLoader_change_property(property, value) dict
...
function! s:ProjectionLoader_change_list(property, value) dict
...
function! s:ProjectionLoader_change_list_item(property, value) dict
...
function! s:JSONParserConstructor()
  let jSONParserObj = {}
  let jSONParserObj.parse = function('s:JSONParser_parse')
...
function! s:InflectionExecuterConstructor()
  ...
  let inflectionExecuterObj.inflect = function('s:InflectionExecuter_inflect')
  return inflectionExecuterObj
endfunction

function! s:InflectionExecuter_inflect(src, rules) dict
  for rule in a:rules
...
function! s:BaseInflectorConstructor()
  ...
  let baseInflectorObj.add_rule = function('s:BaseInflector_add_rule')
  let baseInflectorObj.set_mode = function('s:BaseInflector_set_mode')
  let baseInflectorObj.get_mode = function('s:BaseInflector_get_mode')
  let baseInflectorObj.add_plural_rule = function('s:BaseInflector_add_plural_rule')
  let baseInflectorObj.add_singular_rule = function('s:BaseInflector_add_singular_rule')
  let baseInflectorObj.add_uncountable = function('s:BaseInflector_add_uncountable')
  let baseInflectorObj.add_plural_rules = function('s:BaseInflector_add_plural_rules')
  let baseInflectorObj.add_singular_rules = function('s:BaseInflector_add_singular_rules')
  let baseInflectorObj.add_uncountables = function('s:BaseInflector_add_uncountables')
  let baseInflectorObj.add_irregular = function('s:BaseInflector_add_irregular')
  let baseInflectorObj.add_irregulars = function('s:BaseInflector_add_irregulars')
  let baseInflectorObj.add_acronym = function('s:BaseInflector_add_acronym')
  let baseInflectorObj.add_acronyms = function('s:BaseInflector_add_acronyms')
  let baseInflectorObj.pluralize = function('s:BaseInflector_pluralize')
  let baseInflectorObj.singularize = function('s:BaseInflector_singularize')
  let baseInflectorObj.capitalize = function('s:BaseInflector_capitalize')
  let baseInflectorObj.camelize = function('s:BaseInflector_camelize')
  let baseInflectorObj.lower_camelize = function('s:BaseInflector_lower_camelize')
  let baseInflectorObj.underscorize = function('s:BaseInflector_underscorize')
  let baseInflectorObj.dasherize = function('s:BaseInflector_dasherize')
  let baseInflectorObj.humanize = function('s:BaseInflector_humanize')
  let baseInflectorObj.titleize = function('s:BaseInflector_titleize')
  let baseInflectorObj.tableize = function('s:BaseInflector_tableize')
  let baseInflectorObj.classify = function('s:BaseInflector_classify')
  let baseInflectorObj.affinize = function('s:BaseInflector_affinize')
  let baseInflectorObj.clear = function('s:BaseInflector_clear')
  let baseInflectorObj.is_uncountable = function('s:BaseInflector_is_uncountable')
  let baseInflectorObj.is_irregular = function('s:BaseInflector_is_irregular')
  let baseInflectorObj.update_acronyms_regex = function('s:BaseInflector_update_acronyms_regex')
  let baseInflectorObj.replace_acronyms = function('s:BaseInflector_replace_acronyms')
  let baseInflectorObj.has_acronym_at_start = function('s:BaseInflector_has_acronym_at_start')
  let baseInflectorObj.acronym_for_match = function('s:BaseInflector_acronym_for_match')
  return baseInflectorObj
endfunction

function! s:BaseInflector_add_rule(rules, from, to, ...) dict
...
function! s:BaseInflector_set_mode(mode) dict
  let self.mode = a:mode
endfunction

function! s:BaseInflector_get_mode() dict
  return self.mode
endfunction

function! s:BaseInflector_add_plural_rule(...) dict
  return call(self['add_rule'], [self.plural_rules] + a:000, self)
endfunction

function! s:BaseInflector_add_singular_rule(...) dict
  return call(self['add_rule'], [self.singular_rules] + a:000, self)
endfunction

function! s:BaseInflector_add_uncountable(word) dict
  let self.uncountable[a:word] = 1
endfunction

function! s:BaseInflector_add_plural_rules(rules) dict
  for rule in a:rules
    let res = call(self['add_plural_rule'], rule, self)
  endfor
endfunction

function! s:BaseInflector_add_singular_rules(rules) dict
  for rule in a:rules
    let res = call(self['add_singular_rule'], rule, self)
  endfor
endfunction

function! s:BaseInflector_add_uncountables(words) dict
  for word in a:words
    call self.add_uncountable(word)
  endfor
endfunction

function! s:BaseInflector_add_irregular(singular, plural) dict
...
function! s:BaseInflector_add_irregulars(rules) dict
  for rule in a:rules
    let res = call(self['add_irregular'], rule, self)
  endfor
endfunction

function! s:BaseInflector_add_acronym(word) dict
  let acronym = tolower(a:word)
  let self.acronyms[acronym] = a:word
  call self.update_acronyms_regex()
endfunction

function! s:BaseInflector_add_acronyms(words) dict
  for word in a:words
...
function! s:BaseInflector_pluralize(word) dict
...
function! s:BaseInflector_singularize(word) dict
  if self.is_uncountable(a:word)
    return a:word
  else
...
function! s:BaseInflector_capitalize(word) dict
  let pattern = '\v^(.)(.*)$'
  return substitute(a:word, pattern, '\u\1\L\2', '')
endfunction

function! s:BaseInflector_camelize(str) dict
...
function! s:BaseInflector_lower_camelize(str) dict
  let camel_pattern = '\v%([_/|-]){1}(.)'
  let camel_replace = '\u\1'
...
function! s:BaseInflector_underscorize(str) dict
...
function! s:BaseInflector_dasherize(str) dict
  let str = self.underscorize(a:str)
  let str = substitute(str, '_', '-', 'g')
  return str
endfunction

function! s:BaseInflector_humanize(str) dict
...
function! s:BaseInflector_titleize(str) dict
...
function! s:BaseInflector_tableize(word) dict
  return self.pluralize(self.underscorize(a:word))
endfunction

function! s:BaseInflector_classify(table_name) dict
  let table_name = self.underscorize(a:table_name)
  let table_name = substitute(table_name, '.*\.', '', '')
  return self.camelize(self.singularize(table_name))
endfunction

function! s:BaseInflector_affinize(name, a) dict
...
function! s:BaseInflector_clear() dict
...
function! s:BaseInflector_is_uncountable(word) dict
  return has_key(self.uncountable, a:word)
endfunction

function! s:BaseInflector_is_irregular(quantity, word) dict
  return has_key(self["irregular_" . a:quantity], a:word)
endfunction

function! s:BaseInflector_update_acronyms_regex() dict
  let self.acronyms_regex = '(' . join(keys(self.acronyms), '|') . ')'
endfunction

function! s:BaseInflector_replace_acronyms(str) dict
...
function! s:BaseInflector_has_acronym_at_start(str) dict
  let pattern = '\v^' . self.acronyms_regex
  let result = match(a:str, pattern)
  return result ==# 0
endfunction

function! s:BaseInflector_acronym_for_match(str) dict
...
function! s:InflectorConstructor()
  ...
  let inflectorObj.on_inject = function('s:Inflector_on_inject')
  let inflectorObj.load_defaults = function('s:Inflector_load_defaults')
  return inflectorObj
endfunction

function! s:Inflector_on_inject() dict
  call self.load_defaults()
endfunction

function! s:Inflector_load_defaults() dict
...
function! s:InflectionLoaderConstructor()
  ...
  let inflectionLoaderObj.load = function('s:InflectionLoader_load')
  let inflectionLoaderObj.load_acronyms = function('s:InflectionLoader_load_acronyms')
  let inflectionLoaderObj.load_uncountables = function('s:InflectionLoader_load_uncountables')
  let inflectionLoaderObj.load_irregulars = function('s:InflectionLoader_load_irregulars')
  let inflectionLoaderObj.load_singulars = function('s:InflectionLoader_load_singulars')
  let inflectionLoaderObj.load_plurals = function('s:InflectionLoader_load_plurals')
  return inflectionLoaderObj
endfunction

function! s:InflectionLoader_load(json, inflector) dict
...
function! s:InflectionLoader_load_acronyms(json, inflector) dict
  if type(a:json) ==# type('')
    let acronyms = [a:json]
  else
    let acronyms = a:json
...
function! s:InflectionLoader_load_uncountables(json, inflector) dict
  if type(a:json) ==# type('')
...
function! s:InflectionLoader_load_irregulars(json, inflector) dict
  for [singular, plural] in items(a:json)
    call a:inflector.add_irregular(singular, plural)
  endfor
endfunction

function! s:InflectionLoader_load_singulars(json, inflector) dict
  for [from, to] in items(a:json)
    call a:inflector.add_singular_rule(from, to)
  endfor
endfunction

function! s:InflectionLoader_load_plurals(json, inflector) dict
  for [from, to] in items(a:json)
...
function! s:ContextConstructor()
  let contextObj = {}
  let contextObj.needs = function('s:Context_needs')
  let contextObj.on_inject = function('s:Context_on_inject')
  let contextObj.get_root = function('s:Context_get_root')
  let contextObj.get_root_portkey = function('s:Context_get_root_portkey')
  let contextObj.add_portkey = function('s:Context_add_portkey')
  let contextObj.add_extension = function('s:Context_add_extension')
  let contextObj.get_portkeys = function('s:Context_get_portkeys')
  let contextObj.load = function('s:Context_load')
  let contextObj.load_config = function('s:Context_load_config')
  let contextObj.load_extensions = function('s:Context_load_extensions')
  let contextObj.load_extension_by_name = function('s:Context_load_extension_by_name')
  let contextObj.load_extension = function('s:Context_load_extension')
  let contextObj.load_syntax_files = function('s:Context_load_syntax_files')
  let contextObj.load_filters = function('s:Context_load_filters')
  let contextObj.load_inflections = function('s:Context_load_inflections')
  let contextObj.load_rankers = function('s:Context_load_rankers')
  let contextObj.load_ranker = function('s:Context_load_ranker')
  let contextObj.load_finders = function('s:Context_load_finders')
  let contextObj.load_finder = function('s:Context_load_finder')
  let contextObj.load_extractors = function('s:Context_load_extractors')
  let contextObj.lookup = function('s:Context_lookup')
  let contextObj.get_projections = function('s:Context_get_projections')
  let contextObj.get_extension_names = function('s:Context_get_extension_names')
  let contextObj.inject = function('s:Context_inject')
  return contextObj
endfunction

function! s:Context_needs() dict
  return ['extensions']
endfunction

function! s:Context_on_inject() dict
...
function! s:Context_get_root() dict
  return self.root
endfunction

function! s:Context_get_root_portkey() dict
  return self.root . "portkey.json"
endfunction

function! s:Context_add_portkey(file) dict
  call add(self.portkeys, a:file)
endfunction

function! s:Context_add_extension(extension_name) dict
  call add(self.extension_names, a:extension_name)
endfunction

function! s:Context_get_portkeys() dict
  return self.portkeys
endfunction

function! s:Context_load(root) dict
...
function! s:Context_load_config(json, path, scope) dict
  for [key, value] in items(a:json)
    if key ==# 'inflections'
...
function! s:Context_load_extensions() dict
  let extensions = self.extensions
...
function! s:Context_load_extension_by_name(extension_name) dict
  let extensions = self.extensions
...
function! s:Context_load_extension(extension) dict
...
function! s:Context_load_syntax_files(extension) dict
...
function! s:Context_load_filters(extension) dict
...
function! s:Context_load_inflections(extension) dict
  let inflector = self.lookup('inflector')
  call a:extension.configure_inflector(inflector)
endfunction

function! s:Context_load_rankers(extension) dict
...
function! s:Context_load_ranker(extension, type, ranker) dict
...
function! s:Context_load_finders(extension) dict
...
function! s:Context_load_finder(extension, type, finder) dict
...
function! s:Context_load_extractors(extension) dict
...
function! s:Context_lookup(name) dict
  if a:name ==# 'context'
    return self
  else
    return self.container.lookup(a:name)
...
function! s:Context_get_projections() dict
  return self.lookup('projections')
endfunction

function! s:Context_get_extension_names() dict
  return self.extension_names
endfunction

function! s:Context_inject(object) dict
...
function! s:PortkeyLoaderConstructor(extensions)
  ...
  let portkeyLoaderObj.load = function('s:PortkeyLoader_load')
  let portkeyLoaderObj.load_children = function('s:PortkeyLoader_load_children')
  let portkeyLoaderObj.load_and_parse = function('s:PortkeyLoader_load_and_parse')
  let portkeyLoaderObj.parse = function('s:PortkeyLoader_parse')
  let portkeyLoaderObj.resolve_path = function('s:PortkeyLoader_resolve_path')
  let portkeyLoaderObj.lookup_extension_path = function('s:PortkeyLoader_lookup_extension_path')
  let portkeyLoaderObj.send_extension_event = function('s:PortkeyLoader_send_extension_event')
  let portkeyLoaderObj.get_event_name = function('s:PortkeyLoader_get_event_name')
  let portkeyLoaderObj.show_error = function('s:PortkeyLoader_show_error')
  let portkeyLoaderObj.has_errors = function('s:PortkeyLoader_has_errors')
  let portkeyLoaderObj.has_root_loaded = function('s:PortkeyLoader_has_root_loaded')
  let portkeyLoaderObj.is_json = function('s:PortkeyLoader_is_json')
  let portkeyLoaderObj.has_children = function('s:PortkeyLoader_has_children')
  let portkeyLoaderObj.is_extension_name = function('s:PortkeyLoader_is_extension_name')
  let portkeyLoaderObj.get_scope = function('s:PortkeyLoader_get_scope')
  return portkeyLoaderObj
endfunction

function! s:PortkeyLoader_load(pathname, collector) dict
...
function! s:PortkeyLoader_load_children(json, collector) dict
...
function! s:PortkeyLoader_load_and_parse(path) dict
  try
    if type(a:path) ==# type('')
...
function! s:PortkeyLoader_parse(text, path) dict
...
function! s:PortkeyLoader_resolve_path(pathname) dict
...
function! s:PortkeyLoader_lookup_extension_path(portkey_path) dict
...
function! s:PortkeyLoader_send_extension_event(extension_name) dict
...
function! s:PortkeyLoader_get_event_name(extension_name) dict
  return 'portkey_extension_' . tolower(a:extension_name)
endfunction

function! s:PortkeyLoader_show_error(msg, path) dict
  let rel_path = fnamemodify(a:path, ':.')
  call s:echo_warn(a:msg . ": " . rel_path)
  let self.errors = 1
endfunction

function! s:PortkeyLoader_has_errors() dict
  return self.errors
endfunction

function! s:PortkeyLoader_has_root_loaded() dict
  return self.root_loaded
endfunction

function! s:PortkeyLoader_is_json(json) dict
  return type(a:json) ==# type({})
endfunction

function! s:PortkeyLoader_has_children(json) dict
  return has_key(a:json, 'portkeys') && type(a:json.portkeys) ==# type([])
endfunction

function! s:PortkeyLoader_is_extension_name(path) dict
  return a:path !~# '.json$'
endfunction

function! s:PortkeyLoader_get_scope(pathname) dict
...
function! s:PortkeyPathConstructor(pathname)
  ...
  let portkeyPathObj.get_pathname = function('s:PortkeyPath_get_pathname')
  let portkeyPathObj.build_extension_name = function('s:PortkeyPath_build_extension_name')
  let portkeyPathObj.is_extension = function('s:PortkeyPath_is_extension')
  let portkeyPathObj.get_extension_name = function('s:PortkeyPath_get_extension_name')
  let portkeyPathObj.set_filepath = function('s:PortkeyPath_set_filepath')
  let portkeyPathObj.get_filepath = function('s:PortkeyPath_get_filepath')
  let portkeyPathObj.get_extension_name_parts = function('s:PortkeyPath_get_extension_name_parts')
  let portkeyPathObj.get_name_parts = function('s:PortkeyPath_get_name_parts')
  return portkeyPathObj
endfunction

function! s:PortkeyPath_get_pathname() dict
  return self.pathname
endfunction

function! s:PortkeyPath_build_extension_name() dict
...
function! s:PortkeyPath_is_extension() dict
...
function! s:PortkeyPath_get_extension_name() dict
  if !(has_key(self, 'filepath'))
    call self.build_extension_name()
  endif
...
function! s:PortkeyPath_set_filepath(filepath) dict
  let self.filepath = a:filepath
endfunction

function! s:PortkeyPath_get_filepath() dict
  return self.filepath
endfunction

function! s:PortkeyPath_get_extension_name_parts() dict
  return self.extension_name_parts
endfunction

function! s:PortkeyPath_get_name_parts(extension_name) dict
  let parts = {}
...
function! s:PortkeyCollectorConstructor(context, projections)
  ...
  let portkeyCollectorObj.add = function('s:PortkeyCollector_add')
  let portkeyCollectorObj.add_extension = function('s:PortkeyCollector_add_extension')
  return portkeyCollectorObj
endfunction

function! s:PortkeyCollector_add(json, path, scope) dict
  for [key, value] in items(a:json)
    if key ==# 'config'
...
function! s:PortkeyCollector_add_extension(extension_name) dict
...
function! s:RankerConstructor()
  ...
  let rankerObj.add_ranker = function('s:Ranker_add_ranker')
  let rankerObj.rank = function('s:Ranker_rank')
  let rankerObj.sort = function('s:Ranker_sort')
  let rankerObj.compare_rank_items = function('s:Ranker_compare_rank_items')
  let rankerObj.get_rankers = function('s:Ranker_get_rankers')
  let rankerObj.to_rank_items = function('s:Ranker_to_rank_items')
  let rankerObj.to_results = function('s:Ranker_to_results')
  return rankerObj
endfunction

function! s:Ranker_add_ranker(type, ranker) dict
  call self.rankers.insert(a:type, a:ranker)
endfunction

function! s:Ranker_rank(type, context, results) dict
...
function! s:Ranker_get_rankers(type) dict
...
function! s:Ranker_to_rank_items(results) dict
  let items = []
  for result in a:results
...
function! s:Ranker_to_results(rank_items) dict
  let results = []
  for rank_item in a:rank_items
...
function! s:RankItemConstructor(path, ranking)
  ...
  let rankItemObj.get_path = function('s:RankItem_get_path')
  let rankItemObj.get_ranking = function('s:RankItem_get_ranking')
  let rankItemObj.set_ranking = function('s:RankItem_set_ranking')
  let rankItemObj.raise = function('s:RankItem_raise')
  let rankItemObj.lower = function('s:RankItem_lower')
  let rankItemObj.get_step_size = function('s:RankItem_get_step_size')
  return rankItemObj
endfunction

function! s:RankItem_get_path() dict
  return self.path
endfunction

function! s:RankItem_get_ranking() dict
  return self.ranking
endfunction

function! s:RankItem_set_ranking(ranking) dict
  let self.ranking = a:ranking
endfunction

function! s:RankItem_raise(...) dict
  let step_size = self.get_step_size(a:000)
  let self.ranking += step_size
endfunction

function! s:RankItem_lower(...) dict
  let step_size = self.get_step_size(a:000)
  let self.ranking -= step_size
endfunction

function! s:RankItem_get_step_size(args) dict
  if len(a:args) ==# 1
...
function! s:FinderConstructor()
  ...
  let finderObj.add_finder = function('s:Finder_add_finder')
  let finderObj.find = function('s:Finder_find')
  let finderObj.get_finders = function('s:Finder_get_finders')
  return finderObj
endfunction

function! s:Finder_add_finder(type, finder) dict
  call self.finders.insert(a:type, a:finder)
endfunction

function! s:Finder_find(type, context) dict
...
function! s:Finder_get_finders(type) dict
...
function! s:FinderCollectorConstructor()
  ...
  let finderCollectorObj.get_results = function('s:FinderCollector_get_results')
  let finderCollectorObj.add = function('s:FinderCollector_add')
  let finderCollectorObj.insert = function('s:FinderCollector_insert')
  let finderCollectorObj.remove = function('s:FinderCollector_remove')
  let finderCollectorObj.has = function('s:FinderCollector_has')
  return finderCollectorObj
endfunction

function! s:FinderCollector_get_results() dict
  return self.results
endfunction

function! s:FinderCollector_add(...) dict
  for path in a:000
    if !(self.has(path))
...
function! s:FinderCollector_insert(...) dict
  for path in a:000
    if !(self.has(path))
...
function! s:FinderCollector_remove(path) dict
  if self.has(a:path)
...
function! s:FinderCollector_has(path) dict
...
function! s:MakeEnvConstructor()
  ...
  let makeEnvObj.get_makeprg = function('s:MakeEnv_get_makeprg')
  let makeEnvObj.get_errorformat = function('s:MakeEnv_get_errorformat')
  let makeEnvObj.get_dir = function('s:MakeEnv_get_dir')
  let makeEnvObj.has_local_dir = function('s:MakeEnv_has_local_dir')
  let makeEnvObj.has_compiler = function('s:MakeEnv_has_compiler')
  let makeEnvObj.get_compiler = function('s:MakeEnv_get_compiler')
  let makeEnvObj.restore = function('s:MakeEnv_restore')
  let makeEnvObj.chdir = function('s:MakeEnv_chdir')
  return makeEnvObj
endfunction

function! s:MakeEnv_get_makeprg() dict
  return self.makeprg
endfunction

function! s:MakeEnv_get_errorformat() dict
  return self.errorformat
endfunction

function! s:MakeEnv_get_dir() dict
  return self.dir
endfunction

function! s:MakeEnv_has_local_dir() dict
  return self.found_local_dir
endfunction

function! s:MakeEnv_has_compiler() dict
  return self.found_compiler
endfunction

function! s:MakeEnv_get_compiler() dict
  return self.compiler
endfunction

function! s:MakeEnv_restore() dict
...
function! s:MakeEnv_chdir(dir) dict
  let cwd = getcwd()
  if cwd !=# a:dir
...
function! s:MakeConstructor()
  ...
  let makeObj.set_bang = function('s:Make_set_bang')
  let makeObj.get_bang = function('s:Make_get_bang')
  let makeObj.set_dir = function('s:Make_set_dir')
  let makeObj.get_dir = function('s:Make_get_dir')
  let makeObj.set_show_quickfix = function('s:Make_set_show_quickfix')
  let makeObj.get_show_quickfix = function('s:Make_get_show_quickfix')
  let makeObj.set_compiler = function('s:Make_set_compiler')
  let makeObj.get_compiler = function('s:Make_get_compiler')
  let makeObj.set_makeprg = function('s:Make_set_makeprg')
  let makeObj.get_makeprg = function('s:Make_get_makeprg')
  let makeObj.set_errorformat = function('s:Make_set_errorformat')
  let makeObj.get_errorformat = function('s:Make_get_errorformat')
  let makeObj.set_mocked = function('s:Make_set_mocked')
  let makeObj.get_mocked = function('s:Make_get_mocked')
  let makeObj.get_exec_cmd = function('s:Make_get_exec_cmd')
  let makeObj.set_use_dispatch_make = function('s:Make_set_use_dispatch_make')
  let makeObj.get_use_dispatch_make = function('s:Make_get_use_dispatch_make')
  let makeObj.make = function('s:Make_make')
  let makeObj.load_env = function('s:Make_load_env')
  let makeObj.run = function('s:Make_run')
  let makeObj.get_make_cmd = function('s:Make_get_make_cmd')
  return makeObj
endfunction

function! s:Make_set_bang(bang) dict
  let self.bang = a:bang
endfunction

function! s:Make_get_bang() dict
  return self.bang
endfunction

function! s:Make_set_dir(dir) dict
  let self.dir = a:dir
endfunction

function! s:Make_get_dir() dict
  return self.dir
endfunction

function! s:Make_set_show_quickfix(show_quickfix) dict
  let self.show_quickfix = a:show_quickfix
endfunction

function! s:Make_get_show_quickfix() dict
  return self.show_quickfix
endfunction

function! s:Make_set_compiler(compiler) dict
  let self.compiler = a:compiler
endfunction

function! s:Make_get_compiler() dict
  return self.compiler
endfunction

function! s:Make_set_makeprg(makeprg) dict
  let self.makeprg = a:makeprg
endfunction

function! s:Make_get_makeprg() dict
  return self.makeprg
endfunction

function! s:Make_set_errorformat(errorformat) dict
  let self.errorformat = a:errorformat
endfunction

function! s:Make_get_errorformat() dict
  return self.errorformat
endfunction

function! s:Make_set_mocked(mocked) dict
  let self.mocked = a:mocked
endfunction

function! s:Make_get_mocked() dict
  return self.mocked
endfunction

function! s:Make_get_exec_cmd() dict
  return self.exec_cmd
endfunction

function! s:Make_set_use_dispatch_make(use_dispatch_make) dict
  let self.use_dispatch_make = a:use_dispatch_make
endfunction

function! s:Make_get_use_dispatch_make() dict
  return self.use_dispatch_make
endfunction

function! s:Make_make(...) dict
...
function! s:Make_get_make_cmd() dict
...
function! s:FinderContextConstructor()
  ...
  let finderContextObj.lookup = function('s:FinderContext_lookup')
  let finderContextObj.buffer_has_projection = function('s:FinderContext_buffer_has_projection')
  let finderContextObj.buffer_has_context = function('s:FinderContext_buffer_has_context')
  let finderContextObj.buffer_has_enrolled = function('s:FinderContext_buffer_has_enrolled')
  let finderContextObj.get_current_buffer = function('s:FinderContext_get_current_buffer')
  let finderContextObj.get_current_buffer_path = function('s:FinderContext_get_current_buffer_path')
  let finderContextObj.get_current_buffer_filename = function('s:FinderContext_get_current_buffer_filename')
  let finderContextObj.get_current_buffer_rootname = function('s:FinderContext_get_current_buffer_rootname')
  let finderContextObj.get_current_contexts = function('s:FinderContext_get_current_contexts')
  let finderContextObj.get_current_context = function('s:FinderContext_get_current_context')
  let finderContextObj.get_current_root = function('s:FinderContext_get_current_root')
  let finderContextObj.get_current_projection = function('s:FinderContext_get_current_projection')
  let finderContextObj.get_current_projections = function('s:FinderContext_get_current_projections')
  let finderContextObj.get_current_pattern = function('s:FinderContext_get_current_pattern')
  let finderContextObj.get_current_resource_type = function('s:FinderContext_get_current_resource_type')
  return finderContextObj
endfunction

function! s:FinderContext_lookup(name) dict
  return self.container.lookup(a:name)
endfunction

function! s:FinderContext_buffer_has_projection() dict
  return self.get_current_buffer().has_projection()
endfunction

function! s:FinderContext_buffer_has_context() dict
  return self.get_current_contexts().contains(self.get_current_root())
endfunction

function! s:FinderContext_buffer_has_enrolled() dict
  return self.get_current_buffer().get_enrolled()
endfunction

function! s:FinderContext_get_current_buffer() dict
  return self.lookup('buffers').get_current()
endfunction

function! s:FinderContext_get_current_buffer_path() dict
  return self.get_current_buffer().get_rel_path()
endfunction

function! s:FinderContext_get_current_buffer_filename() dict
  return self.get_current_buffer().get_filename()
endfunction

function! s:FinderContext_get_current_buffer_rootname() dict
  return self.get_current_buffer().get_rootname()
endfunction

function! s:FinderContext_get_current_contexts() dict
  return self.lookup('contexts')
endfunction

function! s:FinderContext_get_current_context() dict
  return self.get_current_contexts().get(self.get_current_root())
endfunction

function! s:FinderContext_get_current_root() dict
  return self.get_current_buffer().get_abs_root()
endfunction

function! s:FinderContext_get_current_projection() dict
  return self.get_current_buffer().get_projection()
endfunction

function! s:FinderContext_get_current_projections() dict
  return self.get_current_context().get_projections()
endfunction

function! s:FinderContext_get_current_pattern() dict
  return self.get_current_buffer().get_pattern()
endfunction

function! s:FinderContext_get_current_resource_type() dict
  return self.get_current_projection().get_resource_type()
endfunction
...
function! s:DataFrameConstructor(buffer)
  ...
  let dataFrameObj.set_line = function('s:DataFrame_set_line')
  let dataFrameObj.set_tags = function('s:DataFrame_set_tags')
  let dataFrameObj.set_source = function('s:DataFrame_set_source')
  let dataFrameObj.set_source_path = function('s:DataFrame_set_source_path')
  let dataFrameObj.print = function('s:DataFrame_print')
  return dataFrameObj
endfunction

function! s:DataFrame_set_line(line) dict
  let self.line = a:line
endfunction

function! s:DataFrame_set_tags(tag, tag_full, tag_proto) dict
  let self.tag = a:tag
  let self.tag_full = a:tag_full
  let self.tag_proto = a:tag_proto
endfunction

function! s:DataFrame_set_source(source_name) dict
  let self.source = a:source_name
endfunction

function! s:DataFrame_set_source_path(source_path) dict
  let self.source_path = a:source_path
endfunction

function! s:DataFrame_print() dict
...
function! s:ProjectionDataFrameConstructor(buffer)
  ...
  let projectionDataFrameObj.set_projection = function('s:ProjectionDataFrame_set_projection')
  let projectionDataFrameObj.set_pattern = function('s:ProjectionDataFrame_set_pattern')
  let projectionDataFrameObj.print = function('s:ProjectionDataFrame_print')
  let projectionDataFrameObj.DataFrame_print = function('s:DataFrame_print')
  return projectionDataFrameObj
endfunction

function! s:ProjectionDataFrame_set_projection(projection, projection_type) dict
  let self.projection = a:projection
  let self.projection_type = a:projection_type
endfunction

function! s:ProjectionDataFrame_set_pattern(pattern) dict
  let self.pattern = a:pattern
endfunction

function! s:ProjectionDataFrame_print() dict
...
function! s:ResourceDataFrameConstructor(buffer)
  ...
  let resourceDataFrameObj.set_pattern_list = function('s:ResourceDataFrame_set_pattern_list')
  return resourceDataFrameObj
endfunction

function! s:ResourceDataFrame_set_pattern_list(pattern_list) dict
...
function! s:GetFileDataFrameConstructor(buffer)
  ...
  let getFileDataFrameObj.set_pattern_list = function('s:GetFileDataFrame_set_pattern_list')
  let getFileDataFrameObj.set_inflector = function('s:GetFileDataFrame_set_inflector')
  let getFileDataFrameObj.set_projection = function('s:GetFileDataFrame_set_projection')
  return getFileDataFrameObj
endfunction

function! s:GetFileDataFrame_set_pattern_list(pattern_list) dict
  let self.pattern_list = a:pattern_list
endfunction

function! s:GetFileDataFrame_set_inflector(inflector) dict
  let self.inflector = a:inflector
endfunction

function! s:GetFileDataFrame_set_projection(projection) dict
  let self.projection = a:projection
endfunction
...
function! s:TemplateContextConstructor(data)
  ...
  let templateContextObj.lookup = function('s:TemplateContext_lookup')
  return templateContextObj
endfunction

function! s:TemplateContext_lookup(key) dict
...
function! s:AlternateFinderContextConstructor()
  ...
  let alternateFinderContextObj.get_query_type = function('s:AlternateFinderContext_get_query_type')
  let alternateFinderContextObj.get_template_context = function('s:AlternateFinderContext_get_template_context')
  return alternateFinderContextObj
endfunction

function! s:AlternateFinderContext_get_query_type(options) dict
  return 'projection'
endfunction

function! s:AlternateFinderContext_get_template_context(options) dict
  let buffer = self.get_current_buffer()
...
function! s:ResourceFinderContextConstructor()
  ...
  let resourceFinderContextObj.get_query_type = function('s:ResourceFinderContext_get_query_type')
  let resourceFinderContextObj.get_template_context = function('s:ResourceFinderContext_get_template_context')
  return resourceFinderContextObj
endfunction

function! s:ResourceFinderContext_get_query_type(options) dict
  return 'resource'
endfunction

function! s:ResourceFinderContext_get_template_context(options) dict
  let resource_type = a:options.get_resource_type()
  let projections = self.get_current_projections()
  let projection = projections.find_by_resource_type(resource_type)
...
function! s:RelatedFinderContextConstructor()
  ...
  let relatedFinderContextObj.get_query_type = function('s:RelatedFinderContext_get_query_type')
  let relatedFinderContextObj.get_template_context = function('s:RelatedFinderContext_get_template_context')
  return relatedFinderContextObj
endfunction

function! s:RelatedFinderContext_get_query_type(options) dict
  return 'projection'
endfunction

function! s:RelatedFinderContext_get_template_context(options) dict
  let buffer = self.get_current_buffer()
  let match = buffer.get_match()
  let pattern = match.get_pattern()
  let projection = pattern.get_projection()
...
function! s:TestFinderContextConstructor()
  ...
  let testFinderContextObj.get_query_type = function('s:TestFinderContext_get_query_type')
  let testFinderContextObj.get_template_context = function('s:TestFinderContext_get_template_context')
  return testFinderContextObj
endfunction

function! s:TestFinderContext_get_query_type(options) dict
  return 'projection'
endfunction

function! s:TestFinderContext_get_template_context(options) dict
  let buffer = self.get_current_buffer()
  let match = buffer.get_match()
  let pattern = match.get_pattern()
  let projection = pattern.get_projection()
...
function! s:GetFileFinderContextConstructor()
  ...
  let getFileFinderContextObj.get_query_type = function('s:GetFileFinderContext_get_query_type')
  let getFileFinderContextObj.get_template_context = function('s:GetFileFinderContext_get_template_context')
  return getFileFinderContextObj
endfunction

function! s:GetFileFinderContext_get_query_type(options) dict
  return 'file'
endfunction

function! s:GetFileFinderContext_get_template_context(options) dict
...
function! s:LauncherConstructor()
  ...
  let launcherObj.run = function('s:Launcher_run')
  let launcherObj.launch = function('s:Launcher_launch')
  let launcherObj.render_template = function('s:Launcher_render_template')
  let launcherObj.get_file_template_context = function('s:Launcher_get_file_template_context')
  let launcherObj.find_source_name = function('s:Launcher_find_source_name')
  let launcherObj.extract_from_source = function('s:Launcher_extract_from_source')
  let launcherObj.extract_into_destination = function('s:Launcher_extract_into_destination')
  let launcherObj.create_strategy = function('s:Launcher_create_strategy')
  let launcherObj.lookup = function('s:Launcher_lookup')
  let launcherObj.on_inject = function('s:Launcher_on_inject')
  return launcherObj
endfunction

function! s:Launcher_run(strategies, finder_context, options) dict
  let self.options = a:options
...
function! s:Launcher_launch(strategies, finder_context, options) dict
...
function! s:Launcher_render_template(filepath, options) dict
...
function! s:Launcher_get_file_template_context(filepath, options) dict
  let buffers = self.lookup('buffers')
  let current_buffer = buffers.get_current()
...
function! s:Launcher_find_source_name(filepath) dict
  let projections = self.lookup('projections')
...
function! s:Launcher_extract_from_source(finder_context, options) dict
  let extractors = self.lookup('extractors')
...
function! s:Launcher_extract_into_destination(finder_context, options) dict
  if self.extractor.is_extractor
    call self.extractor.change_destination(self.extracted_lines, a:options)
  endif
endfunction

function! s:Launcher_create_strategy(klass) dict
  return self.container.lookup(a:klass)
endfunction

function! s:Launcher_lookup(name) dict
  return self.container.lookup(a:name)
endfunction

function! s:Launcher_on_inject() dict
...
function! s:LaunchableConstructor(filepath, strategy)
  ...
  let launchableObj.get_strategy = function('s:Launchable_get_strategy')
  let launchableObj.get_filepath = function('s:Launchable_get_filepath')
  let launchableObj.set_launched = function('s:Launchable_set_launched')
  let launchableObj.get_launched = function('s:Launchable_get_launched')
  return launchableObj
endfunction

function! s:Launchable_get_strategy() dict
  return self.strategy
endfunction

function! s:Launchable_get_filepath() dict
  return self.filepath
endfunction

function! s:Launchable_set_launched(launched) dict
  let self.launched = a:launched
endfunction

function! s:Launchable_get_launched() dict
...
function! s:LoggerConstructor()
  ...
  let loggerObj.add_log_writer = function('s:Logger_add_log_writer')
  let loggerObj.set_level = function('s:Logger_set_level')
  let loggerObj.get_level = function('s:Logger_get_level')
  let loggerObj.get_level_num = function('s:Logger_get_level_num')
  let loggerObj.is_loggable = function('s:Logger_is_loggable')
  let loggerObj.do_log = function('s:Logger_do_log')
  let loggerObj.args_to_message = function('s:Logger_args_to_message')
  let loggerObj.send_log = function('s:Logger_send_log')
  let loggerObj.to_color = function('s:Logger_to_color')
  let loggerObj.debug = function('s:Logger_debug')
  let loggerObj.info = function('s:Logger_info')
  let loggerObj.log = function('s:Logger_log')
  let loggerObj.warn = function('s:Logger_warn')
  let loggerObj.error = function('s:Logger_error')
  let loggerObj.fatal = function('s:Logger_fatal')
  return loggerObj
endfunction

function! s:Logger_add_log_writer(log_writer) dict
  call add(self.log_writers, a:log_writer)
endfunction

function! s:Logger_set_level(level) dict
  let self.level = a:level
endfunction

function! s:Logger_get_level() dict
  return self.level
endfunction

function! s:Logger_get_level_num(level) dict
  return self.levels[a:level]
endfunction

function! s:Logger_is_loggable(level) dict
  return self.get_level_num(a:level) >=# self.get_level_num(self.level)
endfunction

function! s:Logger_do_log(args, level) dict
...
function! s:Logger_args_to_message(args) dict
  return join(a:args, ' ')
endfunction

function! s:Logger_send_log(msg, level) dict
...
function! s:Logger_to_color(msg, level) dict
...
function! s:Logger_debug(...) dict
  call self.do_log(a:000, 'debug')
endfunction

function! s:Logger_info(...) dict
  call self.do_log(a:000, 'info')
endfunction

function! s:Logger_log(...) dict
  call self.do_log(a:000, 'info')
endfunction

function! s:Logger_warn(...) dict
  call self.do_log(a:000, 'warn')
endfunction

function! s:Logger_error(...) dict
  call self.do_log(a:000, 'error')
endfunction

function! s:Logger_fatal(...) dict
...
function! s:PythonFileWriterConstructor(sys_path, output_file)
  ...
  let pythonFileWriterObj.write = function('s:PythonFileWriter_write')
  let pythonFileWriterObj.writeln = function('s:PythonFileWriter_writeln')
  let pythonFileWriterObj.flush = function('s:PythonFileWriter_flush')
  let pythonFileWriterObj.flush_line = function('s:PythonFileWriter_flush_line')
  let pythonFileWriterObj.flush = function('s:PythonFileWriter_flush')
  let pythonFileWriterObj.setup_exit_hooks = function('s:PythonFileWriter_setup_exit_hooks')
  return pythonFileWriterObj
endfunction

function! s:PythonFileWriter_write(line) dict
  execute ':python file_writer.write("' . escape(a:line, '"') . '")'
endfunction

function! s:PythonFileWriter_writeln(line) dict
  execute ':python file_writer.writeln("' . escape(a:line, '"') . '")'
endfunction

function! s:PythonFileWriter_flush() dict
  execute ':python file_writer.flush()'
  execute ':python file_writer.close()'
endfunction

function! s:PythonFileWriter_flush_line() dict
...
function! s:PythonFileWriter_setup_exit_hooks() dict
...
function! s:FileLogWriterConstructor()
  ...
  let fileLogWriterObj.set_writer = function('s:FileLogWriter_set_writer')
  let fileLogWriterObj.get_writer = function('s:FileLogWriter_get_writer')
  let fileLogWriterObj.set_log_file = function('s:FileLogWriter_set_log_file')
  let fileLogWriterObj.set_colorize = function('s:FileLogWriter_set_colorize')
  let fileLogWriterObj.get_colorize = function('s:FileLogWriter_get_colorize')
  let fileLogWriterObj.log = function('s:FileLogWriter_log')
  let fileLogWriterObj.flush = function('s:FileLogWriter_flush')
  return fileLogWriterObj
endfunction

function! s:FileLogWriter_set_writer(writer) dict
  let self.writer = a:writer
endfunction

function! s:FileLogWriter_get_writer() dict
  return self.writer
endfunction

function! s:FileLogWriter_set_log_file(log_file) dict
  let self.log_file = a:log_file
endfunction

function! s:FileLogWriter_set_colorize(colorize) dict
  let self.colorize = a:colorize
endfunction

function! s:FileLogWriter_get_colorize() dict
  return self.colorize
endfunction

function! s:FileLogWriter_log(message) dict
  let writer = self.get_writer()
  call writer.writeln(a:message)
endfunction

function! s:FileLogWriter_flush() dict
  let writer = self.get_writer()
  call writer.flush()
endfunction
