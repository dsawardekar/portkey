...
function! s:BufferOpenerConstructor()
  ...
  let bufferOpenerObj.needs = function('<SNR>' . s:SID() . '_BufferOpener_needs')
  let bufferOpenerObj.open = function('<SNR>' . s:SID() . '_BufferOpener_open')
  let bufferOpenerObj.get_abs_root = function('<SNR>' . s:SID() . '_BufferOpener_get_abs_root')
  let bufferOpenerObj.get_rel_path = function('<SNR>' . s:SID() . '_BufferOpener_get_rel_path')
  let bufferOpenerObj.get_abs_path = function('<SNR>' . s:SID() . '_BufferOpener_get_abs_path')
...
function! s:LexNullConstructor()
  ...
  let lexNullObj.scan = function('<SNR>' . s:SID() . '_LexNull_scan')
  return lexNullObj
endfunction
...
function! s:LexTextConstructor()
  let lexTextObj = {}
  let lexTextObj.scan = function('<SNR>' . s:SID() . '_LexText_scan')
  return lexTextObj
endfunction
...
function! s:LexInsideModifierConstructor()
  ...
  let lexInsideModifierObj.scan = function('<SNR>' . s:SID() . '_LexInsideModifier_scan')
...
function! s:LexLeftDelimConstructor()
  let lexLeftDelimObj = {}
  let lexLeftDelimObj.scan = function('<SNR>' . s:SID() . '_LexLeftDelim_scan')
...
function! s:LexRightDelimConstructor()
  ...
  let lexRightDelimObj.scan = function('<SNR>' . s:SID() . '_LexRightDelim_scan')
...
function! s:LexInsidePlaceholderConstructor()
  ...
  let lexInsidePlaceholderObj.scan = function('<SNR>' . s:SID() . '_LexInsidePlaceholder_scan')
...
function! s:LexInsidePlaceholderNameConstructor()
  ...
  let lexInsidePlaceholderNameObj.scan = function('<SNR>' . s:SID() . '_LexInsidePlaceholderName_scan')
...
function! s:LexInsideFilterConstructor()
  ...
  let lexInsideFilterObj.scan = function('<SNR>' . s:SID() . '_LexInsideFilter_scan')
...
function! s:LexInsideFilterChainConstructor()
  ...
  let lexInsideFilterChainObj.scan = function('<SNR>' . s:SID() . '_LexInsideFilterChain_scan')
...
function! s:LexInsideEscapeConstructor()
  ...
  let lexInsideEscapeObj.scan = function('<SNR>' . s:SID() . '_LexInsideEscape_scan')
...
function! s:LexStateFactoryConstructor()
  ...
  let lexStateFactoryObj.get_state = function('<SNR>' . s:SID() . '_LexStateFactory_get_state')
...
function! s:EnvironmentConstructor()
  ...
  let environmentObj.on_inject = function('<SNR>' . s:SID() . '_Environment_on_inject')
  let environmentObj.load_defaults = function('<SNR>' . s:SID() . '_Environment_load_defaults')
  let environmentObj.set_option = function('<SNR>' . s:SID() . '_Environment_set_option')
  let environmentObj.get_option = function('<SNR>' . s:SID() . '_Environment_get_option')
  let environmentObj.load_option = function('<SNR>' . s:SID() . '_Environment_load_option')
  let environmentObj.load_options = function('<SNR>' . s:SID() . '_Environment_load_options')
...
function! s:ProjectorConstructor()
  ...
  let projectorObj.needs = function('<SNR>' . s:SID() . '_Projector_needs')
  let projectorObj.get_projection_templates = function('<SNR>' . s:SID() . '_Projector_get_projection_templates')
  let projectorObj.get_file_template = function('<SNR>' . s:SID() . '_Projector_get_file_template')
  let projectorObj.render_template = function('<SNR>' . s:SID() . '_Projector_render_template')
  let projectorObj.append_template = function('<SNR>' . s:SID() . '_Projector_append_template')
  return projectorObj
endfunction
...
function! s:BufferConstructor(path)
  ...
  let bufferObj.has_root = function('<SNR>' . s:SID() . '_Buffer_has_root')
  let bufferObj.find_root = function('<SNR>' . s:SID() . '_Buffer_find_root')
  let bufferObj.get_path = function('<SNR>' . s:SID() . '_Buffer_get_path')
  let bufferObj.get_portkey_path = function('<SNR>' . s:SID() . '_Buffer_get_portkey_path')
  let bufferObj.get_portkey_display_path = function('<SNR>' . s:SID() . '_Buffer_get_portkey_display_path')
  let bufferObj.get_abs_portkey_path = function('<SNR>' . s:SID() . '_Buffer_get_abs_portkey_path')
  let bufferObj.get_root = function('<SNR>' . s:SID() . '_Buffer_get_root')
  let bufferObj.get_abs_root = function('<SNR>' . s:SID() . '_Buffer_get_abs_root')
  let bufferObj.get_abs_path = function('<SNR>' . s:SID() . '_Buffer_get_abs_path')
  let bufferObj.get_rel_path = function('<SNR>' . s:SID() . '_Buffer_get_rel_path')
  let bufferObj.get_rootname = function('<SNR>' . s:SID() . '_Buffer_get_rootname')
  let bufferObj.get_filename = function('<SNR>' . s:SID() . '_Buffer_get_filename')
  let bufferObj.reset = function('<SNR>' . s:SID() . '_Buffer_reset')
  let bufferObj.set_match = function('<SNR>' . s:SID() . '_Buffer_set_match')
  let bufferObj.get_match = function('<SNR>' . s:SID() . '_Buffer_get_match')
  let bufferObj.has_projection = function('<SNR>' . s:SID() . '_Buffer_has_projection')
  let bufferObj.get_projection = function('<SNR>' . s:SID() . '_Buffer_get_projection')
  let bufferObj.get_source = function('<SNR>' . s:SID() . '_Buffer_get_source')
  let bufferObj.get_pattern = function('<SNR>' . s:SID() . '_Buffer_get_pattern')
  let bufferObj.set_enrolled = function('<SNR>' . s:SID() . '_Buffer_set_enrolled')
  let bufferObj.get_enrolled = function('<SNR>' . s:SID() . '_Buffer_get_enrolled')
  let bufferObj.set_configured = function('<SNR>' . s:SID() . '_Buffer_set_configured')
  let bufferObj.get_configured = function('<SNR>' . s:SID() . '_Buffer_get_configured')
  return bufferObj
endfunction
...
function! s:BufferCollectionConstructor()
  ...
  let bufferCollectionObj.has_current = function('<SNR>' . s:SID() . '_BufferCollection_has_current')
...
function! s:ContextCollectionConstructor()
  ...
  let contextCollectionObj.contains = function('<SNR>' . s:SID() . '_ContextCollection_contains')
  let contextCollectionObj.add = function('<SNR>' . s:SID() . '_ContextCollection_add')
  let contextCollectionObj.remove = function('<SNR>' . s:SID() . '_ContextCollection_remove')
  let contextCollectionObj.remove_all = function('<SNR>' . s:SID() . '_ContextCollection_remove_all')
  let contextCollectionObj.get = function('<SNR>' . s:SID() . '_ContextCollection_get')
...
function! s:GlobberConstructor()
  let globberObj = {}
  let globberObj.glob = function('<SNR>' . s:SID() . '_Globber_glob')
  let globberObj.get_glob_pattern = function('<SNR>' . s:SID() . '_Globber_get_glob_pattern')
  let globberObj.get_recursive_pattern = function('<SNR>' . s:SID() . '_Globber_get_recursive_pattern')
  return globberObj
endfunction
...
function! s:FinderMatcherConstructor()
  ...
  let finderMatcherObj.shorten = function('<SNR>' . s:SID() . '_FinderMatcher_shorten')
  let finderMatcherObj.match = function('<SNR>' . s:SID() . '_FinderMatcher_match')
  let finderMatcherObj.sort = function('<SNR>' . s:SID() . '_FinderMatcher_sort')
  let finderMatcherObj.compare_filenames = function('<SNR>' . s:SID() . '_FinderMatcher_compare_filenames')
  let finderMatcherObj.match_filename = function('<SNR>' . s:SID() . '_FinderMatcher_match_filename')
  let finderMatcherObj.subst_filename = function('<SNR>' . s:SID() . '_FinderMatcher_subst_filename')
  let finderMatcherObj.find_common_parent = function('<SNR>' . s:SID() . '_FinderMatcher_find_common_parent')
  let finderMatcherObj.find_common_extension = function('<SNR>' . s:SID() . '_FinderMatcher_find_common_extension')
...
function! s:FinderFacadeConstructor()
  let finderFacadeObj = {}
  let finderFacadeObj.needs = function('<SNR>' . s:SID() . '_FinderFacade_needs')
  let finderFacadeObj.find = function('<SNR>' . s:SID() . '_FinderFacade_find')
  let finderFacadeObj.pick = function('<SNR>' . s:SID() . '_FinderFacade_pick')
  let finderFacadeObj.first = function('<SNR>' . s:SID() . '_FinderFacade_first')
  let finderFacadeObj.nth = function('<SNR>' . s:SID() . '_FinderFacade_nth')
  let finderFacadeObj.find_and_rank = function('<SNR>' . s:SID() . '_FinderFacade_find_and_rank')
...
function! s:SyntaxLoaderConstructor()
  ...
  let syntaxLoaderObj.register = function('<SNR>' . s:SID() . '_SyntaxLoader_register')
  let syntaxLoaderObj.get_syntax = function('<SNR>' . s:SID() . '_SyntaxLoader_get_syntax')
  let syntaxLoaderObj.has_syntax = function('<SNR>' . s:SID() . '_SyntaxLoader_has_syntax')
  let syntaxLoaderObj.load = function('<SNR>' . s:SID() . '_SyntaxLoader_load')
  let syntaxLoaderObj.load_by_pattern = function('<SNR>' . s:SID() . '_SyntaxLoader_load_by_pattern')
...
function! s:CommandOptionsConstructor()
  ...
  let commandOptionsObj.set_args = function('<SNR>' . s:SID() . '_CommandOptions_set_args')
  let commandOptionsObj.get_args = function('<SNR>' . s:SID() . '_CommandOptions_get_args')
  let commandOptionsObj.get_nargs = function('<SNR>' . s:SID() . '_CommandOptions_get_nargs')
  let commandOptionsObj.get_opts = function('<SNR>' . s:SID() . '_CommandOptions_get_opts')
  let commandOptionsObj.set_filename = function('<SNR>' . s:SID() . '_CommandOptions_set_filename')
  let commandOptionsObj.get_filename = function('<SNR>' . s:SID() . '_CommandOptions_get_filename')
  let commandOptionsObj.set_launchables = function('<SNR>' . s:SID() . '_CommandOptions_set_launchables')
  let commandOptionsObj.get_launchables = function('<SNR>' . s:SID() . '_CommandOptions_get_launchables')
  let commandOptionsObj.set_append_mode = function('<SNR>' . s:SID() . '_CommandOptions_set_append_mode')
  let commandOptionsObj.get_append_mode = function('<SNR>' . s:SID() . '_CommandOptions_get_append_mode')
  let commandOptionsObj.get_option = function('<SNR>' . s:SID() . '_CommandOptions_get_option')
  let commandOptionsObj.get_word = function('<SNR>' . s:SID() . '_CommandOptions_get_word')
  let commandOptionsObj.get_bang = function('<SNR>' . s:SID() . '_CommandOptions_get_bang')
  let commandOptionsObj.has_range = function('<SNR>' . s:SID() . '_CommandOptions_has_range')
  let commandOptionsObj.get_range = function('<SNR>' . s:SID() . '_CommandOptions_get_range')
  let commandOptionsObj.has_count = function('<SNR>' . s:SID() . '_CommandOptions_has_count')
  let commandOptionsObj.get_count = function('<SNR>' . s:SID() . '_CommandOptions_get_count')
  let commandOptionsObj.set_window_mode = function('<SNR>' . s:SID() . '_CommandOptions_set_window_mode')
  let commandOptionsObj.get_window_mode = function('<SNR>' . s:SID() . '_CommandOptions_get_window_mode')
  let commandOptionsObj.calc_window_mode = function('<SNR>' . s:SID() . '_CommandOptions_calc_window_mode')
  let commandOptionsObj.has_resource_type = function('<SNR>' . s:SID() . '_CommandOptions_has_resource_type')
  let commandOptionsObj.get_resource_type = function('<SNR>' . s:SID() . '_CommandOptions_get_resource_type')
  let commandOptionsObj.set_resource_type = function('<SNR>' . s:SID() . '_CommandOptions_set_resource_type')
  let commandOptionsObj.build_resource_type = function('<SNR>' . s:SID() . '_CommandOptions_build_resource_type')
...
function! s:CompleterConstructor()
  let completerObj = {}
  let completerObj.needs = function('<SNR>' . s:SID() . '_Completer_needs')
  let completerObj.complete = function('<SNR>' . s:SID() . '_Completer_complete')
  let completerObj.filter = function('<SNR>' . s:SID() . '_Completer_filter')
  return completerObj
endfunction
...
function! s:ExtractorConstructor()
  let extractorObj = {}
  let extractorObj.match = function('<SNR>' . s:SID() . '_Extractor_match')
  let extractorObj.change_source = function('<SNR>' . s:SID() . '_Extractor_change_source')
  let extractorObj.change_destination = function('<SNR>' . s:SID() . '_Extractor_change_destination')
  return extractorObj
endfunction
...
function! s:ExtractorCollectionConstructor()
  ...
  let extractorCollectionObj.add_extractor = function('<SNR>' . s:SID() . '_ExtractorCollection_add_extractor')
  let extractorCollectionObj.remove_extractor = function('<SNR>' . s:SID() . '_ExtractorCollection_remove_extractor')
  let extractorCollectionObj.get_all_extractors = function('<SNR>' . s:SID() . '_ExtractorCollection_get_all_extractors')
  let extractorCollectionObj.has_extractor = function('<SNR>' . s:SID() . '_ExtractorCollection_has_extractor')
  let extractorCollectionObj.find_extractor = function('<SNR>' . s:SID() . '_ExtractorCollection_find_extractor')
  let extractorCollectionObj.size = function('<SNR>' . s:SID() . '_ExtractorCollection_size')
...
function! s:ExtensionConstructor()
  let extensionObj = {}
  let extensionObj.get_name = function('<SNR>' . s:SID() . '_Extension_get_name')
  let extensionObj.get_portkey_path = function('<SNR>' . s:SID() . '_Extension_get_portkey_path')
  let extensionObj.get_scope = function('<SNR>' . s:SID() . '_Extension_get_scope')
  let extensionObj.get_finder = function('<SNR>' . s:SID() . '_Extension_get_finder')
  let extensionObj.get_ranker = function('<SNR>' . s:SID() . '_Extension_get_ranker')
  let extensionObj.get_syntax_files = function('<SNR>' . s:SID() . '_Extension_get_syntax_files')
  let extensionObj.configure_inflector = function('<SNR>' . s:SID() . '_Extension_configure_inflector')
  let extensionObj.configure_projection = function('<SNR>' . s:SID() . '_Extension_configure_projection')
  let extensionObj.get_filters = function('<SNR>' . s:SID() . '_Extension_get_filters')
  let extensionObj.get_extractors = function('<SNR>' . s:SID() . '_Extension_get_extractors')
  return extensionObj
endfunction
...
function! s:ExtensionCollectionConstructor()
  ...
  let extensionCollectionObj.add_extension = function('<SNR>' . s:SID() . '_ExtensionCollection_add_extension')
  let extensionCollectionObj.remove_extension = function('<SNR>' . s:SID() . '_ExtensionCollection_remove_extension')
  let extensionCollectionObj.has_extension = function('<SNR>' . s:SID() . '_ExtensionCollection_has_extension')
  let extensionCollectionObj.get_extension = function('<SNR>' . s:SID() . '_ExtensionCollection_get_extension')
  let extensionCollectionObj.get_all_extensions = function('<SNR>' . s:SID() . '_ExtensionCollection_get_all_extensions')
  let extensionCollectionObj.find_extension_portkey = function('<SNR>' . s:SID() . '_ExtensionCollection_find_extension_portkey')
...
function! s:LaunchableCollectionConstructor()
  ...
  let launchableCollectionObj.add = function('<SNR>' . s:SID() . '_LaunchableCollection_add')
  let launchableCollectionObj.get_all = function('<SNR>' . s:SID() . '_LaunchableCollection_get_all')
  let launchableCollectionObj.find = function('<SNR>' . s:SID() . '_LaunchableCollection_find')
  let launchableCollectionObj.size = function('<SNR>' . s:SID() . '_LaunchableCollection_size')
...
function! s:PickFileStrategyConstructor()
  ...
  let pickFileStrategyObj.needs = function('<SNR>' . s:SID() . '_PickFileStrategy_needs')
  let pickFileStrategyObj.get_launchable = function('<SNR>' . s:SID() . '_PickFileStrategy_get_launchable')
...
function! s:FirstFileStrategyConstructor()
  ...
  let firstFileStrategyObj.needs = function('<SNR>' . s:SID() . '_FirstFileStrategy_needs')
  let firstFileStrategyObj.get_launchable = function('<SNR>' . s:SID() . '_FirstFileStrategy_get_launchable')
...
function! s:NthFileStrategyConstructor()
  ...
  let nthFileStrategyObj.needs = function('<SNR>' . s:SID() . '_NthFileStrategy_needs')
  let nthFileStrategyObj.get_launchable = function('<SNR>' . s:SID() . '_NthFileStrategy_get_launchable')
...
function! s:NewResourceStrategyConstructor()
  ...
  let newResourceStrategyObj.needs = function('<SNR>' . s:SID() . '_NewResourceStrategy_needs')
  let newResourceStrategyObj.get_launchable = function('<SNR>' . s:SID() . '_NewResourceStrategy_get_launchable')
  let newResourceStrategyObj.lookup = function('<SNR>' . s:SID() . '_NewResourceStrategy_lookup')
  let newResourceStrategyObj.affinize = function('<SNR>' . s:SID() . '_NewResourceStrategy_affinize')
...
function! s:TestFileStrategyConstructor()
  ...
  let testFileStrategyObj.needs = function('<SNR>' . s:SID() . '_TestFileStrategy_needs')
  let testFileStrategyObj.lookup = function('<SNR>' . s:SID() . '_TestFileStrategy_lookup')
  let testFileStrategyObj.get_launchable = function('<SNR>' . s:SID() . '_TestFileStrategy_get_launchable')
  let testFileStrategyObj.is_test = function('<SNR>' . s:SID() . '_TestFileStrategy_is_test')
...
function! s:GetFileStrategyConstructor()
  ...
  let getFileStrategyObj.needs = function('<SNR>' . s:SID() . '_GetFileStrategy_needs')
  let getFileStrategyObj.first = function('<SNR>' . s:SID() . '_GetFileStrategy_first')
  let getFileStrategyObj.get_launchable = function('<SNR>' . s:SID() . '_GetFileStrategy_get_launchable')
  let getFileStrategyObj.get_variant = function('<SNR>' . s:SID() . '_GetFileStrategy_get_variant')
...
function! s:StripExtStrategyConstructor()
  ...
  let stripExtStrategyObj.get_variant = function('<SNR>' . s:SID() . '_StripExtStrategy_get_variant')
...
function! s:AffinizeStrategyConstructor()
  ...
  let affinizeStrategyObj.get_variant = function('<SNR>' . s:SID() . '_AffinizeStrategy_get_variant')
...
function! s:UnderscorizeStrategyConstructor()
  ...
  let underscorizeStrategyObj.get_variant = function('<SNR>' . s:SID() . '_UnderscorizeStrategy_get_variant')
...
function! s:CamelizeStrategyConstructor()
  ...
  let camelizeStrategyObj.get_variant = function('<SNR>' . s:SID() . '_CamelizeStrategy_get_variant')
...
function! s:PortkeyCommandConstructor(container)
  ...
  let portkeyCommandObj.lookup = function('<SNR>' . s:SID() . '_PortkeyCommand_lookup')
  let portkeyCommandObj.process = function('<SNR>' . s:SID() . '_PortkeyCommand_process')
  let portkeyCommandObj.get_env_var = function('<SNR>' . s:SID() . '_PortkeyCommand_get_env_var')
  let portkeyCommandObj.buffer_has_projection = function('<SNR>' . s:SID() . '_PortkeyCommand_buffer_has_projection')
  let portkeyCommandObj.buffer_has_context = function('<SNR>' . s:SID() . '_PortkeyCommand_buffer_has_context')
  let portkeyCommandObj.buffer_has_enrolled = function('<SNR>' . s:SID() . '_PortkeyCommand_buffer_has_enrolled')
  let portkeyCommandObj.get_current_buffer = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_buffer')
  let portkeyCommandObj.get_current_buffer_path = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_buffer_path')
  let portkeyCommandObj.get_current_buffer_filename = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_buffer_filename')
  let portkeyCommandObj.get_current_buffer_rootname = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_buffer_rootname')
  let portkeyCommandObj.get_current_contexts = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_contexts')
  let portkeyCommandObj.get_current_context = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_context')
  let portkeyCommandObj.get_current_root = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_root')
  let portkeyCommandObj.get_current_projection = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_projection')
  let portkeyCommandObj.get_current_projections = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_projections')
  let portkeyCommandObj.get_current_pattern = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_pattern')
  let portkeyCommandObj.get_current_resource_type = function('<SNR>' . s:SID() . '_PortkeyCommand_get_current_resource_type')
...
function! s:LoadBufferExCmdsCommandConstructor(container)
  ...
  let loadBufferExCmdsCommandObj.get_name = function('<SNR>' . s:SID() . '_LoadBufferExCmdsCommand_get_name')
  let loadBufferExCmdsCommandObj.run = function('<SNR>' . s:SID() . '_LoadBufferExCmdsCommand_run')
...
function! s:MapBuilderConstructor()
  ...
  let mapBuilderObj.append_to = function('<SNR>' . s:SID() . '_MapBuilder_append_to')
  let mapBuilderObj.options = function('<SNR>' . s:SID() . '_MapBuilder_options')
  let mapBuilderObj.option = function('<SNR>' . s:SID() . '_MapBuilder_option')
  let mapBuilderObj.lhs = function('<SNR>' . s:SID() . '_MapBuilder_lhs')
  let mapBuilderObj.rhs = function('<SNR>' . s:SID() . '_MapBuilder_rhs')
  let mapBuilderObj.mode = function('<SNR>' . s:SID() . '_MapBuilder_mode')
  let mapBuilderObj.build = function('<SNR>' . s:SID() . '_MapBuilder_build')
...
function! s:MapLoaderConstructor(Callback)
  ...
  let mapLoaderObj.set_check_conflicts = function('<SNR>' . s:SID() . '_MapLoader_set_check_conflicts')
  let mapLoaderObj.get_check_conflicts = function('<SNR>' . s:SID() . '_MapLoader_get_check_conflicts')
  let mapLoaderObj.load = function('<SNR>' . s:SID() . '_MapLoader_load')
  let mapLoaderObj.unload = function('<SNR>' . s:SID() . '_MapLoader_unload')
  let mapLoaderObj.do_mapping = function('<SNR>' . s:SID() . '_MapLoader_do_mapping')
  let mapLoaderObj.print = function('<SNR>' . s:SID() . '_MapLoader_print')
  let mapLoaderObj.get_callback_expr = function('<SNR>' . s:SID() . '_MapLoader_get_callback_expr')
  let mapLoaderObj.has_conflict = function('<SNR>' . s:SID() . '_MapLoader_has_conflict')
  return mapLoaderObj
endfunction
...
function! s:LoadBufferMappingsCommandConstructor(container)
  ...
  let loadBufferMappingsCommandObj.get_name = function('<SNR>' . s:SID() . '_LoadBufferMappingsCommand_get_name')
  let loadBufferMappingsCommandObj.run = function('<SNR>' . s:SID() . '_LoadBufferMappingsCommand_run')
...
function! s:MapDelegateConstructor()
  let mapDelegateObj = {}
  let mapDelegateObj.invoke = function('<SNR>' . s:SID() . '_MapDelegate_invoke')
...
function! s:LoadGetFileCommandConstructor(container)
  ...
  let loadGetFileCommandObj.get_name = function('<SNR>' . s:SID() . '_LoadGetFileCommand_get_name')
  let loadGetFileCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_LoadGetFileCommand_has_ex_mode')
  let loadGetFileCommandObj.has_ctrlp_mode = function('<SNR>' . s:SID() . '_LoadGetFileCommand_has_ctrlp_mode')
  let loadGetFileCommandObj.run = function('<SNR>' . s:SID() . '_LoadGetFileCommand_run')
...
function! s:IncludeExprDelegateConstructor(cmd)
  ...
  let includeExprDelegateObj.invoke = function('<SNR>' . s:SID() . '_IncludeExprDelegate_invoke')
...
function! s:ShowVersionCommandConstructor(container)
  ...
  let showVersionCommandObj.get_name = function('<SNR>' . s:SID() . '_ShowVersionCommand_get_name')
  let showVersionCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_ShowVersionCommand_has_ex_mode')
  let showVersionCommandObj.run = function('<SNR>' . s:SID() . '_ShowVersionCommand_run')
...
function! s:RefreshCommandConstructor(container)
  ...
  let refreshCommandObj.get_name = function('<SNR>' . s:SID() . '_RefreshCommand_get_name')
  let refreshCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_RefreshCommand_has_ex_mode')
  let refreshCommandObj.get_auto_unregister = function('<SNR>' . s:SID() . '_RefreshCommand_get_auto_unregister')
  let refreshCommandObj.get_bang = function('<SNR>' . s:SID() . '_RefreshCommand_get_bang')
  let refreshCommandObj.run = function('<SNR>' . s:SID() . '_RefreshCommand_run')
...
function! s:SwitchFileCommandConstructor(container)
  ...
  let switchFileCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_SwitchFileCommand_has_ex_mode')
  let switchFileCommandObj.has_ctrlp_mode = function('<SNR>' . s:SID() . '_SwitchFileCommand_has_ctrlp_mode')
  let switchFileCommandObj.get_ctrlp_aliases = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_ctrlp_aliases')
  let switchFileCommandObj.get_nargs = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_nargs')
  let switchFileCommandObj.get_bang = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_bang')
  let switchFileCommandObj.get_completer = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_completer')
  let switchFileCommandObj.complete = function('<SNR>' . s:SID() . '_SwitchFileCommand_complete')
  let switchFileCommandObj.run = function('<SNR>' . s:SID() . '_SwitchFileCommand_run')
  let switchFileCommandObj.launch = function('<SNR>' . s:SID() . '_SwitchFileCommand_launch')
  let switchFileCommandObj.get_finder_context = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_finder_context')
  let switchFileCommandObj.get_launcher_strategies = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_launcher_strategies')
  let switchFileCommandObj.get_error_label = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_error_label')
  let switchFileCommandObj.get_error_msg = function('<SNR>' . s:SID() . '_SwitchFileCommand_get_error_msg')
  let switchFileCommandObj.can_complete = function('<SNR>' . s:SID() . '_SwitchFileCommand_can_complete')
  let switchFileCommandObj.can_run = function('<SNR>' . s:SID() . '_SwitchFileCommand_can_run')
...
function! s:PortkeyRunnerCommandConstructor(container)
  ...
  let portkeyRunnerCommandObj.get_name = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_name')
  let portkeyRunnerCommandObj.get_aliases = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_aliases')
  let portkeyRunnerCommandObj.get_nargs = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_nargs')
  let portkeyRunnerCommandObj.get_bang = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_bang')
  let portkeyRunnerCommandObj.has_ctrlp_mode = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_has_ctrlp_mode')
  let portkeyRunnerCommandObj.get_completer = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_completer')
  let portkeyRunnerCommandObj.get_finder_context = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_finder_context')
  let portkeyRunnerCommandObj.get_launcher_strategies = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_get_launcher_strategies')
  let portkeyRunnerCommandObj.launch = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_launch')
  let portkeyRunnerCommandObj.make = function('<SNR>' . s:SID() . '_PortkeyRunnerCommand_make')
...
function! s:LoadExtensionCommandConstructor(container)
  ...
  let loadExtensionCommandObj.get_name = function('<SNR>' . s:SID() . '_LoadExtensionCommand_get_name')
  let loadExtensionCommandObj.run = function('<SNR>' . s:SID() . '_LoadExtensionCommand_run')
...
function! s:PortkeyMappingsCommandConstructor(container)
  ...
  let portkeyMappingsCommandObj.get_name = function('<SNR>' . s:SID() . '_PortkeyMappingsCommand_get_name')
  let portkeyMappingsCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_PortkeyMappingsCommand_has_ex_mode')
  let portkeyMappingsCommandObj.get_bang = function('<SNR>' . s:SID() . '_PortkeyMappingsCommand_get_bang')
  let portkeyMappingsCommandObj.run = function('<SNR>' . s:SID() . '_PortkeyMappingsCommand_run')
...
function! s:OpenPortkeyCommandConstructor(controller)
  ...
  let openPortkeyCommandObj.get_name = function('<SNR>' . s:SID() . '_OpenPortkeyCommand_get_name')
  let openPortkeyCommandObj.get_aliases = function('<SNR>' . s:SID() . '_OpenPortkeyCommand_get_aliases')
  let openPortkeyCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_OpenPortkeyCommand_has_ex_mode')
  let openPortkeyCommandObj.run = function('<SNR>' . s:SID() . '_OpenPortkeyCommand_run')
...
function! s:AlternateFileCommandConstructor(container)
  ...
  let alternateFileCommandObj.get_name = function('<SNR>' . s:SID() . '_AlternateFileCommand_get_name')
  let alternateFileCommandObj.get_count = function('<SNR>' . s:SID() . '_AlternateFileCommand_get_count')
  let alternateFileCommandObj.get_aliases = function('<SNR>' . s:SID() . '_AlternateFileCommand_get_aliases')
  let alternateFileCommandObj.get_launcher_strategies = function('<SNR>' . s:SID() . '_AlternateFileCommand_get_launcher_strategies')
  let alternateFileCommandObj.get_finder_context = function('<SNR>' . s:SID() . '_AlternateFileCommand_get_finder_context')
...
function! s:RelatedFileCommandConstructor(container)
  ...
  let relatedFileCommandObj.get_name = function('<SNR>' . s:SID() . '_RelatedFileCommand_get_name')
  let relatedFileCommandObj.get_count = function('<SNR>' . s:SID() . '_RelatedFileCommand_get_count')
  let relatedFileCommandObj.get_aliases = function('<SNR>' . s:SID() . '_RelatedFileCommand_get_aliases')
  let relatedFileCommandObj.get_finder_context = function('<SNR>' . s:SID() . '_RelatedFileCommand_get_finder_context')
  let relatedFileCommandObj.get_launcher_strategies = function('<SNR>' . s:SID() . '_RelatedFileCommand_get_launcher_strategies')
...
function! s:ResourceFileCommandConstructor(container)
  ...
  let resourceFileCommandObj.get_name = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_name')
  let resourceFileCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_ResourceFileCommand_has_ex_mode')
  let resourceFileCommandObj.has_ctrlp_mode = function('<SNR>' . s:SID() . '_ResourceFileCommand_has_ctrlp_mode')
  let resourceFileCommandObj.get_range = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_range')
  let resourceFileCommandObj.get_aliases = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_aliases')
  let resourceFileCommandObj.get_ctrlp_aliases = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_ctrlp_aliases')
  let resourceFileCommandObj.get_finder_context = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_finder_context')
  let resourceFileCommandObj.get_launcher_strategies = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_launcher_strategies')
  let resourceFileCommandObj.get_resource_type_names = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_resource_type_names')
  let resourceFileCommandObj.get_error_label = function('<SNR>' . s:SID() . '_ResourceFileCommand_get_error_label')
  let resourceFileCommandObj.can_complete = function('<SNR>' . s:SID() . '_ResourceFileCommand_can_complete')
  let resourceFileCommandObj.can_run = function('<SNR>' . s:SID() . '_ResourceFileCommand_can_run')
...
function! s:GetFileCommandConstructor(container)
  ...
  let getFileCommandObj.get_name = function('<SNR>' . s:SID() . '_GetFileCommand_get_name')
  let getFileCommandObj.has_ex_mode = function('<SNR>' . s:SID() . '_GetFileCommand_has_ex_mode')
  let getFileCommandObj.has_ctrlp_mode = function('<SNR>' . s:SID() . '_GetFileCommand_has_ctrlp_mode')
  let getFileCommandObj.get_finder_context = function('<SNR>' . s:SID() . '_GetFileCommand_get_finder_context')
  let getFileCommandObj.get_launcher_strategies = function('<SNR>' . s:SID() . '_GetFileCommand_get_launcher_strategies')
  let getFileCommandObj.launch = function('<SNR>' . s:SID() . '_GetFileCommand_launch')
  let getFileCommandObj.to_rel_path = function('<SNR>' . s:SID() . '_GetFileCommand_to_rel_path')
...
function! s:LinesExtractorConstructor()
  ...
  let linesExtractorObj.match = function('<SNR>' . s:SID() . '_LinesExtractor_match')
  let linesExtractorObj.change_source = function('<SNR>' . s:SID() . '_LinesExtractor_change_source')
  let linesExtractorObj.change_destination = function('<SNR>' . s:SID() . '_LinesExtractor_change_destination')
...
function! s:ProjectionFinderConstructor(projector)
  ...
  let projectionFinderObj.find = function('<SNR>' . s:SID() . '_ProjectionFinder_find')
  let projectionFinderObj.is_readable = function('<SNR>' . s:SID() . '_ProjectionFinder_is_readable')
...
function! s:ProjectionRankerConstructor()
  ...
  let projectionRankerObj.rank = function('<SNR>' . s:SID() . '_ProjectionRanker_rank')
  let projectionRankerObj.get_rootname = function('<SNR>' . s:SID() . '_ProjectionRanker_get_rootname')
...
function! s:ResourceFinderConstructor()
  ...
  let resourceFinderObj.needs = function('<SNR>' . s:SID() . '_ResourceFinder_needs')
  let resourceFinderObj.find = function('<SNR>' . s:SID() . '_ResourceFinder_find')
...
function! s:FileFinderConstructor()
  let fileFinderObj = {}
  let fileFinderObj.find = function('<SNR>' . s:SID() . '_FileFinder_find')
  let fileFinderObj.add_candidate = function('<SNR>' . s:SID() . '_FileFinder_add_candidate')
  let fileFinderObj.into_pattern = function('<SNR>' . s:SID() . '_FileFinder_into_pattern')
  let fileFinderObj.into_rootname = function('<SNR>' . s:SID() . '_FileFinder_into_rootname')
...
function! s:CoreExtensionConstructor()
  ...
  let coreExtensionObj.needs = function('<SNR>' . s:SID() . '_CoreExtension_needs')
  let coreExtensionObj.get_name = function('<SNR>' . s:SID() . '_CoreExtension_get_name')
  let coreExtensionObj.get_scope = function('<SNR>' . s:SID() . '_CoreExtension_get_scope')
  let coreExtensionObj.get_portkey_path = function('<SNR>' . s:SID() . '_CoreExtension_get_portkey_path')
  let coreExtensionObj.load = function('<SNR>' . s:SID() . '_CoreExtension_load')
  let coreExtensionObj.get_finder = function('<SNR>' . s:SID() . '_CoreExtension_get_finder')
  let coreExtensionObj.get_ranker = function('<SNR>' . s:SID() . '_CoreExtension_get_ranker')
  let coreExtensionObj.get_syntax_files = function('<SNR>' . s:SID() . '_CoreExtension_get_syntax_files')
  let coreExtensionObj.get_extractors = function('<SNR>' . s:SID() . '_CoreExtension_get_extractors')
  let coreExtensionObj.configure_inflector = function('<SNR>' . s:SID() . '_CoreExtension_configure_inflector')
  let coreExtensionObj.configure_projection = function('<SNR>' . s:SID() . '_CoreExtension_configure_projection')
  let coreExtensionObj.get_filters = function('<SNR>' . s:SID() . '_CoreExtension_get_filters')
  let coreExtensionObj.lookup = function('<SNR>' . s:SID() . '_CoreExtension_lookup')
...
function! s:ControllerConstructor()
  ...
  let controllerObj.load_core_extension = function('<SNR>' . s:SID() . '_Controller_load_core_extension')
...
function! s:AppConstructor()
  ...
  let appObj.add_extension = function('<SNR>' . s:SID() . '_App_add_extension')
  return appObj
endfunction
...
function! s:ObjectCacheConstructor()
  ...
  let objectCacheObj.has = function('<SNR>' . s:SID() . '_ObjectCache_has')
  let objectCacheObj.add = function('<SNR>' . s:SID() . '_ObjectCache_add')
  let objectCacheObj.insert = function('<SNR>' . s:SID() . '_ObjectCache_insert')
  let objectCacheObj.put = function('<SNR>' . s:SID() . '_ObjectCache_put')
  let objectCacheObj.get = function('<SNR>' . s:SID() . '_ObjectCache_get')
  let objectCacheObj.remove = function('<SNR>' . s:SID() . '_ObjectCache_remove')
  let objectCacheObj.clear = function('<SNR>' . s:SID() . '_ObjectCache_clear')
  let objectCacheObj.clear_all = function('<SNR>' . s:SID() . '_ObjectCache_clear_all')
  let objectCacheObj.get_hits = function('<SNR>' . s:SID() . '_ObjectCache_get_hits')
  let objectCacheObj.get_misses = function('<SNR>' . s:SID() . '_ObjectCache_get_misses')
...
function! s:MemoizerDelegateConstructor(target, method, cache_store, memoizer)
  ...
  let memoizerDelegateObj.get_key = function('<SNR>' . s:SID() . '_MemoizerDelegate_get_key')
  let memoizerDelegateObj.invoke = function('<SNR>' . s:SID() . '_MemoizerDelegate_invoke')
...
function! s:MemoizerConstructor(target)
  ...
  let memoizerObj.memoizer_get_target = function('<SNR>' . s:SID() . '_Memoizer_memoizer_get_target')
  let memoizerObj.memoizer_load_method = function('<SNR>' . s:SID() . '_Memoizer_memoizer_load_method')
  let memoizerObj.memoizer_load = function('<SNR>' . s:SID() . '_Memoizer_memoizer_load')
  let memoizerObj.memoizer_load_all = function('<SNR>' . s:SID() . '_Memoizer_memoizer_load_all')
  let memoizerObj.memoizer_start = function('<SNR>' . s:SID() . '_Memoizer_memoizer_start')
  let memoizerObj.memoizer_stop = function('<SNR>' . s:SID() . '_Memoizer_memoizer_stop')
  let memoizerObj.memoizer_is_active = function('<SNR>' . s:SID() . '_Memoizer_memoizer_is_active')
  let memoizerObj.memoizer_clear_cache = function('<SNR>' . s:SID() . '_Memoizer_memoizer_clear_cache')
  let memoizerObj.memoizer_clear_all = function('<SNR>' . s:SID() . '_Memoizer_memoizer_clear_all')
  let memoizerObj.memoizer_get_hits = function('<SNR>' . s:SID() . '_Memoizer_memoizer_get_hits')
  let memoizerObj.memoizer_get_misses = function('<SNR>' . s:SID() . '_Memoizer_memoizer_get_misses')
  return memoizerObj
endfunction
...
function! s:LexerConstructor()
  let lexerObj = {}
  let lexerObj.next = function('<SNR>' . s:SID() . '_Lexer_next')
  let lexerObj.backup = function('<SNR>' . s:SID() . '_Lexer_backup')
  let lexerObj.peek = function('<SNR>' . s:SID() . '_Lexer_peek')
  let lexerObj.ignore = function('<SNR>' . s:SID() . '_Lexer_ignore')
  let lexerObj.ignore_whitespace = function('<SNR>' . s:SID() . '_Lexer_ignore_whitespace')
  let lexerObj.advance = function('<SNR>' . s:SID() . '_Lexer_advance')
  let lexerObj.accept = function('<SNR>' . s:SID() . '_Lexer_accept')
  let lexerObj.accept_run = function('<SNR>' . s:SID() . '_Lexer_accept_run')
  let lexerObj.accept_keyword = function('<SNR>' . s:SID() . '_Lexer_accept_keyword')
  let lexerObj.emit = function('<SNR>' . s:SID() . '_Lexer_emit')
  let lexerObj.emit_text = function('<SNR>' . s:SID() . '_Lexer_emit_text')
  let lexerObj.was_text_last_emitted = function('<SNR>' . s:SID() . '_Lexer_was_text_last_emitted')
  let lexerObj.scan = function('<SNR>' . s:SID() . '_Lexer_scan')
  let lexerObj.run = function('<SNR>' . s:SID() . '_Lexer_run')
  let lexerObj.is_state = function('<SNR>' . s:SID() . '_Lexer_is_state')
  let lexerObj.is_ahead = function('<SNR>' . s:SID() . '_Lexer_is_ahead')
  let lexerObj.is_whitespace = function('<SNR>' . s:SID() . '_Lexer_is_whitespace')
  let lexerObj.error = function('<SNR>' . s:SID() . '_Lexer_error')
  let lexerObj.print_cursor = function('<SNR>' . s:SID() . '_Lexer_print_cursor')
  let lexerObj.print_stream = function('<SNR>' . s:SID() . '_Lexer_print_stream')
  return lexerObj
endfunction
...
function! s:UppercaseFilterConstructor()
  ...
  let uppercaseFilterObj.filter = function('<SNR>' . s:SID() . '_UppercaseFilter_filter')
...
function! s:LowercaseFilterConstructor()
  ...
  let lowercaseFilterObj.filter = function('<SNR>' . s:SID() . '_LowercaseFilter_filter')
...
function! s:InflectorFilterConstructor()
  ...
  let inflectorFilterObj.set_inflector = function('<SNR>' . s:SID() . '_InflectorFilter_set_inflector')
...
function! s:PluralFilterConstructor()
  ...
  let pluralFilterObj.filter = function('<SNR>' . s:SID() . '_PluralFilter_filter')
...
function! s:SingularFilterConstructor()
  ...
  let singularFilterObj.filter = function('<SNR>' . s:SID() . '_SingularFilter_filter')
...
function! s:CamelcaseFilterConstructor()
  ...
  let camelcaseFilterObj.filter = function('<SNR>' . s:SID() . '_CamelcaseFilter_filter')
...
function! s:LowerCamelcaseFilterConstructor()
  ...
  let lowerCamelcaseFilterObj.filter = function('<SNR>' . s:SID() . '_LowerCamelcaseFilter_filter')
...
function! s:UnderscoreFilterConstructor()
  ...
  let underscoreFilterObj.filter = function('<SNR>' . s:SID() . '_UnderscoreFilter_filter')
...
function! s:HumanFilterConstructor()
  ...
  let humanFilterObj.filter = function('<SNR>' . s:SID() . '_HumanFilter_filter')
...
function! s:DashFilterConstructor()
  ...
  let dashFilterObj.filter = function('<SNR>' . s:SID() . '_DashFilter_filter')
...
function! s:TitleFilterConstructor()
  ...
  let titleFilterObj.filter = function('<SNR>' . s:SID() . '_TitleFilter_filter')
...
function! s:TableFilterConstructor()
  ...
  let tableFilterObj.filter = function('<SNR>' . s:SID() . '_TableFilter_filter')
...
function! s:ClassFilterConstructor()
  ...
  let classFilterObj.filter = function('<SNR>' . s:SID() . '_ClassFilter_filter')
...
function! s:BaseFilterFactoryConstructor()
  ...
  let baseFilterFactoryObj.needs = function('<SNR>' . s:SID() . '_BaseFilterFactory_needs')
  let baseFilterFactoryObj.has_filter = function('<SNR>' . s:SID() . '_BaseFilterFactory_has_filter')
  let baseFilterFactoryObj.add_filter = function('<SNR>' . s:SID() . '_BaseFilterFactory_add_filter')
  let baseFilterFactoryObj.get_filter = function('<SNR>' . s:SID() . '_BaseFilterFactory_get_filter')
  let baseFilterFactoryObj.configure_filter = function('<SNR>' . s:SID() . '_BaseFilterFactory_configure_filter')
...
function! s:FilterFactoryConstructor()
  ...
  let filterFactoryObj.on_inject = function('<SNR>' . s:SID() . '_FilterFactory_on_inject')
  let filterFactoryObj.load_defaults = function('<SNR>' . s:SID() . '_FilterFactory_load_defaults')
...
function! s:TemplateObjectConstructor()
  ...
  let templateObjectObj.append = function('<SNR>' . s:SID() . '_TemplateObject_append')
  let templateObjectObj.render = function('<SNR>' . s:SID() . '_TemplateObject_render')
...
function! s:TextObjectConstructor(text)
  ...
  let textObjectObj.render = function('<SNR>' . s:SID() . '_TextObject_render')
...
function! s:PlaceholderObjectConstructor(name)
  ...
  let placeholderObjectObj.set_filter_factory = function('<SNR>' . s:SID() . '_PlaceholderObject_set_filter_factory')
  let placeholderObjectObj.add_filter = function('<SNR>' . s:SID() . '_PlaceholderObject_add_filter')
  let placeholderObjectObj.filter = function('<SNR>' . s:SID() . '_PlaceholderObject_filter')
  let placeholderObjectObj.render = function('<SNR>' . s:SID() . '_PlaceholderObject_render')
...
function! s:NewlineObjectConstructor()
  ...
  let newlineObjectObj.render = function('<SNR>' . s:SID() . '_NewlineObject_render')
...
function! s:TabObjectConstructor()
  ...
  let tabObjectObj.render = function('<SNR>' . s:SID() . '_TabObject_render')
  return tabObjectObj
endfunction
...
function! s:CompilerConstructor()
  ...
  let compilerObj.needs = function('<SNR>' . s:SID() . '_Compiler_needs')
  let compilerObj.get_object = function('<SNR>' . s:SID() . '_Compiler_get_object')
  let compilerObj.get_key_name_for_modifier = function('<SNR>' . s:SID() . '_Compiler_get_key_name_for_modifier')
  let compilerObj.get_filter_for_modifier = function('<SNR>' . s:SID() . '_Compiler_get_filter_for_modifier')
  let compilerObj.is_placeholder = function('<SNR>' . s:SID() . '_Compiler_is_placeholder')
  let compilerObj.is_filter = function('<SNR>' . s:SID() . '_Compiler_is_filter')
  let compilerObj.is_eof = function('<SNR>' . s:SID() . '_Compiler_is_eof')
  let compilerObj.is_visible = function('<SNR>' . s:SID() . '_Compiler_is_visible')
  let compilerObj.compile = function('<SNR>' . s:SID() . '_Compiler_compile')
  return compilerObj
endfunction
...
function! s:ProjectionTemplateConstructor(original)
  ...
  let projectionTemplateObj.get_original = function('<SNR>' . s:SID() . '_ProjectionTemplate_get_original')
  let projectionTemplateObj.get_compiled = function('<SNR>' . s:SID() . '_ProjectionTemplate_get_compiled')
  let projectionTemplateObj.has_error = function('<SNR>' . s:SID() . '_ProjectionTemplate_has_error')
  let projectionTemplateObj.get_error = function('<SNR>' . s:SID() . '_ProjectionTemplate_get_error')
  let projectionTemplateObj.compile = function('<SNR>' . s:SID() . '_ProjectionTemplate_compile')
  let projectionTemplateObj.render = function('<SNR>' . s:SID() . '_ProjectionTemplate_render')
  let projectionTemplateObj.is_compiled = function('<SNR>' . s:SID() . '_ProjectionTemplate_is_compiled')
...
function! s:ProjectionPatternConstructor(original, projection)
  ...
  let projectionPatternObj.get_original = function('<SNR>' . s:SID() . '_ProjectionPattern_get_original')
  let projectionPatternObj.get_projection = function('<SNR>' . s:SID() . '_ProjectionPattern_get_projection')
  let projectionPatternObj.swap = function('<SNR>' . s:SID() . '_ProjectionPattern_swap')
  let projectionPatternObj.get_regex = function('<SNR>' . s:SID() . '_ProjectionPattern_get_regex')
  let projectionPatternObj.has_template = function('<SNR>' . s:SID() . '_ProjectionPattern_has_template')
  let projectionPatternObj.set_template = function('<SNR>' . s:SID() . '_ProjectionPattern_set_template')
  let projectionPatternObj.get_template = function('<SNR>' . s:SID() . '_ProjectionPattern_get_template')
  let projectionPatternObj.is_recursive = function('<SNR>' . s:SID() . '_ProjectionPattern_is_recursive')
...
function! s:ProjectionMatcherConstructor(map)
  ...
  let projectionMatcherObj.match = function('<SNR>' . s:SID() . '_ProjectionMatcher_match')
  let projectionMatcherObj.get_pattern_store = function('<SNR>' . s:SID() . '_ProjectionMatcher_get_pattern_store')
  let projectionMatcherObj.set_updated = function('<SNR>' . s:SID() . '_ProjectionMatcher_set_updated')
  let projectionMatcherObj.get_updated = function('<SNR>' . s:SID() . '_ProjectionMatcher_get_updated')
  let projectionMatcherObj.get_patterns = function('<SNR>' . s:SID() . '_ProjectionMatcher_get_patterns')
  let projectionMatcherObj.sort_projections = function('<SNR>' . s:SID() . '_ProjectionMatcher_sort_projections')
  let projectionMatcherObj.update = function('<SNR>' . s:SID() . '_ProjectionMatcher_update')
  let projectionMatcherObj.get_callback = function('<SNR>' . s:SID() . '_ProjectionMatcher_get_callback')
  let projectionMatcherObj.compare_patterns = function('<SNR>' . s:SID() . '_ProjectionMatcher_compare_patterns')
  let projectionMatcherObj.compare_alphabetical = function('<SNR>' . s:SID() . '_ProjectionMatcher_compare_alphabetical')
...
function! s:ProjectionMatchConstructor(ok)
  ...
  let projectionMatchObj.set_input = function('<SNR>' . s:SID() . '_ProjectionMatch_set_input')
  let projectionMatchObj.get_input = function('<SNR>' . s:SID() . '_ProjectionMatch_get_input')
  let projectionMatchObj.set_source = function('<SNR>' . s:SID() . '_ProjectionMatch_set_source')
  let projectionMatchObj.get_source = function('<SNR>' . s:SID() . '_ProjectionMatch_get_source')
  let projectionMatchObj.set_pattern = function('<SNR>' . s:SID() . '_ProjectionMatch_set_pattern')
  let projectionMatchObj.get_pattern = function('<SNR>' . s:SID() . '_ProjectionMatch_get_pattern')
...
function! s:ProjectionConstructor(resource_type)
  ...
  let projectionObj.get_revision = function('<SNR>' . s:SID() . '_Projection_get_revision')
  let projectionObj.bump_revision = function('<SNR>' . s:SID() . '_Projection_bump_revision')
  let projectionObj.get_id = function('<SNR>' . s:SID() . '_Projection_get_id')
  let projectionObj.get_hash = function('<SNR>' . s:SID() . '_Projection_get_hash')
  let projectionObj.has_pattern = function('<SNR>' . s:SID() . '_Projection_has_pattern')
  let projectionObj.add_pattern = function('<SNR>' . s:SID() . '_Projection_add_pattern')
  let projectionObj.get_patterns = function('<SNR>' . s:SID() . '_Projection_get_patterns')
  let projectionObj.match = function('<SNR>' . s:SID() . '_Projection_match')
  let projectionObj.get_compare_func = function('<SNR>' . s:SID() . '_Projection_get_compare_func')
  let projectionObj.has_projection_template = function('<SNR>' . s:SID() . '_Projection_has_projection_template')
  let projectionObj.get_projection_templates = function('<SNR>' . s:SID() . '_Projection_get_projection_templates')
  let projectionObj.add_projection_template = function('<SNR>' . s:SID() . '_Projection_add_projection_template')
  let projectionObj.get_resource_type = function('<SNR>' . s:SID() . '_Projection_get_resource_type')
  let projectionObj.has_keyword = function('<SNR>' . s:SID() . '_Projection_has_keyword')
  let projectionObj.add_keyword = function('<SNR>' . s:SID() . '_Projection_add_keyword')
  let projectionObj.get_keyword_list = function('<SNR>' . s:SID() . '_Projection_get_keyword_list')
  let projectionObj.set_affinity = function('<SNR>' . s:SID() . '_Projection_set_affinity')
  let projectionObj.get_affinity = function('<SNR>' . s:SID() . '_Projection_get_affinity')
  let projectionObj.get_mapping = function('<SNR>' . s:SID() . '_Projection_get_mapping')
  let projectionObj.set_mapping = function('<SNR>' . s:SID() . '_Projection_set_mapping')
  let projectionObj.has_mapping = function('<SNR>' . s:SID() . '_Projection_has_mapping')
  let projectionObj.get_compiler = function('<SNR>' . s:SID() . '_Projection_get_compiler')
  let projectionObj.set_compiler = function('<SNR>' . s:SID() . '_Projection_set_compiler')
  let projectionObj.has_compiler = function('<SNR>' . s:SID() . '_Projection_has_compiler')
  let projectionObj.get_scope = function('<SNR>' . s:SID() . '_Projection_get_scope')
  let projectionObj.set_scope = function('<SNR>' . s:SID() . '_Projection_set_scope')
  let projectionObj.has_scope = function('<SNR>' . s:SID() . '_Projection_has_scope')
...
function! s:TrieConstructor()
  ...
  let trieObj.add_word = function('<SNR>' . s:SID() . '_Trie_add_word')
  let trieObj.size = function('<SNR>' . s:SID() . '_Trie_size')
  let trieObj.sizeof = function('<SNR>' . s:SID() . '_Trie_sizeof')
  let trieObj.keys = function('<SNR>' . s:SID() . '_Trie_keys')
  let trieObj.keys_with_prefix = function('<SNR>' . s:SID() . '_Trie_keys_with_prefix')
  let trieObj.collect = function('<SNR>' . s:SID() . '_Trie_collect')
  let trieObj.get = function('<SNR>' . s:SID() . '_Trie_get')
  let trieObj.find = function('<SNR>' . s:SID() . '_Trie_find')
  let trieObj.find_distinct_prefixes = function('<SNR>' . s:SID() . '_Trie_find_distinct_prefixes')
  let trieObj.collect_prefix = function('<SNR>' . s:SID() . '_Trie_collect_prefix')
  let trieObj.print = function('<SNR>' . s:SID() . '_Trie_print')
  return trieObj
endfunction
...
function! s:TrieNodeConstructor(char, source)
  ...
  let trieNodeObj.add_child = function('<SNR>' . s:SID() . '_TrieNode_add_child')
  let trieNodeObj.remove_child = function('<SNR>' . s:SID() . '_TrieNode_remove_child')
  let trieNodeObj.collect_prefix = function('<SNR>' . s:SID() . '_TrieNode_collect_prefix')
  let trieNodeObj.get_children = function('<SNR>' . s:SID() . '_TrieNode_get_children')
  let trieNodeObj.contains = function('<SNR>' . s:SID() . '_TrieNode_contains')
  let trieNodeObj.get_char = function('<SNR>' . s:SID() . '_TrieNode_get_char')
  let trieNodeObj.set_char = function('<SNR>' . s:SID() . '_TrieNode_set_char')
  let trieNodeObj.get_child = function('<SNR>' . s:SID() . '_TrieNode_get_child')
  let trieNodeObj.get_source = function('<SNR>' . s:SID() . '_TrieNode_get_source')
  let trieNodeObj.get_total_children = function('<SNR>' . s:SID() . '_TrieNode_get_total_children')
  let trieNodeObj.has_child = function('<SNR>' . s:SID() . '_TrieNode_has_child')
  let trieNodeObj.has_fork = function('<SNR>' . s:SID() . '_TrieNode_has_fork')
  let trieNodeObj.print = function('<SNR>' . s:SID() . '_TrieNode_print')
  let trieNodeObj.print_str = function('<SNR>' . s:SID() . '_TrieNode_print_str')
  return trieNodeObj
endfunction
...
function! s:PrefixCollectorConstructor()
  ...
  let prefixCollectorObj.accept_start = function('<SNR>' . s:SID() . '_PrefixCollector_accept_start')
  let prefixCollectorObj.accept_end = function('<SNR>' . s:SID() . '_PrefixCollector_accept_end')
  let prefixCollectorObj.accept_start_frame = function('<SNR>' . s:SID() . '_PrefixCollector_accept_start_frame')
  let prefixCollectorObj.accept_push = function('<SNR>' . s:SID() . '_PrefixCollector_accept_push')
  let prefixCollectorObj.accept_end_frame = function('<SNR>' . s:SID() . '_PrefixCollector_accept_end_frame')
  let prefixCollectorObj.improve_collection = function('<SNR>' . s:SID() . '_PrefixCollector_improve_collection')
  let prefixCollectorObj.get_prefixes = function('<SNR>' . s:SID() . '_PrefixCollector_get_prefixes')
  let prefixCollectorObj.add_prefix = function('<SNR>' . s:SID() . '_PrefixCollector_add_prefix')
  let prefixCollectorObj.print_prefixes = function('<SNR>' . s:SID() . '_PrefixCollector_print_prefixes')
...
function! s:StackConstructor()
  let stackObj = {}
  let stackObj.frames = []
  let stackObj.push = function('<SNR>' . s:SID() . '_Stack_push')
  let stackObj.pop = function('<SNR>' . s:SID() . '_Stack_pop')
  let stackObj.is_empty = function('<SNR>' . s:SID() . '_Stack_is_empty')
  return stackObj
endfunction
...
function! s:StackFrameConstructor(start)
  ...
  let stackFrameObj.set_source = function('<SNR>' . s:SID() . '_StackFrame_set_source')
  let stackFrameObj.get_source = function('<SNR>' . s:SID() . '_StackFrame_get_source')
  let stackFrameObj.append = function('<SNR>' . s:SID() . '_StackFrame_append')
  let stackFrameObj.set_nesting = function('<SNR>' . s:SID() . '_StackFrame_set_nesting')
  let stackFrameObj.get_nesting = function('<SNR>' . s:SID() . '_StackFrame_get_nesting')
  let stackFrameObj.get_prefix = function('<SNR>' . s:SID() . '_StackFrame_get_prefix')
  let stackFrameObj.get_chars = function('<SNR>' . s:SID() . '_StackFrame_get_chars')
...
function! s:ProjectionCollectionConstructor()
  ...
  let projectionCollectionObj.needs = function('<SNR>' . s:SID() . '_ProjectionCollection_needs')
  let projectionCollectionObj.get_matcher = function('<SNR>' . s:SID() . '_ProjectionCollection_get_matcher')
  let projectionCollectionObj.add = function('<SNR>' . s:SID() . '_ProjectionCollection_add')
  let projectionCollectionObj.change_projection = function('<SNR>' . s:SID() . '_ProjectionCollection_change_projection')
  let projectionCollectionObj.has = function('<SNR>' . s:SID() . '_ProjectionCollection_has')
  let projectionCollectionObj.find_by_resource_type = function('<SNR>' . s:SID() . '_ProjectionCollection_find_by_resource_type')
  let projectionCollectionObj.get_projections = function('<SNR>' . s:SID() . '_ProjectionCollection_get_projections')
  let projectionCollectionObj.get_resource_types = function('<SNR>' . s:SID() . '_ProjectionCollection_get_resource_types')
  let projectionCollectionObj.get_mappings = function('<SNR>' . s:SID() . '_ProjectionCollection_get_mappings')
  let projectionCollectionObj.get_patterns = function('<SNR>' . s:SID() . '_ProjectionCollection_get_patterns')
  let projectionCollectionObj.match = function('<SNR>' . s:SID() . '_ProjectionCollection_match')
...
function! s:ProjectionLoaderConstructor(projection)
  ...
  let projectionLoaderObj.load = function('<SNR>' . s:SID() . '_ProjectionLoader_load')
  let projectionLoaderObj.get_changed = function('<SNR>' . s:SID() . '_ProjectionLoader_get_changed')
  let projectionLoaderObj.load_property = function('<SNR>' . s:SID() . '_ProjectionLoader_load_property')
  let projectionLoaderObj.load_projection_template = function('<SNR>' . s:SID() . '_ProjectionLoader_load_projection_template')
  let projectionLoaderObj.load_list = function('<SNR>' . s:SID() . '_ProjectionLoader_load_list')
  let projectionLoaderObj.load_pattern = function('<SNR>' . s:SID() . '_ProjectionLoader_load_pattern')
  let projectionLoaderObj.has_property = function('<SNR>' . s:SID() . '_ProjectionLoader_has_property')
  let projectionLoaderObj.change_property = function('<SNR>' . s:SID() . '_ProjectionLoader_change_property')
  let projectionLoaderObj.change_list = function('<SNR>' . s:SID() . '_ProjectionLoader_change_list')
  let projectionLoaderObj.change_list_item = function('<SNR>' . s:SID() . '_ProjectionLoader_change_list_item')
...
function! s:InflectionExecuterConstructor()
  ...
  let inflectionExecuterObj.inflect = function('<SNR>' . s:SID() . '_InflectionExecuter_inflect')
...
function! s:BaseInflectorConstructor()
  ...
  let baseInflectorObj.add_rule = function('<SNR>' . s:SID() . '_BaseInflector_add_rule')
  let baseInflectorObj.set_mode = function('<SNR>' . s:SID() . '_BaseInflector_set_mode')
  let baseInflectorObj.get_mode = function('<SNR>' . s:SID() . '_BaseInflector_get_mode')
  let baseInflectorObj.add_plural_rule = function('<SNR>' . s:SID() . '_BaseInflector_add_plural_rule')
  let baseInflectorObj.add_singular_rule = function('<SNR>' . s:SID() . '_BaseInflector_add_singular_rule')
  let baseInflectorObj.add_uncountable = function('<SNR>' . s:SID() . '_BaseInflector_add_uncountable')
  let baseInflectorObj.add_plural_rules = function('<SNR>' . s:SID() . '_BaseInflector_add_plural_rules')
  let baseInflectorObj.add_singular_rules = function('<SNR>' . s:SID() . '_BaseInflector_add_singular_rules')
  let baseInflectorObj.add_uncountables = function('<SNR>' . s:SID() . '_BaseInflector_add_uncountables')
  let baseInflectorObj.add_irregular = function('<SNR>' . s:SID() . '_BaseInflector_add_irregular')
  let baseInflectorObj.add_irregulars = function('<SNR>' . s:SID() . '_BaseInflector_add_irregulars')
  let baseInflectorObj.add_acronym = function('<SNR>' . s:SID() . '_BaseInflector_add_acronym')
  let baseInflectorObj.add_acronyms = function('<SNR>' . s:SID() . '_BaseInflector_add_acronyms')
  let baseInflectorObj.pluralize = function('<SNR>' . s:SID() . '_BaseInflector_pluralize')
  let baseInflectorObj.singularize = function('<SNR>' . s:SID() . '_BaseInflector_singularize')
  let baseInflectorObj.capitalize = function('<SNR>' . s:SID() . '_BaseInflector_capitalize')
  let baseInflectorObj.camelize = function('<SNR>' . s:SID() . '_BaseInflector_camelize')
  let baseInflectorObj.lower_camelize = function('<SNR>' . s:SID() . '_BaseInflector_lower_camelize')
  let baseInflectorObj.underscorize = function('<SNR>' . s:SID() . '_BaseInflector_underscorize')
  let baseInflectorObj.dasherize = function('<SNR>' . s:SID() . '_BaseInflector_dasherize')
  let baseInflectorObj.humanize = function('<SNR>' . s:SID() . '_BaseInflector_humanize')
  let baseInflectorObj.titleize = function('<SNR>' . s:SID() . '_BaseInflector_titleize')
  let baseInflectorObj.tableize = function('<SNR>' . s:SID() . '_BaseInflector_tableize')
  let baseInflectorObj.classify = function('<SNR>' . s:SID() . '_BaseInflector_classify')
  let baseInflectorObj.affinize = function('<SNR>' . s:SID() . '_BaseInflector_affinize')
  let baseInflectorObj.clear = function('<SNR>' . s:SID() . '_BaseInflector_clear')
  let baseInflectorObj.is_uncountable = function('<SNR>' . s:SID() . '_BaseInflector_is_uncountable')
  let baseInflectorObj.is_irregular = function('<SNR>' . s:SID() . '_BaseInflector_is_irregular')
  let baseInflectorObj.update_acronyms_regex = function('<SNR>' . s:SID() . '_BaseInflector_update_acronyms_regex')
  let baseInflectorObj.replace_acronyms = function('<SNR>' . s:SID() . '_BaseInflector_replace_acronyms')
  let baseInflectorObj.has_acronym_at_start = function('<SNR>' . s:SID() . '_BaseInflector_has_acronym_at_start')
  let baseInflectorObj.acronym_for_match = function('<SNR>' . s:SID() . '_BaseInflector_acronym_for_match')
...
function! s:InflectorConstructor()
  ...
  let inflectorObj.on_inject = function('<SNR>' . s:SID() . '_Inflector_on_inject')
  let inflectorObj.load_defaults = function('<SNR>' . s:SID() . '_Inflector_load_defaults')
  return inflectorObj
endfunction
...
function! s:InflectionLoaderConstructor()
  ...
  let inflectionLoaderObj.load = function('<SNR>' . s:SID() . '_InflectionLoader_load')
  let inflectionLoaderObj.load_acronyms = function('<SNR>' . s:SID() . '_InflectionLoader_load_acronyms')
  let inflectionLoaderObj.load_uncountables = function('<SNR>' . s:SID() . '_InflectionLoader_load_uncountables')
  let inflectionLoaderObj.load_irregulars = function('<SNR>' . s:SID() . '_InflectionLoader_load_irregulars')
  let inflectionLoaderObj.load_singulars = function('<SNR>' . s:SID() . '_InflectionLoader_load_singulars')
  let inflectionLoaderObj.load_plurals = function('<SNR>' . s:SID() . '_InflectionLoader_load_plurals')
...
function! s:ContextConstructor()
  let contextObj = {}
  let contextObj.needs = function('<SNR>' . s:SID() . '_Context_needs')
  let contextObj.on_inject = function('<SNR>' . s:SID() . '_Context_on_inject')
  let contextObj.get_root = function('<SNR>' . s:SID() . '_Context_get_root')
  let contextObj.get_root_portkey = function('<SNR>' . s:SID() . '_Context_get_root_portkey')
  let contextObj.add_portkey = function('<SNR>' . s:SID() . '_Context_add_portkey')
  let contextObj.add_extension = function('<SNR>' . s:SID() . '_Context_add_extension')
  let contextObj.get_portkeys = function('<SNR>' . s:SID() . '_Context_get_portkeys')
  let contextObj.load = function('<SNR>' . s:SID() . '_Context_load')
  let contextObj.load_config = function('<SNR>' . s:SID() . '_Context_load_config')
  let contextObj.load_extensions = function('<SNR>' . s:SID() . '_Context_load_extensions')
  let contextObj.load_extension_by_name = function('<SNR>' . s:SID() . '_Context_load_extension_by_name')
  let contextObj.load_extension = function('<SNR>' . s:SID() . '_Context_load_extension')
  let contextObj.load_syntax_files = function('<SNR>' . s:SID() . '_Context_load_syntax_files')
  let contextObj.load_filters = function('<SNR>' . s:SID() . '_Context_load_filters')
  let contextObj.load_inflections = function('<SNR>' . s:SID() . '_Context_load_inflections')
  let contextObj.load_rankers = function('<SNR>' . s:SID() . '_Context_load_rankers')
  let contextObj.load_ranker = function('<SNR>' . s:SID() . '_Context_load_ranker')
  let contextObj.load_finders = function('<SNR>' . s:SID() . '_Context_load_finders')
  let contextObj.load_finder = function('<SNR>' . s:SID() . '_Context_load_finder')
  let contextObj.load_extractors = function('<SNR>' . s:SID() . '_Context_load_extractors')
  let contextObj.lookup = function('<SNR>' . s:SID() . '_Context_lookup')
  let contextObj.get_projections = function('<SNR>' . s:SID() . '_Context_get_projections')
  let contextObj.get_extension_names = function('<SNR>' . s:SID() . '_Context_get_extension_names')
  let contextObj.inject = function('<SNR>' . s:SID() . '_Context_inject')
  return contextObj
endfunction
...
function! s:PortkeyLoaderConstructor(extensions)
  ...
  let portkeyLoaderObj.load = function('<SNR>' . s:SID() . '_PortkeyLoader_load')
  let portkeyLoaderObj.load_children = function('<SNR>' . s:SID() . '_PortkeyLoader_load_children')
  let portkeyLoaderObj.load_and_parse = function('<SNR>' . s:SID() . '_PortkeyLoader_load_and_parse')
  let portkeyLoaderObj.parse = function('<SNR>' . s:SID() . '_PortkeyLoader_parse')
  let portkeyLoaderObj.resolve_path = function('<SNR>' . s:SID() . '_PortkeyLoader_resolve_path')
  let portkeyLoaderObj.lookup_extension_path = function('<SNR>' . s:SID() . '_PortkeyLoader_lookup_extension_path')
  let portkeyLoaderObj.send_extension_event = function('<SNR>' . s:SID() . '_PortkeyLoader_send_extension_event')
  let portkeyLoaderObj.get_event_name = function('<SNR>' . s:SID() . '_PortkeyLoader_get_event_name')
  let portkeyLoaderObj.show_error = function('<SNR>' . s:SID() . '_PortkeyLoader_show_error')
  let portkeyLoaderObj.has_errors = function('<SNR>' . s:SID() . '_PortkeyLoader_has_errors')
  let portkeyLoaderObj.has_root_loaded = function('<SNR>' . s:SID() . '_PortkeyLoader_has_root_loaded')
  let portkeyLoaderObj.is_json = function('<SNR>' . s:SID() . '_PortkeyLoader_is_json')
  let portkeyLoaderObj.has_children = function('<SNR>' . s:SID() . '_PortkeyLoader_has_children')
  let portkeyLoaderObj.is_extension_name = function('<SNR>' . s:SID() . '_PortkeyLoader_is_extension_name')
  let portkeyLoaderObj.get_scope = function('<SNR>' . s:SID() . '_PortkeyLoader_get_scope')
...
function! s:PortkeyPathConstructor(pathname)
  ...
  let portkeyPathObj.get_pathname = function('<SNR>' . s:SID() . '_PortkeyPath_get_pathname')
  let portkeyPathObj.build_extension_name = function('<SNR>' . s:SID() . '_PortkeyPath_build_extension_name')
  let portkeyPathObj.is_extension = function('<SNR>' . s:SID() . '_PortkeyPath_is_extension')
  let portkeyPathObj.get_extension_name = function('<SNR>' . s:SID() . '_PortkeyPath_get_extension_name')
  let portkeyPathObj.set_filepath = function('<SNR>' . s:SID() . '_PortkeyPath_set_filepath')
  let portkeyPathObj.get_filepath = function('<SNR>' . s:SID() . '_PortkeyPath_get_filepath')
  let portkeyPathObj.get_extension_name_parts = function('<SNR>' . s:SID() . '_PortkeyPath_get_extension_name_parts')
  let portkeyPathObj.get_name_parts = function('<SNR>' . s:SID() . '_PortkeyPath_get_name_parts')
...
function! s:PortkeyCollectorConstructor(context, projections)
  ...
  let portkeyCollectorObj.add = function('<SNR>' . s:SID() . '_PortkeyCollector_add')
  let portkeyCollectorObj.add_extension = function('<SNR>' . s:SID() . '_PortkeyCollector_add_extension')
...
function! s:RankerConstructor()
  ...
  let rankerObj.add_ranker = function('<SNR>' . s:SID() . '_Ranker_add_ranker')
  let rankerObj.rank = function('<SNR>' . s:SID() . '_Ranker_rank')
  let rankerObj.sort = function('<SNR>' . s:SID() . '_Ranker_sort')
  let rankerObj.compare_rank_items = function('<SNR>' . s:SID() . '_Ranker_compare_rank_items')
  let rankerObj.get_rankers = function('<SNR>' . s:SID() . '_Ranker_get_rankers')
  let rankerObj.to_rank_items = function('<SNR>' . s:SID() . '_Ranker_to_rank_items')
  let rankerObj.to_results = function('<SNR>' . s:SID() . '_Ranker_to_results')
  return rankerObj
endfunction
...
function! s:RankItemConstructor(path, ranking)
  ...
  let rankItemObj.get_path = function('<SNR>' . s:SID() . '_RankItem_get_path')
  let rankItemObj.get_ranking = function('<SNR>' . s:SID() . '_RankItem_get_ranking')
  let rankItemObj.set_ranking = function('<SNR>' . s:SID() . '_RankItem_set_ranking')
  let rankItemObj.raise = function('<SNR>' . s:SID() . '_RankItem_raise')
  let rankItemObj.lower = function('<SNR>' . s:SID() . '_RankItem_lower')
  let rankItemObj.get_step_size = function('<SNR>' . s:SID() . '_RankItem_get_step_size')
  return rankItemObj
endfunction
...
function! s:FinderConstructor()
  ...
  let finderObj.add_finder = function('<SNR>' . s:SID() . '_Finder_add_finder')
  let finderObj.find = function('<SNR>' . s:SID() . '_Finder_find')
  let finderObj.get_finders = function('<SNR>' . s:SID() . '_Finder_get_finders')
  return finderObj
endfunction
...
function! s:FinderCollectorConstructor()
  ...
  let finderCollectorObj.get_results = function('<SNR>' . s:SID() . '_FinderCollector_get_results')
  let finderCollectorObj.add = function('<SNR>' . s:SID() . '_FinderCollector_add')
  let finderCollectorObj.insert = function('<SNR>' . s:SID() . '_FinderCollector_insert')
  let finderCollectorObj.remove = function('<SNR>' . s:SID() . '_FinderCollector_remove')
  let finderCollectorObj.has = function('<SNR>' . s:SID() . '_FinderCollector_has')
...
function! s:MakeEnvConstructor()
  ...
  let makeEnvObj.get_makeprg = function('<SNR>' . s:SID() . '_MakeEnv_get_makeprg')
  let makeEnvObj.get_errorformat = function('<SNR>' . s:SID() . '_MakeEnv_get_errorformat')
  let makeEnvObj.get_dir = function('<SNR>' . s:SID() . '_MakeEnv_get_dir')
  let makeEnvObj.has_local_dir = function('<SNR>' . s:SID() . '_MakeEnv_has_local_dir')
  let makeEnvObj.has_compiler = function('<SNR>' . s:SID() . '_MakeEnv_has_compiler')
  let makeEnvObj.get_compiler = function('<SNR>' . s:SID() . '_MakeEnv_get_compiler')
  let makeEnvObj.restore = function('<SNR>' . s:SID() . '_MakeEnv_restore')
  let makeEnvObj.chdir = function('<SNR>' . s:SID() . '_MakeEnv_chdir')
  return makeEnvObj
endfunction
...
function! s:MakeConstructor()
  ...
  let makeObj.set_bang = function('<SNR>' . s:SID() . '_Make_set_bang')
  let makeObj.get_bang = function('<SNR>' . s:SID() . '_Make_get_bang')
  let makeObj.set_dir = function('<SNR>' . s:SID() . '_Make_set_dir')
  let makeObj.get_dir = function('<SNR>' . s:SID() . '_Make_get_dir')
  let makeObj.set_show_quickfix = function('<SNR>' . s:SID() . '_Make_set_show_quickfix')
  let makeObj.get_show_quickfix = function('<SNR>' . s:SID() . '_Make_get_show_quickfix')
  let makeObj.set_compiler = function('<SNR>' . s:SID() . '_Make_set_compiler')
  let makeObj.get_compiler = function('<SNR>' . s:SID() . '_Make_get_compiler')
  let makeObj.set_makeprg = function('<SNR>' . s:SID() . '_Make_set_makeprg')
  let makeObj.get_makeprg = function('<SNR>' . s:SID() . '_Make_get_makeprg')
  let makeObj.set_errorformat = function('<SNR>' . s:SID() . '_Make_set_errorformat')
  let makeObj.get_errorformat = function('<SNR>' . s:SID() . '_Make_get_errorformat')
  let makeObj.set_mocked = function('<SNR>' . s:SID() . '_Make_set_mocked')
  let makeObj.get_mocked = function('<SNR>' . s:SID() . '_Make_get_mocked')
  let makeObj.get_exec_cmd = function('<SNR>' . s:SID() . '_Make_get_exec_cmd')
  let makeObj.set_use_dispatch_make = function('<SNR>' . s:SID() . '_Make_set_use_dispatch_make')
  let makeObj.get_use_dispatch_make = function('<SNR>' . s:SID() . '_Make_get_use_dispatch_make')
  let makeObj.make = function('<SNR>' . s:SID() . '_Make_make')
  let makeObj.load_env = function('<SNR>' . s:SID() . '_Make_load_env')
  let makeObj.run = function('<SNR>' . s:SID() . '_Make_run')
  let makeObj.get_make_cmd = function('<SNR>' . s:SID() . '_Make_get_make_cmd')
  return makeObj
endfunction
...
function! s:FinderContextConstructor()
  ...
  let finderContextObj.lookup = function('<SNR>' . s:SID() . '_FinderContext_lookup')
  let finderContextObj.buffer_has_projection = function('<SNR>' . s:SID() . '_FinderContext_buffer_has_projection')
  let finderContextObj.buffer_has_context = function('<SNR>' . s:SID() . '_FinderContext_buffer_has_context')
  let finderContextObj.buffer_has_enrolled = function('<SNR>' . s:SID() . '_FinderContext_buffer_has_enrolled')
  let finderContextObj.get_current_buffer = function('<SNR>' . s:SID() . '_FinderContext_get_current_buffer')
  let finderContextObj.get_current_buffer_path = function('<SNR>' . s:SID() . '_FinderContext_get_current_buffer_path')
  let finderContextObj.get_current_buffer_filename = function('<SNR>' . s:SID() . '_FinderContext_get_current_buffer_filename')
  let finderContextObj.get_current_buffer_rootname = function('<SNR>' . s:SID() . '_FinderContext_get_current_buffer_rootname')
  let finderContextObj.get_current_contexts = function('<SNR>' . s:SID() . '_FinderContext_get_current_contexts')
  let finderContextObj.get_current_context = function('<SNR>' . s:SID() . '_FinderContext_get_current_context')
  let finderContextObj.get_current_root = function('<SNR>' . s:SID() . '_FinderContext_get_current_root')
  let finderContextObj.get_current_projection = function('<SNR>' . s:SID() . '_FinderContext_get_current_projection')
  let finderContextObj.get_current_projections = function('<SNR>' . s:SID() . '_FinderContext_get_current_projections')
  let finderContextObj.get_current_pattern = function('<SNR>' . s:SID() . '_FinderContext_get_current_pattern')
  let finderContextObj.get_current_resource_type = function('<SNR>' . s:SID() . '_FinderContext_get_current_resource_type')
...
function! s:DataFrameConstructor(buffer)
  ...
  let dataFrameObj.set_line = function('<SNR>' . s:SID() . '_DataFrame_set_line')
  let dataFrameObj.set_tags = function('<SNR>' . s:SID() . '_DataFrame_set_tags')
  let dataFrameObj.set_source = function('<SNR>' . s:SID() . '_DataFrame_set_source')
  let dataFrameObj.set_source_path = function('<SNR>' . s:SID() . '_DataFrame_set_source_path')
  let dataFrameObj.print = function('<SNR>' . s:SID() . '_DataFrame_print')
  return dataFrameObj
endfunction
...
function! s:ProjectionDataFrameConstructor(buffer)
  ...
  let projectionDataFrameObj.set_projection = function('<SNR>' . s:SID() . '_ProjectionDataFrame_set_projection')
  let projectionDataFrameObj.set_pattern = function('<SNR>' . s:SID() . '_ProjectionDataFrame_set_pattern')
  let projectionDataFrameObj.print = function('<SNR>' . s:SID() . '_ProjectionDataFrame_print')
  let projectionDataFrameObj.DataFrame_print = function('<SNR>' . s:SID() . '_DataFrame_print')
...
function! s:ResourceDataFrameConstructor(buffer)
  ...
  let resourceDataFrameObj.set_pattern_list = function('<SNR>' . s:SID() . '_ResourceDataFrame_set_pattern_list')
...
function! s:GetFileDataFrameConstructor(buffer)
  ...
  let getFileDataFrameObj.set_pattern_list = function('<SNR>' . s:SID() . '_GetFileDataFrame_set_pattern_list')
  let getFileDataFrameObj.set_inflector = function('<SNR>' . s:SID() . '_GetFileDataFrame_set_inflector')
  let getFileDataFrameObj.set_projection = function('<SNR>' . s:SID() . '_GetFileDataFrame_set_projection')
...
function! s:TemplateContextConstructor(data)
  ...
  let templateContextObj.lookup = function('<SNR>' . s:SID() . '_TemplateContext_lookup')
...
function! s:AlternateFinderContextConstructor()
  ...
  let alternateFinderContextObj.get_query_type = function('<SNR>' . s:SID() . '_AlternateFinderContext_get_query_type')
  let alternateFinderContextObj.get_template_context = function('<SNR>' . s:SID() . '_AlternateFinderContext_get_template_context')
...
function! s:ResourceFinderContextConstructor()
  ...
  let resourceFinderContextObj.get_query_type = function('<SNR>' . s:SID() . '_ResourceFinderContext_get_query_type')
  let resourceFinderContextObj.get_template_context = function('<SNR>' . s:SID() . '_ResourceFinderContext_get_template_context')
...
function! s:RelatedFinderContextConstructor()
  ...
  let relatedFinderContextObj.get_query_type = function('<SNR>' . s:SID() . '_RelatedFinderContext_get_query_type')
  let relatedFinderContextObj.get_template_context = function('<SNR>' . s:SID() . '_RelatedFinderContext_get_template_context')
...
function! s:TestFinderContextConstructor()
  ...
  let testFinderContextObj.get_query_type = function('<SNR>' . s:SID() . '_TestFinderContext_get_query_type')
  let testFinderContextObj.get_template_context = function('<SNR>' . s:SID() . '_TestFinderContext_get_template_context')
...
function! s:GetFileFinderContextConstructor()
  ...
  let getFileFinderContextObj.get_query_type = function('<SNR>' . s:SID() . '_GetFileFinderContext_get_query_type')
  let getFileFinderContextObj.get_template_context = function('<SNR>' . s:SID() . '_GetFileFinderContext_get_template_context')
...
function! s:LauncherConstructor()
  ...
  let launcherObj.run = function('<SNR>' . s:SID() . '_Launcher_run')
  let launcherObj.launch = function('<SNR>' . s:SID() . '_Launcher_launch')
  let launcherObj.render_template = function('<SNR>' . s:SID() . '_Launcher_render_template')
  let launcherObj.get_file_template_context = function('<SNR>' . s:SID() . '_Launcher_get_file_template_context')
  let launcherObj.find_source_name = function('<SNR>' . s:SID() . '_Launcher_find_source_name')
  let launcherObj.extract_from_source = function('<SNR>' . s:SID() . '_Launcher_extract_from_source')
  let launcherObj.extract_into_destination = function('<SNR>' . s:SID() . '_Launcher_extract_into_destination')
  let launcherObj.create_strategy = function('<SNR>' . s:SID() . '_Launcher_create_strategy')
  let launcherObj.lookup = function('<SNR>' . s:SID() . '_Launcher_lookup')
  let launcherObj.on_inject = function('<SNR>' . s:SID() . '_Launcher_on_inject')
  return launcherObj
endfunction
...
function! s:LaunchableConstructor(filepath, strategy)
  ...
  let launchableObj.get_strategy = function('<SNR>' . s:SID() . '_Launchable_get_strategy')
  let launchableObj.get_filepath = function('<SNR>' . s:SID() . '_Launchable_get_filepath')
  let launchableObj.set_launched = function('<SNR>' . s:SID() . '_Launchable_set_launched')
  let launchableObj.get_launched = function('<SNR>' . s:SID() . '_Launchable_get_launched')
...
function! s:LoggerConstructor()
  ...
  let loggerObj.add_log_writer = function('<SNR>' . s:SID() . '_Logger_add_log_writer')
  let loggerObj.set_level = function('<SNR>' . s:SID() . '_Logger_set_level')
  let loggerObj.get_level = function('<SNR>' . s:SID() . '_Logger_get_level')
  let loggerObj.get_level_num = function('<SNR>' . s:SID() . '_Logger_get_level_num')
  let loggerObj.is_loggable = function('<SNR>' . s:SID() . '_Logger_is_loggable')
  let loggerObj.do_log = function('<SNR>' . s:SID() . '_Logger_do_log')
  let loggerObj.args_to_message = function('<SNR>' . s:SID() . '_Logger_args_to_message')
  let loggerObj.send_log = function('<SNR>' . s:SID() . '_Logger_send_log')
  let loggerObj.to_color = function('<SNR>' . s:SID() . '_Logger_to_color')
  let loggerObj.debug = function('<SNR>' . s:SID() . '_Logger_debug')
  let loggerObj.info = function('<SNR>' . s:SID() . '_Logger_info')
  let loggerObj.log = function('<SNR>' . s:SID() . '_Logger_log')
  let loggerObj.warn = function('<SNR>' . s:SID() . '_Logger_warn')
  let loggerObj.error = function('<SNR>' . s:SID() . '_Logger_error')
  let loggerObj.fatal = function('<SNR>' . s:SID() . '_Logger_fatal')
  return loggerObj
endfunction
...
function! s:PythonFileWriterConstructor(sys_path, output_file)
  ...
  let pythonFileWriterObj.write = function('<SNR>' . s:SID() . '_PythonFileWriter_write')
  let pythonFileWriterObj.writeln = function('<SNR>' . s:SID() . '_PythonFileWriter_writeln')
  let pythonFileWriterObj.flush = function('<SNR>' . s:SID() . '_PythonFileWriter_flush')
  let pythonFileWriterObj.flush_line = function('<SNR>' . s:SID() . '_PythonFileWriter_flush_line')
  let pythonFileWriterObj.flush = function('<SNR>' . s:SID() . '_PythonFileWriter_flush')
  let pythonFileWriterObj.setup_exit_hooks = function('<SNR>' . s:SID() . '_PythonFileWriter_setup_exit_hooks')
...
function! s:FileLogWriterConstructor()
  ...
  let fileLogWriterObj.set_writer = function('<SNR>' . s:SID() . '_FileLogWriter_set_writer')
  let fileLogWriterObj.get_writer = function('<SNR>' . s:SID() . '_FileLogWriter_get_writer')
  let fileLogWriterObj.set_log_file = function('<SNR>' . s:SID() . '_FileLogWriter_set_log_file')
  let fileLogWriterObj.set_colorize = function('<SNR>' . s:SID() . '_FileLogWriter_set_colorize')
  let fileLogWriterObj.get_colorize = function('<SNR>' . s:SID() . '_FileLogWriter_get_colorize')
  let fileLogWriterObj.log = function('<SNR>' . s:SID() . '_FileLogWriter_log')
  let fileLogWriterObj.flush = function('<SNR>' . s:SID() . '_FileLogWriter_flush')
